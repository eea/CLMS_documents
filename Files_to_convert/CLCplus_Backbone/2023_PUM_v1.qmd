---
title: "Copernicus Land Monitoring Service – CLCplus Backbone 2023"
...
The CLCplus Backbone 2023 product comprises an updated layer of the main land cover raster layer, as well as three auxiliary layers (see {@sec-figure-1}). 

![Figure 1: Overview of CLCplus Backbone layers produced for the reference year 2023](2023_PUM_v1-media/img-3ae7a950b89b88ab5164a45a96c174e993f664d9.png){#sec-figure1}
...
![](2023_PUM_v1-media/Table2.png)

![Figure 2: CLCplus Backbone 2023 for the EEA38+UK (note: French DOMs are not shown)](2023_PUM_v1-media/img-9df408152771d42bb0f22ad96081a803854b9e76.png){#fig-figure2}
...
![Figure 3: CLCplus Backbone 2023 for tile E44N36 (Copenhagen)](2023_PUM_v1-media/img-66b2331d63fc430e212e30aa8999c547d0b8dc82.png){#fig-figure3}
...
|**Coordinate Reference Syste**m: European ETRS89 LAEA projection / WGS84 and the respective UTM zone for French DOMs|
...
![Figure 4: Exemplary 10x10m plot illustration of a situation where no single land cover class  covers 50% of the area](2023_PUM_v1-media/img-0f13569c926a8fcffb56ce87a86f6969e7efe854.png){#fig-figure4}
...
![Figure 5: Levels 1-5 of the EAGLE Land Cover Components (LCC) v3.21. The hierarchical  levels allow for resolving the LCC assignment in the most suitable way. In case level 1 is too  general, the most suitable lower level is chosen](2023_PUM_v1-media/img-eeda59c50bb28bb4c441bd411b0a293d236bdfac.png){#fig-figure5}
...
![Figure 6: Decision tree for the usage of area thresholds for pixels with (pure or) spatially mixed land cover in the CLCplus Backbone](2023_PUM_v1-media/img-dc7fffd1594ddeea432815b9578cf21c994675b4.png){#fig-figure6}
...
![](2023_PUM_v1-media/Example1.png)
...
![Figure 15: Example of the uncertainty in the mapping of Low-growing woody plants. This  example from Northern Sweden illustrates that a sharp distinction of shrubs and trees is often difficult and sometimes remains fuzzy even at the level of the same species (here different  specimens of Betula with sometimes more tree-like, sometimes more shrub-like habitus). In  addition, the canopy is rather sparse and the understorey comprises a mix of herbaceous  species, dwarf shrubs as well as mosses and lichens](2023_PUM_v1-media/img-98f8fc0c2616e39680f4446b5be599320c5a71ab.png){#fig-figure15}
...
![Figure 17: CLCplus Backbone Data Score Layer (RASDL) of the reference year 2023 (±3 months)](2023_PUM_v1-media/img-957b567d0ef07f50f054c5cee41babd5cf0d641d.png){#fig-figure17}
...
![Figure 18: CLCplus Backbone Raster Confidence Layer 2023](2023_PUM_v1-media/img-dce450dddbdcde7b15953ed341a6d06ccee0784e.png){#fig-figure18}

![Figure 19: Closeup of the RASCL showing edges as a result of separate training models per production unit](2023_PUM_v1-media/img-30f84d5430161602116c020f37687fa15d9cb6f1.png){#fig-figure19}

![Figure 20: Distribution and fractions of values in the Raster Confidence Layer (RASCL) of  CLCplus Backbone 2023 across the EEA38+UK](2023_PUM_v1-media/img-59c1dd0915814ee2101e85c9ab825da1feea60d1.png){fig-figure20}
...
![Figure 21: CLCplus Backbone Raster Post-Processing Layer (RASPL) 2023](2023_PUM_v1-media/img-873fc1d0b90c1e8fea175db5a26fb19ff0db0f39.png){#fig-figure21}
...
![Colour palette for the Raster (RAS) Product](2023_PUM_v1-media/RasterProduct.png)

### Data Score Layer (RASDL)

![Colour palette for the Data Score Layer](2023_PUM_v1-media/DataScoreLayer.png)

### Raster Confidence Layer (RASCL)

![Colour palette for the Raster Confidence Layer](2023_PUM_v1-media/RasterConfidenceLayer.png)

### Post-Processing Layer (RASPL)

![Colour palette for the Raster Post-processing Layer](2023_PUM_v1-media/RasterPost-ProcessingLayer.png)
