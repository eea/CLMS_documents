...
URBAN ATLAS 2021 - ALGORITHM  THEORETICAL BASIS DOCUMENT (ATBD)

![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-4940706e249f2e5dd804cf1f54a8980ea970aff3.png)
...
|Document Title|ATBD Algorithm Theoretical Basis Document|
|--|--|
...
|--|--|--|--|
|Lhernould Alice|Author||21.08.2025|
|Yoann Courmont|Author||18.08.2025|
|Tanja Gasber|Author||18.08.2025|
|Stefan Ralser|Author||18.08.2025|
|Adam Pasik|Author||18.08.2025|
|Robin Dratwa|Author||18.08.2025|
...
|--|--|--|
|1.0|22.08.2025|Initial published issue|
...
|2 Background of the document ..............................................................................................|... 7|
|2.1     Scope and objectives.................................................................................................|... 7|
|2.2     Content and structure ...............................................................................................|... 7|
|3 Methodology........................................................................................................................|... 8|
|3.1    Methodology and workflow ......................................................................................|... 9|
|3.2     Source data ................................................................................................................|... 9|
|3.2.1   EO data ..................................................................................................................|. 10|
|3.2.2   Ancillary data.........................................................................................................|. 10|
|3.3     Pre-processing ...........................................................................................................|. 12|
|3.3.1    Input data for pre-processing................................................................................|. 12|
|3.3.2   Pre-processing methodology.................................................................................|. 12|
|3.4     Processing ..................................................................................................................|. 13|
|3.4.1   Processing methodology .......................................................................................|. 13|
|3.5    Output products ........................................................................................................|. 24|
|4 Quality control and production verification ........................................................................|. 25|
|4.1    Quality assurance and quality control framework ....................................................|. 25|
|4.2    Thematic quality and accuracy assessment...............................................................|. 27|
|4.2.1   Objectives and approach.......................................................................................|. 27|
|4.2.2   Sampling and response design ..............................................................................|. 27|
|4.2.3   Thematic accuracy and statistical analysis............................................................|. 29|
|5   Recognized technical issues.................................................................................................|. 30|
|5.1    Technical issues linked to the UA2021 LC/LU production.........................................|. 30|
|5.2    Technical issues linked to the GUA classification ......................................................|. 31|
|6 Terms of use and product technical support.......................................................................|. 32|
|6.1    Terms of use ..............................................................................................................|. 32|
|6.2     Citation.......................................................................................................................|. 32|
|6.3     Product technical support .........................................................................................|. 32|


|List of abbreviations & acronyms................................................................................................ 33|
|--|
|Annex 1 - Green Urban Areas queries......................................................................................... 35|
|Annex 2 - UA LC/LU Nomenclature ............................................................................................. 37|


# List of tables

Table 1: Overview table of methodology...................................................................................... 8

Table 2: Ancillary datasets used for the UA 2021 production .................................................... 11

Table 3: Number of private/public and unknown occurrences of selected FUAs of one delivery  batch............................................................................................................................................ 22

Table 4: Quality Assurance: topological rules............................................................................. 26

Table 5: Share of samples to be interpreted............................................................................... 28

Table 6: UA LC/LU nomenclature (in bold, classes used in the products, without any further  subdivision) ................................................................................................................................. 37

# List of figures

Figure 1: UA2021 LC/LU workflow ................................................................................................ 9

Figure 2: Number of observations for Sentinel-2 as extracted from the Sen2Cor scene classification map: a: Antwerpen 2018, b: Antwerpen 2021, c: Madrid 2018, d: Madrid 2021. 13

Figure 3: Example of the S2-change detection. .......................................................................... 15

Figure 4: Change detection heatmap derived from VHR data.................................................... 16

Figure 5: Methodology of Change Detection for UA2021 .......................................................... 17

Figure 6: Exception rule for the minimum mapping width......................................................... 18

Figure 7: Examples of the public, private and unknown classes in Iasi, Romania ...................... 22
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-2cf3034b1d6467165bba95b2c0efb0bfb737e009.png)
...
|HRL IMD 2021|IMD (imperviousnessdensity)|https://land.copernicus.eu/en/products/high-resolution-layer-imperviousness|
...
in this equation, pi are the coefficients of the polynomial term with order P, H is the order of the  harmonic system and αk and βk are the coefficients of the harmonic functions with order k. \(\omega=\) 2π/year is the base angular frequency of the harmonic system. The coefficients pi, \({\upalpha}_{\upkappa}\) and \(\upbeta_{\upkappa}\) are  estimated by performing ordinary least squares fit to the signal of each pixel of the time series. Cloud and atmospheric artifacts (Figure 2) are mitigated through a weighting scheme based on  the Sentinel-2 L2A Scene Classification Layer (SCL), in which observations with high cloud or  shadow probability are down-weighted during the modelling process. This ensures that only  high-quality observations contribute meaningfully to the fitted time series.

![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-368bd0a7ba855372998b556a130d1a530b822bc1.png)

Figure 2: Number of observations for Sentinel-2 as extracted from the Sen2Cor scene classification map: a: Antwerpen 2018, b: Antwerpen 2021, c: Madrid 2018, d: Madrid 2021
...
This expresses the average squared difference between two continuous NDVI curves (modelled by the harmonic curves \(\mathsf{f}_{1}\) and \(^{\mathsf{f}}_{2}\)) over a full annual cycle.
...
where \(\mu_{\mathrm{class}}\) and \(\sigma_{\mathsf{c l a s s}}\) are the mean and standard deviation of the RMSD within the corresponding  land cover class.
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-9937c1b12fadb16ec003747b2921e1c9d1b5d766.png)

Figure 3: Example of the S2-change detection. The image shows a detected change in Vienna.  Upper left: Copernicus VHR Satellite image of 2018 with OSM building footprints overlay, upper  right: Copernicus VHR Satellite image of 2021 with OSM building footprints overlay, lower left:  The normalized RMSD calculation, lower right: The normalized RMSD calculation with OSM  building footprints overlay.
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-09eb2e9f24c74dfd56b196c98442d476880fe8f9.png)
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-2af73a172321d5fb216bb889eb5ec30e77f5b4ae.png)
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-834e715dc033114faa122e89cdc459db3bf039c3.png)
...
#### 3.4.1.6 Generation of Green Urban Areas (GUA) “public vs private” label Data model
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-04ba10b31f195e99675e225dd2792a5419e40b8c.png)
...
CLMS_UA2021_LULC_ATBD_v1.1.docx Version 1.1
...
### 4.1.1.1 Topological consistency
...
### 4.1.1.4 Conceptual consistency 
...
1. Be based on a representative probabilistic sample, following a sound and statistically  robust methodology.

2. Ensure synergies and economies of scale.
...
Despite rigorous QA/QC, residual errors remain, particularly in detecting “unlikely evolutions”  (e.g. urban reverting to agriculture). Automated checks cannot always capture these anomalies. Mitigation 7: In addition to internal plausibility models and anomaly detection, an external  validation process will be organized by the EEA to provide an independent assessment of  thematic accuracy and ensure product reliability.
...
![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-68f105f08e83ec4f9d20854e47d7d044be04e522.png)

![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-91cce6541dc22c94a8b16b2452b7778d1f3ebde7.png)

![img](CLMS_UA2021_LULC_ATBD_v1.1-media/img-ea2fa0d630aebaf52c3d6d556422ec686e794eb8.png)
