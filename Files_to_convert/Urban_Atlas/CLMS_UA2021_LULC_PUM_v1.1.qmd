---
title: "Copernicus Land Monitoring Service – Priority Area Monitoring – Urban Atlas 2021 and 2024"
subtitle: "Urban Atlas 2021 – Product User Manual (PUM)"
date: "29/01/2026"
version: 1.5
...
![83 Urban Atlas FUA's with more than 50,000 inhabitants used for this study](CLMS_UA2021_LULC_PUM_v1.1-media/img-87c21c7c04e003001a144ad28cc9305d084946ca.png){#fig-figure2}
...
![UA2021 status layer for Bruxelles/Brussel/Leuven](CLMS_UA2021_LULC_PUM_v1.1-media/img-54059741438c873bd6ecb859d30620018f9ab691.png){#fig-figure3}
...
![Exception rule for the minimum mapping width](CLMS_UA2021_LULC_PUM_v1.1-media/img-87d1a7009176100d4a09373b0e22528bc1120b3c.png){#fig-figure4}
...
Thematic accuracy: ≥ 85 % in urban classes (class 1) <br> ≥ 80 % in rural classes (classes 2 to 5) <br> ≥ 80 % overall accuracy

Minimum Mapping Unit: Urban (class 1) to urban (class 1) = 0.1 ha <br> Rural/natural (classes 2-5) to urban (class 1) = 0.1 ha <br> Rural/natural (classes 2-5) to rural/natural (classes 2-5) = 0.25 ha <br> Urban (class 1) to rural/natural (classes 2-5) = 0.25 ha
...
Minimum Mapping Unit: 0.25 ha in urban areas <br> 1 ha in rural areas
...
![Change detection based on VHR (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1.1-media/figure5.png){#fig-figure5}
...
![Change detection based on Sentinel-2 (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1.1-media/figure6.png){#fig-figure6}
...
![Extracted change detection layer (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1.1-media/figure7.png){#fig-figure7}
...
![Examples of the public, private and unknown classes in Iasi, Romania. For completeness, the figure also includes class 14200 - recreational and sport areas](CLMS_UA2021_LULC_PUM_v1.1-media/img-b2a5ee3fbe67ecb823db882daf38b32172f70c3f.png){#fig-figure8}
