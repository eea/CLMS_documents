...
category: guidelines
date: '2026-05-26'
description: A step-by-step guide for integrating an existing project repository with
  the CLMS Technical Library documentation system.
original-filename: guidelines/setup-guide_v1.qmd
...
- [ ] Editors have the Editor Guide link: [Editor Guide](guidelines-editor-guide_v1.html)
