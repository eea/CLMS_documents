...
-   Click the **Render** button at the top of the RStudio window. ![Render button](editor-manual_v1-media/rstudio-render.png){width="6.27in"}

-   Or enable **Preview on Save** (in the RStudio IDE toolbar). This option automatically re-renders your document every time you save it. ![Render on Save](editor-manual_v1-media/rstudio-render-on-save.png){width="6.27in"}
...
![](editor-manual_v1-media/rstudio-render-viewer-tab.png){width="6.27in"}
...
![](editor-manual_v1-media/rstudio-render-viewer-options.png){width="6.27in"}
...
![](editor-manual_v1-media/rstudio-render-docx.png){width="3.09in"}
...
3. Upon review approval:
    - The PR is merged.
    - The final, official version is automatically rendered and published at [https://library.land.copernicus.eu](https://library.land.copernicus.eu)
...
Version 2.2.0 introduced problems. Restore version 2.0.0, make corrections, and publish. When the library is released, your changes will be assigned a new minor or patch version (like 2.3.0 or 2.2.1) based on their scope.
