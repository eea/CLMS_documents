...
Fenced divs (`:::`) are used for callout boxes and content grouping. **Always leave a blank line before the closing `:::`** — otherwise the div bleeds into the next element and the nesting breaks:
