...
title: Riparian Zones LC/LU and change 2012-2018 - Product User Manual
toc: true
toc-depth: 3
toc-title: Content
version: 1.0
...
![Figure 1: Riparian Zones 2012-2018 product portfolio](2012-2018_PUM_v1-media/Fig1.png){width="6.27in"}
...
![Figure 2: The 43 Riparian Zones Delivery Units (based on ECRINS v1.1)](2012-2018_PUM_v1-media/image6.png){width="6.27in"}
...
![](2012-2018_PUM_v1-media/Table1.png){width="4.35in"}

![](2012-2018_PUM_v1-media/Table2.png){width="4.35in"}

![](2012-2018_PUM_v1-media/Table3.png){width="4.35in"}

![](2012-2018_PUM_v1-media/Table4.png){width="4.36in"}
...
![Figure 3: AoI amendment example of Str-2 hanging rivers connected to Str. 3](2012-2018_PUM_v1-media/image7.png){width="5.58in"}

![Figure 4: AoI amendment to include Lake Outline](2012-2018_PUM_v1-media/image8.png){width="4.53in"}
...
![Table 8: Recoding of the UA Core areas into the RZ Nomenclature](2012-2018_PUM_v1-media/Picture1.png){width="4.19in"}
...
![Figure 5: UA2012/2018 Integration into the RZ project](2012-2018_PUM_v1-media/image10.png){width="6.27in"}
...
![Figure 6: Delineation avoiding smooth lines](2012-2018_PUM_v1-media/image11.png){width="6.27in"}
...
![Figure 7: Delineation avoiding acute angles](2012-2018_PUM_v1-media/image14.png){width="5.29in"}
...
![Figure 8: MMU exception at RZ border](2012-2018_PUM_v1-media/image15.png){width="3.42in"}
...
![Figure 9: MMU exception of linear elements](2012-2018_PUM_v1-media/image16.png){width="6.27in"}
...
![Figure 10: MMU exception between roads](2012-2018_PUM_v1-media/image17.jpeg){width="3.31in"}
...
![Figure 11: MMW exception](2012-2018_PUM_v1-media/image18.png){width="5.65in"}
...
![Figure 12: A Green urban area (1.4.0.0) ≥0,5 ha in 2012 changes into Continuous urban fabric (1.1.1.1) in 2018](2012-2018_PUM_v1-media/image19.png){width="3.72in"}
...
![Figure 13: Changes (Continuous urban fabric 0,4 ha, water area 0,15 ha) with an area \<0,5 ha and different classes make up a complex change area of 0,55 ha](2012-2018_PUM_v1-media/image20.png){width="5.73in"}
...
![Figure 14: An Olive grove (2.2.2.0) changed into Vineyards, fruit trees and berry plantations (2.2.1.0) and Industrial, commercial and military units (1.1.2.0), but because the areas are \<0,5 ha, they are merged with the neighbouring objects.](2012-2018_PUM_v1-media/image21.png){width="6.27in"}
...
![Figure 15: Urban expansion: Several changes with an area \<0,5 ha make up a complex change area of 0,5 ha (0,1 ha of 4.1.0.0 and 0,4 ha of 2.1.1.0 changed to 0,5 ha of 1.1.1.1)](2012-2018_PUM_v1-media/image22.png){width="4.15in"}
...
![Figure 16: Polygons \<0,5 ha with no change (4.1.0.0) but connected to polygons (1.3.1) where there is a change](2012-2018_PUM_v1-media/image23.png){width="5.47in"}
...
![Figure 17: Simple change](2012-2018_PUM_v1-media/image24.png){width="6.27in"}
...
![Figure 18: Simple change](2012-2018_PUM_v1-media/image25.png){width="6.27in"}
...
![Figure 19: Small change integrated into adjacent change](2012-2018_PUM_v1-media/image26.png){width="6.27in"}
...
![Figure 20: Generalisation (disappearing polygon)](2012-2018_PUM_v1-media/image27.png){width="6.27in"}
...
![Figure 21: A new Aquaculture pond (8.2.3) is established on semi-natural grassland (4.2.x).](2012-2018_PUM_v1-media/image28.png){width="6.27in"}
...
![Figure 22: New established feature with splitted change](2012-2018_PUM_v1-media/image29.png){width="6.27in"}
...
|------------|-------------------------------|--------------------------------------------|--------------------------------------------|----------------------------------------------------------------------|
| 1 | Multipart features m f s f | Check separates all ultipart d eatures into s inglepart eatures | Assurance that all delivered ata is inglepart data | ![](2012-2018_PUM_v1-media/image30.jpeg){width="3.35in"}<br>Source: Esri ArcGIS 10.2 Help |
| 2 | Missing vertices f s v c | Check that all adjacent eatures i hare all t ertices at s ommon edges | Assurance that delivery data s opologically ound | ![](2012-2018_PUM_v1-media/image31.JPG){width="1.7in"}<br>Source: Interpretation data |
| 3 | Overlaps f p n e | Check that eature d olygons do i ot overlap o ach other | Assurance that elivery data s free of verlaps | ![](2012-2018_PUM_v1-media/image32.JPG){width="1.13in"}<br>Source: Esri ArcGIS 10.2 Help |
| 4 | Gaps f p n g e | Check that eature d olygons do i ot possess aps between ach other | Assurance that elivery data s free of gaps | ![](2012-2018_PUM_v1-media/image33.JPG){width="1.38in"}<br>Source: Esri ArcGIS 10.2 Help |

| No. | Check | Description | Purpose | Example |
|------------|----------------------------------------|------------------------------------------|------------------------------------------|----------------------------------------------------------------|
| 1 | Multipart | Check separates features into singlepart features s | Assurance that all delivered data is inglepart data. | ![](2012-2018_PUM_v1-media/image30.jpeg){width="3.35in"}<br>Source: Esri ArcGIS 10.2 Help |
| 2 | Missing vertices | Check that all adjacent features share all vertices at common edges ( c | Assurance that delivery data is topologically sound share exactly ommon edges) | ![](2012-2018_PUM_v1-media/image31.JPG){width="1.7in"}<br>Source: Interpretation data |
| 3 | Overlaps | Check that feature polygons do not overlap each other | Assurance that delivery data is free of overlaps | ![](2012-2018_PUM_v1-media/image32.JPG){width="1.13in"}<br>Source: Esri ArcGIS 10.2 Help |
| 4 | Gaps | Check that feature polygons do not possess gaps between each other | Assurance that delivery data is free of gaps | ![](2012-2018_PUM_v1-media/image33.JPG){width="1.38in"}<br>Source: Esri ArcGIS 10.2 Help |
...
| 9 | Unnecessary polygon boundaries | Check finds adjacent polygons with same attribution p | Assurance that delivery data is free of unnecessary olygon boundaries | ![](2012-2018_PUM_v1-media/image34.jpeg){width="4.25in"}<br>Source: interpretation data |
...
| 15 | Attribution completeness of attribute tables | Check completeness of attribute tables | Assure that all attributes are complete and correct | ![](2012-2018_PUM_v1-media/image35.png){width="4.89in"} |
...
| 17 | Projection | Check projection h | LAEA-projection as to be defined | ![](2012-2018_PUM_v1-media/image36.png){width="2.21in"} |
