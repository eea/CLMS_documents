...
![Figure 1: Riparian Zones 2012-2018 product portfolio](2012-2018_PUM_v1-media/Fig1.png)
...
![Figure 2: The 43 Riparian Zones Delivery Units (based on ECRINS v1.1)](2012-2018_PUM_v1-media/image6.png)
...
![](2012-2018_PUM_v1-media/Table1.png)

![](2012-2018_PUM_v1-media/Table2.png)

![](2012-2018_PUM_v1-media/Table3.png)

![](2012-2018_PUM_v1-media/Table4.png)
...
![Figure 3: AoI amendment example of Str-2 hanging rivers connected to Str. 3](2012-2018_PUM_v1-media/image7.png)

![Figure 4: AoI amendment to include Lake Outline](2012-2018_PUM_v1-media/image8.png)
...
![Table 8: Recoding of the UA Core areas into the RZ Nomenclature](2012-2018_PUM_v1-media/Picture1.png)
...
![Figure 5: UA2012/2018 Integration into the RZ project](2012-2018_PUM_v1-media/image10.png)
...
![Figure 6: Delineation avoiding smooth lines](2012-2018_PUM_v1-media/image11.png)
...
![Figure 7: Delineation avoiding acute angles](2012-2018_PUM_v1-media/image14.png)
...
![Figure 8: MMU exception at RZ border](2012-2018_PUM_v1-media/image15.png)
...
![Figure 9: MMU exception of linear elements](2012-2018_PUM_v1-media/image16.png)
...
![Figure 10: MMU exception between roads](2012-2018_PUM_v1-media/image17.jpeg)
...
![Figure 11: MMW exception](2012-2018_PUM_v1-media/image18.png)
...
![Figure 12: A Green urban area (1.4.0.0) ≥0,5 ha in 2012 changes into Continuous urban fabric (1.1.1.1) in 2018](2012-2018_PUM_v1-media/image19.png)
...
![Figure 13: Changes (Continuous urban fabric 0,4 ha, water area 0,15 ha) with an area \<0,5 ha and different classes make up a complex change area of 0,55 ha](2012-2018_PUM_v1-media/image20.png)
...
![Figure 14: An Olive grove (2.2.2.0) changed into Vineyards, fruit trees and berry plantations (2.2.1.0) and Industrial, commercial and military units (1.1.2.0), but because the areas are \<0,5 ha, they are merged with the neighbouring objects.](2012-2018_PUM_v1-media/image21.png)
...
![Figure 15: Urban expansion: Several changes with an area \<0,5 ha make up a complex change area of 0,5 ha (0,1 ha of 4.1.0.0 and 0,4 ha of 2.1.1.0 changed to 0,5 ha of 1.1.1.1)](2012-2018_PUM_v1-media/image22.png)
...
![Figure 16: Polygons \<0,5 ha with no change (4.1.0.0) but connected to polygons (1.3.1) where there is a change](2012-2018_PUM_v1-media/image23.png)
...
![Figure 17: Simple change](2012-2018_PUM_v1-media/image24.png)
...
![Figure 18: Simple change](2012-2018_PUM_v1-media/image25.png)
...
![Figure 19: Small change integrated into adjacent change](2012-2018_PUM_v1-media/image26.png)
...
![Figure 20: Generalisation (disappearing polygon)](2012-2018_PUM_v1-media/image27.png)
...
![Figure 21: A new Aquaculture pond (8.2.3) is established on semi-natural grassland (4.2.x).](2012-2018_PUM_v1-media/image28.png)
...
![Figure 22: New established feature with splitted change](2012-2018_PUM_v1-media/image29.png)
...
+:==========+:===========================+:======================================================================+:===================================================+:==================================================================================================+
| 1         | Multipart features m f s f | Check separates all ultipart d eatures into s inglepart eatures       | Assurance that all delivered ata is inglepart data | ![](2012-2018_PUM_v1-media/image30.JPEG){width="2.9032261592300963in" height="1.3333333333333333in"}\ |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 2         | Missing vertices f s v c   | Check that all adjacent eatures i hare all t ertices at s ommon edges | Assurance that delivery data s opologically ound   | ![](2012-2018_PUM_v1-media/image31.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Interpretation data                                                                       |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 3         | Overlaps f p n e           | Check that eature d olygons do i ot overlap o ach other               | Assurance that elivery data s free of verlaps      | ![](2012-2018_PUM_v1-media/image32.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 4         | Gaps f p n g e             | Check that eature d olygons do i ot possess aps between ach other     | Assurance that elivery data s free of gaps         | ![](2012-2018_PUM_v1-media/image33.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
...
| No. | Check                                                            | Description                                                                                   | Purpose                                                                                                | Example                                                                                                                                                                                                                                                                                                                        |
+:===:+:=================================================================+:==============================================================================================+:======================================================================================================:+:==============================================================================================================================================================================================================================================================================================================================:+
| 1   | Multipart                                                        | Check separates features into singlepart features s                                           | Assurance that all delivered data is inglepart data.                                                   | ![](2012-2018_PUM_v1-media/image30.JPEG){width="2.9in" height="1.33in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2   | Missing vertices                                                 | Check that all adjacent features share all vertices at common edges ( c                       | Assurance that delivery data is topologically sound share exactly ommon edges)                         | ![](2012-2018_PUM_v1-media/image31.JPG){width="2.27in" height="1.53in"}                                                                                                                                                                                                                                                            |
|     |                                                                  |                                                                                               |                                                                                                        |                                                                                                                                                                                                                                                                                                                                |
|     |                                                                  |                                                                                               |                                                                                                        | Source: Interpretation data                                                                                                                                                                                                                                                                                                    |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3   | Overlaps                                                         | Check that feature polygons do not overlap each other                                         | Assurance that delivery data is free of overlaps                                                       | ![](2012-2018_PUM_v1-media/image32.JPG){width="0.99in" height="1.03in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4   | Gaps                                                             | Check that feature polygons do not possess gaps between each other                            | Assurance that delivery data is free of gaps                                                           | ![](2012-2018_PUM_v1-media/image33.JPG){width="1.30in" height="0.97in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 9   | Unnecessary polygon boundaries                                   | Check finds adjacent polygons with same attribution p                                         | Assurance that delivery data is free of unnecessary olygon boundaries                                  | ![](2012-2018_PUM_v1-media/image34.JPEG){width="2.90in" height="0.87in"} Source: interpretation data                                                                                                                                                                                                                               |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 15  | Attribution completeness of attribute tables                     | Check completeness of attribute tables                                                        | Assure that all attributes are complete and correct                                                    | ![](2012-2018_PUM_v1-media/image35.png){width="2.90in" height="0.39in"}                                                                                                                                                                                                                                                            |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 17  | Projection                                                       | Check projection h                                                                            | LAEA-projection as to be defined                                                                       | ![](2012-2018_PUM_v1-media/image36.png){width="2.85in" height="0.78in"}                                                                                                                                                                                                                                                            |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
