...
![Figure 3-1 Evolution of HRL Forest and Grassland towards the three product groups HRL Tree Cover & Forests, HRL Grasslands, HRL Croplands.](Product_User_Manual-media/img-e79a17cf553119f8377b001ffc12b7e1787f7098.png)
...
![Figure 5-1: Products within the HRL vegetated land cover characteristics.](Product_User_Manual-media/img-5ffcb441cde1eb0e5c25696fe98984f1817eb864.png)
...
![Figure 5-2: High-level overview of the relationship between the Base Vegetation Layer and the subsequent production of Grasslands, Croplands and Tree Cover & Forests products](Product_User_Manual-media/img-813e9da3364258b08029cd0fa0b27a1c92440fc4.png)
...
![Figure 7-1: LAEA tile layout incl. distinction between tiles to cover EU27 and EEA38.](Product_User_Manual-media/img-7cbffb4e28195ea5f90ae8fdcbdb8a4a9911aed9.jpg)
...
![Figure 7-2: Worflow dependencies of HRL Grasslands layers](Product_User_Manual-media/img-c5554fecfa28620f521b7ed7b9f6161ef53ff84d.jpg)
...
![Figure 7-3: Grouping of GRAME and GRAMD for one reference year.](Product_User_Manual-media/img-3f8e349450591978a7802510775bea060e0bdae6.png)
...
![Figure 7-4: HRL Grasslands product portfolio](Product_User_Manual-media/img-9fa170fe843818b2e5ca4ce8ebfb817acf3080e3.png)
...
![Figure 7-5: Exemplary NDVI time-series illustrating the typical drops after mowing events.](Product_User_Manual-media/img-55e21933a7ca7d8e7557cd2ee944f27e8d0e5544.png)
...
![Figure 8-1: Spatial distribution of 14.000 Primary Sampling Units.](Product_User_Manual-media/img-9fbefbdf18646ff6d9b0a24ceb1cc62433079267.jpg)
...
+============+=====================+=======+=======+=======+=============================================================================+
| 0          | all non-grass areas | 240   | 240   | 240   | ![](Product_User_Manual-media/all_non-grass_areas.png)    |
+------------+---------------------+-------+-------+-------+-----------------------------------------------------------------------------+
| 1          | grassland           | 163   | 199   | 56    | ![](Product_User_Manual-media/grassland.png)              |
+------------+---------------------+-------+-------+-------+-----------------------------------------------------------------------------+
| 255        | outside area        | 0     | 0     | 0     | ![](Product_User_Manual-media/outside_area.png)           |
+------------+---------------------+-------+-------+-------+-----------------------------------------------------------------------------+
...
|   Class Code |   Class Name                                        |   Red |   Green |   Blue |                                                                                                          |
+==============+=====================================================+=======+=========+========+==========================================================================================================+
| 0            | non-grassland in reference year                     | 240   | 240     | 240    | ![](Product_User_Manual-media/non-grassland_in_reference_year.png)                     |
+--------------+-----------------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 1            | permanent and temporary grassland in reference year | 116   | 151     | 11     | ![](Product_User_Manual-media/permanent_and_temporary_grassland_in_reference_year.png) |
+--------------+-----------------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 255          | outside area                                        | 0     | 0       | 0      | ![](Product_User_Manual-media/outside_area.png)                                        |
+--------------+-----------------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
...
|   Class Code |   Class Name                               |   Red |   Green |   Blue |                                                                                                          |
+==============+============================================+=======+=========+========+==========================================================================================================+
| 0            | Indication of ploughing in current year    | 66    | 0       | 0      | ![](Product_User_Manual-media/Indication_of_ploughing_in_current_year.png)             |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 1            | 1 year since last indication of ploughing  | 128   | 0       | 0      | ![](Product_User_Manual-media/1_year_since_last_indication_of_ploughing.png)           |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 2            | 2 years since last indication of ploughing | 199   | 60      | 18     | ![](Product_User_Manual-media/2_years_since_last_indication_of_ploughing.png)          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 3            | 3 years since last indication of ploughing | 230   | 107     | 37     | ![](Product_User_Manual-media/3_years_since_last_indication_of_ploughing.png)          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 4            | 4 years since last indication of ploughing | 247   | 153     | 59     | ![](Product_User_Manual-media/4_years_since_last_indication_of_ploughing.png)          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 5            | 5 years since last indication of ploughing | 252   | 201     | 91     | ![](Product_User_Manual-media/5_years_since_last_indication_of_ploughing.png)          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 6            | 6 years since last indication of ploughing | 255   | 236     | 140    | ![](Product_User_Manual-media/6_years_since_last_indication_of_ploughing.png)          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 100          | Change of herbaceous cover                 | 229   | 251     | 17     | ![](Product_User_Manual-media/Change_of_herbaceous_cover.png)                          |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 253          | no ploughing information                   | 240   | 240     | 240    | ![](Product_User_Manual-media/no_ploughing_information.png)                            |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
| 255          | outside area                               | 0     | 0       | 0      | ![](Product_User_Manual-media/outside_area.png)                                        |
+--------------+--------------------------------------------+-------+---------+--------+----------------------------------------------------------------------------------------------------------+
...
| Class Code | Class Name                                    | Red   | Green | Blue  |                                                                                                     |
+============+===============================================+=======+=======+=======+=====================================================================================================+
| 0          | unchanged non-grassland in both years         | 240   | 240   | 240   |  ![](Product_User_Manual-media/unchanged_non-grassland_in_both_years.png)         |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
| 1          | grassland gain                                | 0     | 141   | 246   |  ![](Product_User_Manual-media/grassland_gain.png)                                |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
| 2          | grassland loss                                | 255   | 0     | 0     |  ![](Product_User_Manual-media/grassland_loss.png)                                |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
| 10         | unchanged grassland in both years             | 163   | 199   | 56    |  ![](Product_User_Manual-media/unchanged_grassland_in_both_years.png)             |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
| 254        | unclassifiable in any of parent status layers | 153   | 153   | 153   |  ![](Product_User_Manual-media/unclassifiable_in_any_of_parent_status_layers.png) |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
| 255        | outside area                                  | 0     | 0     | 0     |  ![](Product_User_Manual-media/outside_area.png)                                  |
+------------+-----------------------------------------------+-------+-------+-------+-----------------------------------------------------------------------------------------------------+
...
| Class Code | Class Name                  | Red                      | Green                    | Blue                     |                                                                                |
+============+=============================+==========================+==========================+==========================+================================================================================+
| 0          | 0% grassland confidence     | 194                      | 82                       | 60                       |  ![](Product_User_Manual-media/0_grassland_confidence.png)   |
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 50         | 50% grassland confidence    | 123                      | 237                      | 0                        |   ![](Product_User_Manual-media/50_grassland_confidence.png) |
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 100        | 100% grassland confidence   | 12                       | 47                       | 122                      |   ![](Product_User_Manual-media/100_grassland_confidence.png)|
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 253        | all non-grassland areas     | 240                      | 240                      | 240                      |   ![](Product_User_Manual-media/all_non-grassland_areas.png) |
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 255        | outside area                | 0                        | 0                        | 0                        |    ![](Product_User_Manual-media/outside_area.png)           |
+------------+-----------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
| Class Code | Class Name                         | Red                      | Green                    | Blue                     |                                                                                |
+============+====================================+==========================+==========================+==========================+================================================================================+
| 0          | 0% grassland change confidence     | 194                      | 82                       | 60                       |    ![](Product_User_Manual-media/0_grassland_confidence.png) |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 50         | 50% grassland change confidence    | 123                      | 237                      | 0                        |   ![](Product_User_Manual-media/50_grassland_confidence.png) |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 100        | 100% grassland change confidence   | 12                       | 47                       | 122                      |   ![](Product_User_Manual-media/100_grassland_confidence.png)|
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 253        | all non-grassland change areas     | 240                      | 240                      | 240                      |   ![](Product_User_Manual-media/all_non-grassland_areas.png) |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
| 255        | outside area                       | 0                        | 0                        | 0                        |   ![](Product_User_Manual-media/outside_area.png)            |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+--------------------------------------------------------------------------------+
...
| Class Code | Class Name                         | Red                      | Green                    | Blue                     |                                                                               |
+============+====================================+==========================+==========================+==========================+===============================================================================+
| 0          | 0% grassland mowing confidence     | 194                      | 82                       | 60                       |  ![](Product_User_Manual-media/0_grassland_confidence.png)  |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
...
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
| 50         | 50% grassland mowing confidence    | 123                      | 237                      | 0                        |  ![](Product_User_Manual-media/50_grassland_confidence.png) |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
...
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
| 100        | 100% grassland mowing confidence   | 12                       | 47                       | 122                      |  ![](Product_User_Manual-media/100_grassland_confidence.png)|
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
| 253        | All non-mowing areas               | 240                      | 240                      | 240                      | ![](Product_User_Manual-media/all_non-grassland_areas.png)  |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
| 255        | outside area                       | 0                        | 0                        | 0                        |  ![](Product_User_Manual-media/outside_area.png)            |
+------------+------------------------------------+--------------------------+--------------------------+--------------------------+-------------------------------------------------------------------------------+
...
| Class Code | Class Name                                                        | Red  | Green | Blue |                                                                                                                           |
+============+===================================================================+======+=======+======+===========================================================================================================================+
| 0          | all non-mowing areas                                              | 240  | 240   | 240  | ![](Product_User_Manual-media/all_non-grass_areas.png)                                                  |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 1          | all grassland areas that have been mowed once                     | 237  | 248   | 251  | ![](Product_User_Manual-media/all_grassland_areas_that_have_been_mowed_once.png)                        |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 2          | all grassland areas that have been mowed twice                    | 178  | 226   | 226  |  ![](Product_User_Manual-media/all_grassland_areas_that_have_been_mowed_twice.png)                      |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 3          | all grassland areas that have been mowed three times              | 102  | 194   | 164  |  ![](Product_User_Manual-media/all_grassland_areas_that_have_been_mowed_three_times.png)                |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 4+         | all grassland areas that have been mowed four times or more times | 35   | 139   | 69   |  ![](Product_User_Manual-media/all_grassland_areas_that_have_been_mowed_four_times_or_more_times.png)   |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 253        | all non-herbaceous areas                                          | 240  | 240   | 240  |  ![](Product_User_Manual-media/all_non-herbaceous_areas.png)                                            |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
| 255        | outside area                                                      | 0    | 0     | 0    |  ![](Product_User_Manual-media/outside_area.png)                                                        |
+------------+-------------------------------------------------------------------+------+-------+------+---------------------------------------------------------------------------------------------------------------------------+
...
| Class Code  | Class Name                          | Red                      | Green                    | Blue                     |                                                                                 |
+=============+=====================================+==========================+==========================+==========================+=================================================================================+
| 0           | no mowing detected                  | 240                      |  240                     | 240                      |  ![](Product_User_Manual-media/no_mowing_detected.png)        |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
| 1           | 01.01.YYYY mowing date              | 255                      | 237                      | 195                      |   ![](Product_User_Manual-media/01.01.YYYY_mowing_date.png)   |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
...
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
| 182         | 01.07.YYYY mowing date              | 175                      | 74                       | 51                       |    ![](Product_User_Manual-media/01.07.YYYY_mowing_date.png)  |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
...
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
| 366         | 31.12.YYYY mowing date              | 113                      | 12                       | 2                        |   ![](Product_User_Manual-media/31.12.YYYY_mowing_date.png)   |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
| 65533       | all non-herbaceous areas            | 240                      | 240                      | 240                      |  ![](Product_User_Manual-media/all_non-herbaceous_areas.png)  |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
| 65535       | outside area                        | 0                        | 0                        | 0                        |  ![](Product_User_Manual-media/outside_area.png)              |
+-------------+-------------------------------------+--------------------------+--------------------------+--------------------------+---------------------------------------------------------------------------------+
