...
![HRL SLF 2021 workflow](CLMS_ATBD_HRLSLF_v1-media/img-19af4590dd266c8c9cb96e9eebf8f88e30ed117f.png){width="6.27in" #fig-figure1}
...
![Urban Mask production steps](CLMS_ATBD_HRLSLF_v1-media/img-f1a2f36404cd309a9239b2a29b76a6fc4622a636.png){width="4.73in" #fig-figure2}
...
![External dataset used for Reference Database sampling stratification](CLMS_ATBD_HRLSLF_v1-media/img-cdea45cb195629a1bdac80dbd5adc2aab5f6a896.png){width="5.81in" #fig-figure3}

![Reference Database samples distribution](CLMS_ATBD_HRLSLF_v1-media/img-0aeffbc120bdc6740e4085604ad2c7f3d15b624c.png){width="6.27in" #fig-figure4}
...
![Reference database patch example](CLMS_ATBD_HRLSLF_v1-media/img-7f7921a5b76c664e0971072cce1e96907da340a1.png){width="5.34in" #fig-figure5}
...
![Model architecture of SATLASNET. Separate heads can be used to predict outputs of different formats or different thematic nature (source: Bastani et al, 2023)](CLMS_ATBD_HRLSLF_v1-media/img-6359dfdbf09c541f640c3720b6a554f4f2bf2223.png){width="6.27in" #fig-figure6}
...
![U-NET super resolution prediction at 5m. Single trees visible on VHR data (left) are  also visible in the prediction from Sentinel 2 imagery (right)](CLMS_ATBD_HRLSLF_v1-media/img-01b50e5d324407691b81fab81cbccc1fefddbb48.png){width="6.27in" #fig-figure7}
...
![An erosion followed by a dilation operation allows to distinguish between linear and patchy features in the raster](CLMS_ATBD_HRLSLF_v1-media/img-aa134eba6cce3b395453b7fc397b281b18a661be.png){width="6.21in" #fig-figure8}
...
![Identified polygons in the intermediate product. The image shows an area close to Merano, Italy and demonstrates the identification of agricultural areas.](CLMS_ATBD_HRLSLF_v1-media/img-767c0ee584714b1b05aa33bef49f66b0a83d5175.png){width="6.27in" #fig-figure9}
...
![Example of the random distribution of SSUs within a PSU](CLMS_ATBD_HRLSLF_v1-media/img-a9079df225d0f0e930a75fb45cb4dd8fd3583733.png){width="2.63in" #fig-figure10}
...
![Comparison of densely planted orchards between 20cm imagery and 2m imagery](CLMS_ATBD_HRLSLF_v1-media/img-744ae8fbb0a096ed9cbb611f481a8d6d01051dc6.png){width="6.27in" #fig-figure11}
