---
title: 'Medium Resolution Vegetation Phenology and Productivity (MR-VPP) – Product User Manual (PUM)'
...
![Figure 1. Examples of TIMESAT-derived phenology and productivity parameters. (a) start of season, (b) end of season, (c) length of season, (d) minimum value, (e) time of maximum, (f) maximum value, (g) amplitude, (h) seasonal productivity, and (h+i) total productivity. Source: https://web.nateko.lu.se/timesat/timesat.asp.](MRVPP_PUM_v1-media/img-72efb44e1dfa69faac1d13f39bea722c.png)
...
![Figure 2. Product structure of MR-VPP Version 5.0 Issue 2.0. The product suite is generated from MODIS Collection 6.1 MCD43A4 NBAR data and associated MCD43A2 quality and geometry information. PPI is calculated from red and near-infrared NBAR reflectance, quality-weighted using MCD43A2 information, and processed with TIMESAT Version 4.2 to generate smoothed seasonal trajectories. The delivered products include 5-day PPI time-series products with PPI QA, and annual VPP parameter products with VPP QA for up to two growing seasons per year over the EEA-39 region and Ukraine.](MRVPP_PUM_v1-media/img-8dd2854b2170c7518ac857ca3cbb7327.png)
...
![Figure 3. Illustration of growing-season identification and year assignment. Coarse-season peaks are indicated by A-D, and the corresponding local minima by a-e. Red markers indicate the start and end points of the detected growing seasons. Seasons are assigned to the year of their maximum-of-season date; for example, the season a-A-b is assigned to 2018, while the seasons associated with peaks C and D are assigned to 2019.](MRVPP_PUM_v1-media/img-e327e97c5ca0229593c063986753a343.png)
...
<tr>
  ...
  <tr>
    <td style="font-weight:bold" colspan="2">Aux QA</td>
    <td>UINT8</td>
    <td>-</td>
    <td>-</td>
    <td>255</td>
...
![Figure 4. Illustration of VPP parameter quality assurance (QA) determination.](MRVPP_PUM_v1-media/img-b5facdd86845d0e68cb56a730c9b2619.png)

![Figure 5. Conceptual structure of the 8-bit VPP QA flag.](MRVPP_PUM_v1-media/img-ec5261ebdf953a8430dfbb279d7b5b46.png)
...
![Figure 6. Using TPROD to assess the 2018 Northern Europe drought impacts in agriculture, using reference year 2017. Drought data are from the Lund University Global Drought Dataset (LUGD) https://zenodo.org/records/18985819](MRVPP_PUM_v1-media/img-1d7ec6d66874d329e63ebd0d2fda4fe4.png)
