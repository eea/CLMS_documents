...
![Figure 1: Riparian Zones 2012-2018 product portfolio](Product_User_Manual-media/Fig1.png)
...
![Figure 2: The 43 Riparian Zones Delivery Units (based on ECRINS v1.1)](Product_User_Manual-media/image6.png)
...
![](Product_User_Manual-media/Table3.png)

![](Product_User_Manual-media/Table4.png)
...
![Figure 3: AoI amendment example of Str-2 hanging rivers connected to Str. 3](Product_User_Manual-media/image7.png)

![Figure 4: AoI amendment to include Lake Outline](Product_User_Manual-media/image8.png)
...
![Table 8: Recoding of the UA Core areas into the RZ Nomenclature](Product_User_Manual-media/Picture1.png)
...
![Figure 5: UA2012/2018 Integration into the RZ project](Product_User_Manual-media/image10.png)
...
![Figure 6: Delineation avoiding smooth lines](Product_User_Manual-media/image11.png)
...
![Figure 7: Delineation avoiding acute angles](Product_User_Manual-media/image14.png)
...
![Figure 8: MMU exception at RZ border](Product_User_Manual-media/image15.png)
...
![Figure 9: MMU exception of linear elements](Product_User_Manual-media/image16.png)
...
![Figure 10: MMU exception between roads](Product_User_Manual-media/image17.jpeg)
...
![Figure 11: MMW exception](Product_User_Manual-media/image18.png)
...
![Figure 12: A Green urban area (1.4.0.0) ≥0,5 ha in 2012 changes into Continuous urban fabric (1.1.1.1) in 2018](Product_User_Manual-media/image19.png)
...
![Figure 13: Changes (Continuous urban fabric 0,4 ha, water area 0,15 ha) with an area \<0,5 ha and different classes make up a complex change area of 0,55 ha](Product_User_Manual-media/image20.png)
...
![Figure 14: An Olive grove (2.2.2.0) changed into Vineyards, fruit trees and berry plantations (2.2.1.0) and Industrial, commercial and military units (1.1.2.0), but because the areas are \<0,5 ha, they are merged with the neighbouring objects.](Product_User_Manual-media/image21.png)
...
![Figure 15: Urban expansion: Several changes with an area \<0,5 ha make up a complex change area of 0,5 ha (0,1 ha of 4.1.0.0 and 0,4 ha of 2.1.1.0 changed to 0,5 ha of 1.1.1.1)](Product_User_Manual-media/image22.png)
...
![Figure 16: Polygons \<0,5 ha with no change (4.1.0.0) but connected to polygons (1.3.1) where there is a change](Product_User_Manual-media/image23.png)
...
![Figure 17: Simple change](Product_User_Manual-media/image24.png)
...
![Figure 18: Simple change](Product_User_Manual-media/image25.png)
...
![Figure 19: Small change integrated into adjacent change](Product_User_Manual-media/image26.png)
...
![Figure 20: Generalisation (disappearing polygon)](Product_User_Manual-media/image27.png)
...
![Figure 21: A new Aquaculture pond (8.2.3) is established on semi-natural grassland (4.2.x).](Product_User_Manual-media/image28.png)
...
![Figure 22: New established feature with splitted change](Product_User_Manual-media/image29.png)
