...
- `CLMS_WSI-WDS-SSC-S1B_20210217T053159_R60m_T32TNS_V01-R00.tif` (sensing datetime, sub-product in the code-variable compound)
...
- `CLMS_WSI-WDS-SSC-S1B_20210217T053159_R60m_T32TNS_V01-R00.tif` (sensing datetime)
...
- `CLMS_WSI-WDS-SSC-S1B_20210217T053159_R60m_T32TNS_V01-R00.tif` (MGRS, SAR sensor)
...
**Rule:** No standalone sensor token in the filename. The sensor is implicit in the product code. Include a sensor identifier only when the product supports multiple sensor sources distinguishable at file level (e.g., SAR platform identity `S1B`). When needed, the sensor is hyphenated into the code-variable compound at position 2 — not appended as a separate trailing field.

**Compliant:**

- `CLMS_WSI-SP-SCD_A20200901P1Y_R20m_T38TKL_V01-R00.tif` (no sensor — implicit)
- `CLMS_WSI-WDS-SSC-S1B_20210217T053159_R60m_T32TNS_V01-R00.tif` (S1B sensor hyphenated into the code-variable compound for SAR discrimination)
