...
category: products
date: '2026-02-05'
subtitle: Copernicus Land Monitoring Service – Priority Area Monitoring – Urban Atlas
  2021 and 2024
...
![83 Urban Atlas FUA's with more than 50,000 inhabitants used for this study](CLMS_UA2021_LULC_PUM_v1-media/img-87c21c7c04e003001a144ad28cc9305d084946ca.png){width="6.27in" #fig-figure2}
...
![UA2021 status layer for Bruxelles/Brussel/Leuven](CLMS_UA2021_LULC_PUM_v1-media/img-54059741438c873bd6ecb859d30620018f9ab691.png){width="6.27in" #fig-figure3}
...
![Exception rule for the minimum mapping width](CLMS_UA2021_LULC_PUM_v1-media/img-87d1a7009176100d4a09373b0e22528bc1120b3c.png){width="6.27in" #fig-figure4}
...
![Change detection based on VHR (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1-media/figure5.png){width="5.64in" #fig-figure5}
...
![Change detection based on Sentinel-2 (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1-media/figure6.png){width="3.6in" #fig-figure6}
...
![Extracted change detection layer (location: Bordeaux, France)](CLMS_UA2021_LULC_PUM_v1-media/figure7.png){width="3.01in" #fig-figure7}
...
![Examples of the public, private and unknown classes in Iasi, Romania. For completeness, the figure also includes class 14200 - recreational and sport areas](CLMS_UA2021_LULC_PUM_v1-media/img-b2a5ee3fbe67ecb823db882daf38b32172f70c3f.png){width="6.27in" #fig-figure8}
