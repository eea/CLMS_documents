...
In order to clarify certain mapping delineations, there are some comments defined as product attributes.
  ...
  **Order No**   **Description; Note**                                                                                                                                                                                                                                                   **Comment**
  ...
  : []{#_Toc30603721 .anchor}Table 3: List of allowed comments
...
: []{#_Ref30584272 .anchor}Table 4: High level description of the CZ LC/LU nomenclature
...
![Left side. Very precise OSM delineation Keep OSM, and just correct errors. Right side: manual delineation -- map urban outline  generalized. Example from Poland. SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image35.png)
...
![Ataturk dam, Sanliurfa region (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image41.png)
...
![3.5 Lines of trees and scrub surrounded by road network (1.2.1) and area \< 0.5 ha: map as associated feature and generalize into road](./CZ-media/media/image50.png)
...
![Industrial site with railways from ancillary data in turquoise. Example from Stockholm (Sweden). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image54.png)
...
![Clear cuts between harvesting and restoration in an eucalyptus plantation. Cortegana (Huelva, Spain) SPOT-5 (2.5 m) (NIR Band Combination). Date: 2011-08-06. Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image185.png)
...
![Coniferous forest located at the Monsini Danube River near Magyarkimle (Hungary). Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image192.png)
...
![CLC Class 322 "Moors and heathland" used to localize heathland. Munster in Germany (Niedersachsen), SPOT-5 (2.5m), Date: 2011-05-06. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image305.jpeg)
...
+----------------------------+----------------------------------------------------------------------------------------------+
| **Document Main Authors:** | > Florian Innerbichler (GeoVille), Alexander Kreisel (GeoVille), Christian Gruber (GeoVille) |
+----------------------------+----------------------------------------------------------------------------------------------+
| **Document Co-Authors:**   |                                                                                              |
+----------------------------+----------------------------------------------------------------------------------------------+
| **Project Officer:**       | Hans Dufourmont (EEA)                                                                        |
+----------------------------+----------------------------------------------------------------------------------------------+
| **Project Manager:**       | Claudio La Mantia (PKI)                                                                      |
+----------------------------+----------------------------------------------------------------------------------------------+
| **Doc. Version:**          | 1.1                                                                                          |
+----------------------------+----------------------------------------------------------------------------------------------+
...
**Document History**
  ...
  **Revision**   **Date**     **Created by**            **Short description of changes**
  -------------- ------------ ------------------------- ------------------------------------------------------------------------------------------------------
  1.1            01/10/2020   GeoVille, PKI, PKH, TPZ   Update of codes according to change in Nomenclature

  1.0            24/01/2020   GeoVille, PKI, PKH, TPZ   Final Nomenclature Guideline

  0.3            19/12/2019   GeoVille, PKI, PKH, TPZ   Preliminary Nomenclature Guideline (incl. adaptions after training, comments to be clarified by EEA)

  0.2            06/12/2019   GeoVille, PKI, PKH, TPZ   Preliminary Nomenclature Guideline (including all adaptations resulting of the User Consultation)

  0.1            21/09/2019   GeoVille, PKI, PKH, TPZ   Preliminary Nomenclature Guideline (before User consultation)
  ------------------------------------------------------------------------------------------------------------------------------------------------------------
