...
![](./CZ-media/media/image1.png)

![Table 2: Detailed CZ LC/LU classes and cross reference to MAES Level 2](./CZ-media/media/image2.png)
...
![Figure 1: The loss of green urban area ≥ 0.5 ha (1.4) in 2012 by becoming urban fabric in 2018.](./CZ-media/media/image8.png)
...
![Figure 2: Urban expansion: Changes with MMU \< 0.5 ha make up a complex change area of 0.5 ha.](./CZ-media/media/image9.png)
...
![Figure 3: Urban expansion: Changes with MMU \< 0.5 ha make up a complex change area of 0.5 ha, but because the single changes would result in an incorrect status map 2018 they are generalized to one class.](./CZ-media/media/image10.png)
...
![Continuous urban fabric IM.D. \>80% (Tallinn, Estonia). Credit: K. Larsson](./CZ-media/media/image12.jpeg)

![Continuous urban fabric IM.D. \>80% (Valencia, Spain). Credit: A. Kreisel](./CZ-media/media/image13.jpeg)
...
![1.1.1.1, City Drammen (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-07-20. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image14.png)

![1.1.1.1, City Skien (Norway). SPOT-5 (2.5 m). (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image15.png)

![1.1.1.1, City Skien (Norway). SPOT-5 and HR I.MD. (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image16.png)
...
![Dense urban fabric (IM.D ≥30-80%): City: Stockholm. Credits: European Union LUCAS 2009](./CZ-media/media/image17.jpeg)

![Dense urban fabric (IM.D ≥30-80%): City: Stockholm. Credits: European Union LUCAS 2009](./CZ-media/media/image18.jpeg)
...
![1.1.1.2 City Larvik (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image19.png)

![1.1.1.2 City Lunde (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image20.png)

![1.1.1.2 City Lunde (Norway). SPOT-5 and HR I.MD. (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image21.png)
...
![Low density urban fabric (IM.D \<30%) (Täby, Sweden). Credits: K. Larsson](./CZ-media/media/image22.jpeg)

![Low density urban fabric (IM.D \<30%) (Costa del Sol, Spain). Credits: M. Palacios](./CZ-media/media/image23.jpeg)
...
![1.1.1.3 Low Density Urban fabric at Siljan region (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image24.png)

![1.1.1.3, City Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination) together with HR IM.D. Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image25.png)

![In regions with scattered houses, only large accumulations of houses are mapped (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image26.png)

![Village Årea (Sweden): Example of generalized delineation of a low density urban fabric area (1.1.1.3). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image27.png)
...
![Example of generalized delineation of a low density urban fabric area, 1.1.1.2 (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image28.png)

![Generalized mapping of scattered urban areas. Gardens have to be included. Gaps of less than 50 meters are generalized and single blocks are connected. Large agricultural areas (width \> 50 m) at the urban border should be excluded.](./CZ-media/media/image29.png)

![Gardens included, outline generalized to support a cartographic representation of urban areas. Otherwise urban areas will be underestimated and not presented correctly. Do not include too much agricultural area (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image30.png)

![Urban mapping example from Poland: SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image31.png)

![Generalize urban outline, include gardens, and use 2.3.2 Complex cultivation patterns for heterogenous areas (example from Poland). SPOT-5 (2.5m) (Poland) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image32.png)

![Generalize urban outline, include gardens, and use 2.3.2 Complex cultivation patterns for heterogenous areas (example from Poland). SPOT-5 (2.5m) (Poland) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image33.png)
...
![UA delineation of a village in Poland presented on SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image34.png)

If OSM delineation is too precise, please correct real errors and perhaps parts of the outline. 

![Left side. Very precise OSM delineation Keep OSM, and just correct errors. Right side: manual delineation -- map urban outline  generalized. Example from Poland. SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image35.png){{< pagebreak >}}
...
![Industrial or commercial units. (Riga, Latvia). Credits: K. Larsson](./CZ-media/media/image36.jpeg)

![Industrial site (Madrid, Spain). Credits: M. Palacios](./CZ-media/media/image37.jpeg)
...
![Industrial site of Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image38.png)

![Example of 1.1.2.1 in Batman, Anatolia region (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image39.png)

![Active archaeological site: Hosap castle -- Guzelsu (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-08-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image40.png)
...
![Ataturk dam, Sanliurfa region (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image41.png){{< pagebreak >}}
...
https://commons.wikimedia.org/w/index.php?curid=7938296](./CZ-media/media/image42.jpeg)

![Gravelines Nuclear Power Station (France). Credit: Raimond Spekking / CC BY-SA 4.0 (via Wikimedia Commons), CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=32461775](./CZ-media/media/image43.jpeg)
...
![Delineation of Gravelines nuclear energy plant and associated land (France). SPOT-6 (1.5m) (4/3/2 Band Combination). Date: 2014-07-17. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image44.png)

![Delineation of* *Vandellòs nuclear energy plant and associated land (Spain). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-09-29. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image45.png)
...
![Road network and associated land (Stockholm, Sweden) Credit: K. Larsson](./CZ-media/media/image46.jpeg)
...
![Example of 1.2.1 from Siljan (Norway) presented on SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image47.png)

![Example of 1.2.1 city of Skien (Norway) presented on SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image48.png)

![Example of 1.2.1 Bismil (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-07-13. Source: CNES 2013©, Distribution Airbus DS/Spot Image](./CZ-media/media/image49.png)
...
![3.5 Lines of trees and scrub surrounded by road network (1.2.1) and area \< 0.5 ha: map as associated feature and generalize into road](./CZ-media/media/image50.png){{< pagebreak >}}
...
![Railways and associated land (Täby, Sweden) Credit: K. Larsson](./CZ-media/media/image51.jpeg)
...
![1.2.2 city of Lunde (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination) Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image52.png)

![1.2.2 city of Gvarv (Norway.) SPOT-5 (2.5m) (1/2/3 Band Combination) Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image53.png)
...
![Industrial site with railways from ancillary data in turquoise. Example from Stockholm (Sweden). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image54.png){{< pagebreak >}}
...
![Port of Antwerp (Belgium). Credit: Arminius, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=3499475](./CZ-media/media/image55.jpeg)

![Cargo port Barcelona (Spain). Credit: A. Kreisel](./CZ-media/media/image56.jpeg)
...
![Delineation of a cargo port area and associated land located at Dunkirk (France). SPOT-6 (1.5m) (4/3/2 Band Combination). Date: 2014-07-17. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image57.png)

![Delineation of a cargo port area and associated land located at Le Havre (France). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-09-09. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image58.png)
...
![Port of Las Palmas (Spain). Credit: By Bengt Nyman from Vaxholm, Sweden - D81_5789, CC BY 2.0, https://commons.wikimedia.org/w/index.php?curid=56716943](./CZ-media/media/image59.jpeg)

![Port of Dover (UK). Credit: DeFacto - Own work, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=71471831](./CZ-media/media/image60.jpeg)
...
![Delineation of a passenger port area and associated land in Tarifa (Spain). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-07. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image61.png)

![Delineation of a passenger port area and associated land located at Split (Croatia). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-11-12. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image62.png)
...
![Fishing port of Keroman in Loirent (France). Credit: Par XIIIfromTOKYO --- Travail personnel, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=15828518](./CZ-media/media/image63.jpeg)
...
![Delineation of a fishing port and associated land located at Loirent (France). SPOT- (2.5m) (1/2/3 Band Combination). Date: 2012-01-14. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image64.png)

**Methodological advice:**

- Delineation of harbour areas of different purposes as well as to urban and industrial units may be difficult. If local in-situ data other than UA is available, use if suitable.{{< pagebreak >}}
...
![Naval Base Toulon (France). Credit: Jesfr - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=7198238](./CZ-media/media/image65.jpeg)
...
![1.2.3.4 Naval port in Toulon (France). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-05-28. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image66.png)
...
![Hohe Düne Marina and Yacht Club Rostock (Germany). Credit: Beauwell - Own work, CC0, https://commons.wikimedia.org/w/index.php?curid=26976918](./CZ-media/media/image67.jpeg)
...
![Delineation of a marina in Split (Croatia). SPOT- (2.5m) (1/2/3 Band Combination). Date: 2011-11-12. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image68.png)

![Delineation of marinas in Dunkirk (France). SPOT-6 (1.5m) (4/3/2 Band Combination). Date: 2014-07-17. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image69.png)
...
![Portofino Harbour (Italy). Credit: Zinnmann - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=78901984](./CZ-media/media/image70.jpeg)
...
![Delineation of a local multi-functional harbour in Pontevenere (Italy). SPOT- (2.5m) (1/2/3 Band Combination). Date: 2011-08-19. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image71.png)
...
![Gdynia Shipyard (Poland). Credit: Vadimka assumed (based on copyright claims). Own work assumed (based on copyright claims)., CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=1436355](./CZ-media/media/image72.jpg)

![Shipyard in Papenburg (Germany). Credit: Ra Boe / Wikipedia, CC BY-SA 3.0 de, https://commons.wikimedia.org/w/index.php?curid=25978461](./CZ-media/media/image73.jpg)
...
![Delineation of a shipyard in Papenburg (Germany). Pléiades 1A (2m) (1/2/3 Band Combination). Date: 2018-07-01. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image74.png)

![Delineation of a shipyard in Pula (Croatia). SPOT-7 (2 m) (1/2/3 Band Combination). Date: 2017-07-26. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image75.PNG)
...
![Airport, (Arlanda Stockholm, Sweden). Credits: K. Larsson](./CZ-media/media/image76.jpeg)
...
![Military airport at Wilhelmswöerth (Germany). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image77.png)

![Airport Worms (Germany).* *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image78.png)

![Erzinkan airport (Turkey)*. *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-09-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image79.png)
...
![Garzweiler surface mine (Germany). Credit: Raimond Spekking / CC BY-SA 4.0 (via Wikimedia Commons), CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=151584](./CZ-media/media/image80.jpeg)

![Gravel pit near Geinsheim (Germany). Credit: Fritz Geller-Grimm - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=3352715](./CZ-media/media/image81.jpeg)
...
![Delineation of mineral extraction site at Bostrac (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image82.png)

![Gravel pit (Turkey)*. *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-08-07. Source: CNES 2013©, Distribution Airbus DS/Spot Image](./CZ-media/media/image83.png)
...
![Dump site (Madrid, Spain). Credits: M. Palacios](./CZ-media/media/image84.jpeg)

![Dump site (Madrid, Spain). Credits: M. Palacios](./CZ-media/media/image85.jpeg)
...
![Delineation of a dump site near Athens (Greece). Pléiades 1B (2m) (1/2/3 Band Combination). Date: 2018-07-16. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image86.png)

![Delineation of a dump site near Málaga (Spain)*. *Pléiades 1B (2m) (1/2/3 Band Combination). Date: 2018-07-21. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image87.png)
...
![Construction site (Cadiz, Spain). Credits: M. Palacios](./CZ-media/media/image88.jpeg)

![Construction site (Malaga, Spain). Credits: M. Palacios](./CZ-media/media/image89.jpeg)
...
![Delineation of construction site at Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image90.png)
...
![Land without current use (Malaga, Spain). Credits: M. Palacios](./CZ-media/media/image91.jpeg)
...
![Land without current use near Porsgun (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image92.jpeg)

![Ruins near Caykoy (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-06-30. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image93.png)

![Unfinished urban development outside Madrid (Spain) SuperView-1 (2m) (1/2/3). Date: 2018-06-24. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image94.png)
...
![Green urban areas (Täby, Sweden). Credits: K. Larsson](./CZ-media/media/image95.jpeg)

![Golf course. Credits: M. Palacios](./CZ-media/media/image96.jpeg)
...
![Green urban area in Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image97.png)

![Golf course at Uleforss (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image98.png)
...
![](./CZ-media/media/Picture1.png){width=20%}
...
- [**2.1 Arable land**]{custom-style="NormalLine"}\

  - 2.1.1 Arable irrigated and non-irrigated land

  - 2.1.2 Greenhouses

- [**2.2 Permanent crops**]{custom-style="NormalLine"}\

  - 2.2.1 Vineyards, fruit trees and berry plantations

  - 2.2.2 Olive groves

- [**2.3 Heterogeneous agricultural area**]{custom-style="NormalLine"}\
...
![Non-irrigated arable land: Rapeseed in Germany. Credits: M. Probeck](./CZ-media/media/image100.png)

![Non-irrigated arable land: Parcel of cereal harvested in Central Spain. Credits: M. Palacios](./CZ-media/media/image101.jpeg)

![Schematic representation of managed non-irrigated arable land.](./CZ-media/media/image102.png)
...
![Non-irrigated agricultural fields in Northern Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-07-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image104.jpeg)
...
![Non-irrigated arable land in central Europe (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-28. Source: CNES 2010©, Distribution Airbus DS/Spot Image](./CZ-media/media/image105.jpeg)

- [Plough furrows are a typical characteristic of crops.]{custom-style="NormalLine"}\

![Non-irrigated arable land in Altnkusak (Anatolia, Turkey) SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-08-05 Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image106.png)

- [Yellow/white colours in summertime.]{custom-style="NormalLine"}\ 

![Non-irrigated arable land in northern Sweden. (1/2/3 Band Combination). SPOT-5 image. Date: 2013-08-05. Source: CNES 2013©, Distribution Airbus DS/Spot.](./CZ-media/media/image107.png)
...
![Irrigation channel in Osmaniye (Turkey). Credits:* *By Ozgurmulazimoglu - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=20304812](./CZ-media/media/image108.png)

![Schematic representation of a permanent irrigated area with irrigation channels.](./CZ-media/media/image109.png)
...
![](./CZ-media/media/image111.png)

The location of the centre-pivot systems can vary from an agricultural year to another within the same area.

![Examples of centre-pivot irrigation system not used to irrigate parcels in summertime. Credits: M. Palacios](./CZ-media/media/image112.jpeg)
...
![Traditional irrigated area in Saka (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-09-06 Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image114.png)
...
![Rice fields at Rosayenda, Italy. SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-07-29. Source: CNES 20011©, Distribution Airbus DS / Spot Image](./CZ-media/media/image115.png)
...
![Viransehir, Turkey. Source: SPOT-5 (2.5 m) Natural colour combination. Date: 2006-09-16. CNES 2006 ©, Distribution Airbus DS / Spot Image](./CZ-media/media/image116.jpeg)
...
![Zaragoza (Ebro valley), Spain. Source: SPOT-5 (2.5 m) Natural colour combination. Date: 2006-08-27 CNES 2006 ©, Distribution Airbus DS / Spot Image](./CZ-media/media/image117.jpeg)
...
![Irrigated fruits trees plantation in Morhamam (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-29 Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image118.png)
...
- [**Traditional irrigated land with permanent infrastructures**:]{custom-style="NormalLine"}\
...
![Example of final result of classification of traditional irrigated land with traditional infrastructures](./CZ-media/media/image120.png)

- [**Irrigated land using underground water**:]{custom-style="NormalLine"}\
...
![Example of final result of classification of irrigated land using underground water](./CZ-media/media/image121.png)

- [**Centre pivot irrigation systems**]{custom-style="NormalLine"}\
...
![Example of final result of classification of centre pivot irrigation systems](./CZ-media/media/image123.png)

- [**Intensively managed fruit trees plantations**:]{custom-style="NormalLine"}\
...
![Example of a final result of classification of intensively managed fruit trees plantations.](./CZ-media/media/image125.png)
...
![Harran (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-04 and 2011-07-15. Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image126.png)
...
![Akoren (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-04. Source: CNES 2011© Distribution Airbus DS/Spot Image. Irrigated parcels are only visible in the image dated 2011-08-15.](./CZ-media/media/image127.png)

![Akoren (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-08-15. Source: CNES 2011© Distribution Airbus DS/Spot Image.* Irrigated parcels are only visible in the image dated 2011-08-15.](./CZ-media/media/image128.png)
...
- Both irrigated and non-irrigated area delimitation should be performed through CORE03 product, while time series Landsat images must be considered to assign the appropriate category (*2.1.1*).  {{< pagebreak >}}
...
![Schematic representation of complex patters of irrigated and non-irrigated arable land](./CZ-media/media/image1291.png)
...
![Example of Type C class 2.1.1 Kallithiro (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-02. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image129.png)

![Example of Type C class 2.1.1 Megala Kalivia (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-02. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image130.png)
...
![Greenhouse in Almeria (Andalusia, Spain). Credit: Eurostat Lucas 2009.](./CZ-media/media/image131.jpeg)

![Greenhouses structure in Almeria (Andalusia, Spain). Credit: Eurostat Lucas 2009.](./CZ-media/media/image132.jpeg)
...
![Nursery with greenhouses, Lampertheim, (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-14 Source: CNES 2010©, Distribution Airbus DS/Spot Image](./CZ-media/media/image133.jpeg)
...
![Nursery with greenhouses, Lampertheim, (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-14 Source: CNES 2010©, Distribution Airbus DS/Spot Image](./CZ-media/media/image134.jpeg)
...
![Greenhouses in Koru (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-29. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image135.jpeg)
...
![Vineyards in Dordogne (France). Credits: C. Alonso](./CZ-media/media/image136.jpeg)

![Vineyards in Duero Valley (Central Spain). Credits: M. Palacios](./CZ-media/media/image137.jpeg)

![Apple trees in Slovakia. Credit: Eurostat Lucas 2009.](./CZ-media/media/image138.jpeg)

![Almond trees in Valencia region (Spain). Credit: Eurostat Lucas 2009.](./CZ-media/media/image139.jpeg)

![Cherry fruit trees, western Germany. Source: © LUCAS 2012](./CZ-media/media/image140.png)

![Low stem fruit trees near Rome, Italy. Source: © LUCAS 2012](./CZ-media/media/image141.png)

![Vineyard in Loutsa (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image142.jpeg)
...
![Vineyards at Úbeda (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image143.jpeg)
...
![Vineyard at Oestrich-Winkel (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image144.jpeg)

- [Characteristic structure: small parcel sizes, terraced cultivation and high reflectance of open soil when cultivated in rows.]{custom-style="NormalLine"}\

![Vineyard at Lösnich (Germany).* *SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image145.jpeg)
...
![High stem fruit trees, Helmarshausen (Germany), Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-28. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image146.jpeg)
...
![High stem fruit trees, Ingelheim am Rhein (Germany), Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image147.png)

- Sometimes planted in small stripes.

- In Central Europe: understory is normally grassland, sometimes also arable land (e.g. Luxemburg).

![Example of pistachio cultivation. Nizip (Turkey) 1/2/3 Band Combination). Date: 2011-05-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image148.jpeg)
...
![Schwarmstedt (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Central Europe (Germany). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image149.jpeg)

![Apple plantation at Schwarmstedt (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image150.jpeg)
...
![Śniadków Dolny (Poland). Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-08-06. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image151.png)
...
![Bogoria (Poland). Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-08-06. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image152.png)
...
![Olive groves in a mountainous area in South-western Spain. Credits: M. Palacios](./CZ-media/media/image153.jpeg)

![Young plantation of olive trees in Southern Spain. Credits: J. Pecci](./CZ-media/media/image154.jpeg)

![Olive groves in Kathenes (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image155.jpeg)

![Olive groves in Kallithea (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image156.jpeg)
...
![Olive grove with vineyards around. Úbeda (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image157.png)

![Olive grove, Badajoz (Spain). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image158.jpeg)
...
![Typical landscape of annual crops in association and mosaic with olive groves and vineyards in Spain. Credit: Eurostat Lucas 2009.](./CZ-media/media/image159.jpeg)
...
![Schematic representation of 2.3.2 complex cultivation patterns](./CZ-media/media/image160.png)
...
![Mix of annual and permanent crops, Bad Salzig (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image161.jpeg)
...
![Agricultural parcel included in an area with vegetation natural (spontaneous grasses, trees, scrub, etc.). Credits: M. Rodriguez](./CZ-media/media/image162.jpeg)

![Schematic representation of 2.3.3 land principally occupied by agriculture with significant areas of natural vegetation](./CZ-media/media/image163.png)
...
![Agricultural area with natural vegetation in Inandik (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-07-16 Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image164.png)

![Land principally occupied by agriculture with significant areas of natural vegetation (2330) in Germersheim (Germany). SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image165.png)
...
![Dehesa of cork oaks with very high T.C.D. in South-western Spain. Credits: M. Palacios](./CZ-media/media/image166.jpeg)

![Dehesa invaded by scrubs. Credits: M. Palacios](./CZ-media/media/image167.jpeg)

![Dehesa in Spain in springtime. Credit: C. Alonso](./CZ-media/media/image168.jpeg)

![Schematic representation of 2.3.4 Agro-forestry T.C.D \< 30%](./CZ-media/media/image169.png)
...
![Badajoz (Spain). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image170.jpeg)

![Example of Agroforestry T.C.D. \< 30% with grassland and arable land understory. Extremadura (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image171.jpeg)
...
- T.C.D. assignation. {{< pagebreak >}}

# 3 Woodland and forest{.unnumbered}

![](./CZ-media/media/picture4.png)
...
![Broadleaved forest (beech), Bavaria, Germany. Credits: M. Probeck](./CZ-media/media/image173.png)

![Broadleaved forest (beech and maple), Stockholm, Sweden. Credits: E. Alkrona](./CZ-media/media/image174.jpeg)

![Broadleaved forest in La Rioja region (Spain). Credits: C. Alonso](./CZ-media/media/image175.jpeg)

![Poplar (Populus sp.) plantation. Credits: M. Palacios](./CZ-media/media/image176.jpeg)

![Broadleaved swamp forest, Island of Rügen, Germany. Credits: U. Weingart](./CZ-media/media/image177.png)

![Broadleaved evergreen forest (Quercus ilex, Quercus coccifera, Juniperus spec.) in Ano Vathia (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image178.jpeg)
...
![Natural & semi-natural deciduous broadleaved forest near the Danube river near Károlyháza (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image179.png)

![Broadleaved forest at the Danube River near Kisbodak (Hungary). Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image180.png){width="4.086805555555555in" height="3.0458333333333334in"}
...
!["Borsteler Moor" near Borstel, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image](./CZ-media/media/image181.png)

[Broadleaved evergreen forest:]{.underline}

![Mediterranean sclerophyllous forest (Quercus rotundifolia) in South Western Spain*. *SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image182.jpeg)
...
![Eucalyptus sp. plantation in Southern Spain. Credit: 2009 Ministerio de Fomento IGN](./CZ-media/media/image183.jpeg)

![Eucalyptus sp. plantation in Southern Spain. Lepe (Huelva, Spain) SPOT-5 (2.5 m) (NIR Band Combination). Date: 2011-08-06. Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image184.png)
...
![Clear cuts between harvesting and restoration in an eucalyptus plantation. Cortegana (Huelva, Spain) SPOT-5 (2.5 m) (NIR Band Combination). Date: 2011-08-06. Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image185.png) {{< pagebreak >}}
...
![Other natural coniferous (spruce) forest in Attali (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image186.jpeg)

![Coniferous forest (Pinus canariensis). Credits: M. Palacios](./CZ-media/media/image187.jpeg)

![Dwarf pine on swampland, Bavaria, Germany. Credits: M. Probeck](./CZ-media/media/image188.png)

![Coniferous forest (Pinus) in Sweden. Source: © LUCAS 2012.](./CZ-media/media/image189.png)
...
![Other natural or semi-natural coniferous forest located near Bezenye (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image190.png)

![Other natural or semi-natural coniferous forest, Harz, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-03. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image191.png)
...
![Coniferous forest located at the Monsini Danube River near Magyarkimle (Hungary). Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image192.png) {{< pagebreak >}}
...
![Highly artificial coniferous plantations (Pine) in the north west of Spain. Source: © LUCAS 2012.](./CZ-media/media/image193.png)
...
![Highly artificial coniferous plantation (Christmas trees) near Gifhorn, Germany. Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-09-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image194.png)

![Highly artificial coniferous plantation (Christmas trees) near Bischofsheim, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-05-25. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image195.png)
...
![Highly artificial coniferous plantation in Central Spain. Credit: 2009 Ministerio de Fomento IGN](./CZ-media/media/image196.png)

![Coniferous plantation in Central Spain. Credit: SPOT-5 (2.5 m) (NIR Band Combination). Date: 2012-07-04. Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image197.png)
...
![Mixed forest (Pinus sylvestris, Quercus petraea), Germany. Source: © LUCAS 2012](./CZ-media/media/image198.png)
...
![Other mixed forest near Runkel, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image](./CZ-media/media/image199.png)
...
![Mixed swamp forest, "Großes Moor" near Uchte, Northern Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image](./CZ-media/media/image200.png)
...
![Transitional woodland. Credits: M. Palacios](./CZ-media/media/image201.jpeg)

![Transitional woodland, Scotland Credits: M. Rosengren](./CZ-media/media/image202.jpeg)
...
![Reeds alongside a Mediterranean River: Credits: M. Palacios](./CZ-media/media/image203.jpeg)
...
![Forest clear-cuts at the Danube river side (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image204.png)

![Transitional forest near Zella-Mehlis, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-08-01. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image205.png)
...
![Lines of tress and scrub, eastern Germany. Source: © LUCAS 2012.](./CZ-media/media/image206.png)
...
![Lines of trees and scrub near Novákpuszta (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image207.png)

![Lines of trees and scrub near Guntershausen, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-10. Source: CNES 2010©, Distribution Airbus DS/Spot Image](./CZ-media/media/image208.png)

![Example: Lines of trees along river with Strahler level 3 → Forest close to riparian zones. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-10-04. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image209.png)

![Example: Lines of forest along river with Strahler level 4 (or higher) → SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-09-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image210.png)
...
![Other damaged forest: Bark-beetle damage, Bavarian Forest, Germany. Credits: M. Probeck](./CZ-media/media/image211.png)

![Other damaged forest: Bark-beetle damage, Bavarian Forest, Germany. Credits: M. Probeck.](./CZ-media/media/image212.png)

![Wildfire in Alcalá la Real (Spain). Credit: Michelangelo-36 - Self-photographed, CC BY 2.5, https://commons.wikimedia.org/w/index.php?curid=1118633](./CZ-media/media/image213.jpeg)
...
![Forest damaged by fire in Benicolet (Spain). Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image214.jpeg)

![Almost 1.500 ha of forest affected by fire in San Joan de Labritja (Spain). Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image215.jpeg)
...
![Bark-beetle damage, Harz National Park, Central Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-03. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image216.png)
...
![Managed (improved) grasslands in Friesland (The Netherlands). Credit: European Union, 2012. LUCAS](./CZ-media/media/image218.jpeg)

![Schematic representation of managed (improved) grasslands](./CZ-media/media/image219.jpeg)

![Managed (semi-improved) grasslands. Prairies in Auvergne, France. Credit: C. Alonso](./CZ-media/media/image220.jpeg)

![Schematic representation of managed (semi-improved) grasslands](./CZ-media/media/image221.jpeg)
...
![Managed grassland in Scandinavia. Borders to arable land. SPOT-5 image.* (*1/2/3 Band Combination). Date: 2011-08-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image222.png)
...
![Managed grasslands plot containing scrubs and trees (right), in this case due a process of land abandonment (Central Spain). Credit: M. Palacios](./CZ-media/media/image223.jpeg)
...
![Hade Edge (United Kingdom). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-01-31. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image224.jpeg)
...
![Example of grassland with trees. Omex (France). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-10-04. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image225.png)
...
![Managed (semi-improved)/semi-natural grassland main differences. Mountain hay meadows/calcareous semi-natural grasslands in Central Spain example. Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-27. Source: CNES 2011©, Distribution Airbus DS/Spot Image. Credits: M. Palacios](./CZ-media/media/image226.png)
...
![Managed Grassland. Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-27. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image227.png)
...
![Managed grassland in mountain regions. France. Spot 5 (2.5 m) (1/2/3 Band Combination). Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image228.png)

![Managed grassland in mountain regions. France. Spot 5 (2.5 m) (1/2/3 Band Combination). Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image229.png)
...
!["Managed" grassland of motorway junctions. Spot 5 (2.5 m) (1/2/3 Band Combination). Source: CNES ©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image230.png)
...
![Typical arable land colour patterns in Landsat images](./CZ-media/media/image231.png)

![Typical grasslands colour patterns in Landsat images](./CZ-media/media/image249.png)
...
![Visible cultivation tracks near Beppen (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image257.png)

![Homogenous parcels of grassland without visible mowing tracks, Ahsen-Oetzen (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image258.png)

![Tracks in cropland and grassland with no tracks. SPOT-5 (2.5m), Band combination (1/2/3). Date: 2011-05-06.* *Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image259.jpeg)

![Examples of rows in a grassland parcel due mowing management. Credits: Eurostat. LUCAS 2009](./CZ-media/media/image260.jpeg)

![Examples of rows in a grassland parcel due mowing management. Credits: Eurostat. LUCAS 2009](./CZ-media/media/image261.jpeg)
...
![Dry grassland with trees on the Franconian Alb (juniper heathland), Germany. Credit: M. Probeck](./CZ-media/media/image262.png)

![Schematic representation of calcareous dry grasslands](./CZ-media/media/image263.jpeg)

![Dry Mediterranean grasslands in Extremadura region, South Western Spain. Credit: M. Palacios](./CZ-media/media/image264.jpeg)

![Schematic representation of Mediterranean pseudo-steppes in summertime](./CZ-media/media/image265.jpeg)

![Pannonian dry grasslands in northwestern Hungary. Credits: European Union, 2012. LUCAS](./CZ-media/media/image266.jpeg)

![Nordic alvar (Oländ, Sweden). Credits: European Union, 2012. LUCAS](./CZ-media/media/image267.jpeg)

![Grasses covering an abandoned arable land. Credit: M. Palacios](./CZ-media/media/image268.jpeg)

![Grasses in a military camp. Credit: M. Palacios](./CZ-media/media/image269.jpeg)
...
![Spontaneous grassland in Bieszczday district (Poland). Credits: Eurostat, LUCAS, 2009](./CZ-media/media/image270.jpeg)

![Wet grassland in Donegal (Ireland): Credits: Eurostat, LUCAS, 2009](./CZ-media/media/image271.jpeg)

![Wet grassland alongside river humid soils in Spain. Credit: M. Palacios](./CZ-media/media/image272.jpeg)

![Schematic representation of Mediterranean alluvial meadows](./CZ-media/media/image273.jpeg)

[Differentiation between natural mesic grasslands and wetlands (classes *7 Wetland*):]{.underline}

![Differentiation between grasslands and wetlands near Drozdowo (Poland). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-08-27. Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image274.png)
...
![Examples of Mediterranean grasslands ploughed 3-5 years to remove scrubs invading the parcel. Example in Extremadura, Spain. Credits: European Union, 2012. LUCAS](./CZ-media/media/image275.jpeg)

![Examples of Mediterranean grasslands ploughed 3-5 years to remove scrubs invading the parcel. Example in Extremadura, Spain. Credits: European Union, 2012. LUCAS](./CZ-media/media/image276.jpeg)
...
![Calcareous dry grasslands example with trees (Himsklamm Natura 2000 site, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-08-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image277.jpeg)
...
![Mediterranean dry grasslands example (Contrada Giammaiano Natura 2000 site, Sicily, Italy). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-07-16. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image278.jpeg)
...
![Pannonic steppe grasslands example. (Hortobágy Natura 2000 site, Hungary. SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-09-22. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image279.png)
...
![Anatolian steppe example. Sultanhanı (South of Tuz Lake, Turkey). SPOT-5 (2.5 m.). Date: 2011-11-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image280.jpeg)
...
![Machair example. Termoncarragh Lake and Annagh Machair SPA (Ireland). In green, Nature 2000 site limits. IRS (20 m.) (3/4/2 Band Combination) Date: 2011-03-31.](./CZ-media/media/image281.jpeg)
...
![Nordic Alvar example. Stora Alvaret Natura 2000 site, Sweden. Grasslands appear in red colour. SPOT-5 (2.5 m.) (1/2/3 Band Combination) Date: 2011-06-29. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image282.png)
...
![Semi-natural grassland (4.2.1) on a former military training site. SPOT-5 (2.5m), Band combination (1/2/3). Date: 2011-05-06.* *Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image283.jpeg)
...
![Hydrophilous tall herb example. Rečice Natura 2000 site, Croatia. SPOT-5 (2.5 m). Date: 2011-08-25. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image284.png)
...
![Alluvial meadow example in Umurca (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-07-05 Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image285.jpeg)
...
![Oro-Iberian festuca indigesta grasslands at altitude above 2,000 m. in Madrid region (Spanish Central Mountains range) Credit: M. Palacios](./CZ-media/media/image286.jpeg)

![Schematic representation of alpine grasslands](./CZ-media/media/image287.png)

Alpine and subalpine grassland could be located in alpine valley bottom, slopes or mountain tops.

![Location of alpine and subalpine grasslands. Credit: M. Rodriguez](./CZ-media/media/image288.jpeg)
...
![Alpine meadows/mountain hay meadows discrimination using a theoretical tree line (dotted line in red). Alps in Austria. Credit of photography: European Union, 2012. LUCAS](./CZ-media/media/image289.png)
...
![Siliceous Pyrenean Festuca eskia grassland example. SPOT-5 (2.5 m) (1/2/3 Band Combination). Tendeñera Natura 2000 site, Spain. Date: 2011-09-08.](./CZ-media/media/image290.jpeg)

![Alpine calcareous grassland example. Verwall Natura 2000 site, Austria. SPOT-5 (2.5 m) (1/2/3 Band Combination) Date: 2012-09-28. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image291.jpeg)

![Alpine grassland example. Border between Bosnia and Herzegovina and Montenegro. SPOT-5 (2.5 m) (1/2/3 Band Combination) Date: 2011-10-18. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image292.jpeg)

![Alpine grassland example. IRS (20 m.) example. (Durness Natura 2000 site, Scotland, UK). Date: 2013-06-05. Source: CNES 2012©, Distribution Airbus DS/Spot Image](./CZ-media/media/image293.jpeg)

![Example from mountainous parts of Scandinavia. (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image294.png)

![Alpine grassland example. France. Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image295.png)
...
- In the case of Nordic countries, and considering the heterogeneous nature of this class, a polygon may include up to 30% of *3.1.1 Natural & semi-natural broadleaved forest, 5.1 Heathland and moorland, 5.2 Alpine scrub land, 7.1.2.2 Unexploited peat bog, 6.1 Sparsely vegetated areas and 6.3.1.1 Bare rocks and outcrops* if these surfaces are too small to map separately. The specified class should therefore cover at least 70% of the surface. The minimum mapping unit for these heterogeneous classes will be around 1 ha.  {{< pagebreak >}}

# 5 Heathland and scrub{.unnumbered}

![](./CZ-media/media/picture7.png)
...
![Un-grassed lichen area of Rödfjället, Dalarana, Sweden. Credit: Charlotta Cristvall](./CZ-media/media/image297.jpeg)

![Stornärfjället, Dalarna (Sweden). Credit: Sebastian Kirppu](./CZ-media/media/image298.jpeg)

![Juniperus communis subsp. nana in Mediterranean Alpine-subalpine mountains. Credits: M. Palacios-](./CZ-media/media/image299.jpeg)

![Heathland invading grasslands in Ireland. Credit: A. Utanda](./CZ-media/media/image300.jpeg)
...
![LC CLC classes. Alpine area south east of Kebnekaise, Sweden. (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image301.png)
...
![Heathlands and Moorlands (5.1) SPOT 6 image.* *(1/2/3 Band Combination). (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image302.png)
...
![Heathland and Moorlands in the southern parts of Scandinavia. SPOT-5 image. 1/2/3 Band Combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image303.png)
...
![Heathland on a military training site located near Munster, Germany (Niedersachsen), SPOT-5 (2.5m), Date: 2011-05-06. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image304.png)
...
![CLC Class 322 "Moors and heathland" used to localize heathland. Munster in Germany (Niedersachsen), SPOT-5 (2.5m), Date: 2011-05-06. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image305.jpeg)  {{< pagebreak >}}
...
![5.2 Alpine scrub land: Mountain dwarf pine in the Bavarian Alps, Germany. Credits: M. Probeck](./CZ-media/media/image306.jpeg)

![5.2 Alpine scrub land, Salix in boreal climate zone of Kiruna, Sweden. Credits: S. Kirppu.](./CZ-media/media/image307.jpeg)
...
![5.2 Alpine scrub land. Location: Kiruna, Sweden. SPOT-6 image (1.5 m), Band Combination. (3/4/2). Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image308.png)
...
![5.2 in low laying parts of mountainous areas relative to dwarf scrubs (5.1). Location: Kiruna, Sweden. SPOT-6 image (1.5 m), Band Combination. (3/4/2). Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image](./CZ-media/media/image309.png)
...
![SPOT-6 image (1.5m), Band Combination (1/2/3). Location: Kiruna, Sweden. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image310.png)
...
![Dwarf pine region in the Alps (Austria). Difference in height and texture to neighbouring coniferous forest is clearly visible. SPOT-5 (2.5m), Band combination (1/2/3). CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image311.png)
...
!["Garriga" in Catalonia (Spain). Credits: European Union, 2012 LUCAS](./CZ-media/media/image312.jpeg)

![Sclerophyllous vegetation (Stipa tenaccissima) in Central Spain. Credits: European Union, 2012 LUCAS](./CZ-media/media/image313.jpeg)

![Sclerophyllous scrubs (Asparagus spec., Euphorbia spec., Cistus spec., Olea europaea var. sylvestris) in Loutsa (Island of Evia), Greece. Credits: N. Kolpatzik](./CZ-media/media/image314.jpeg)

![Scrubs (Retama sphaerocarpa) invading a grassland area in south-western Spain. Credits: M. Palacios](./CZ-media/media/image315.jpeg)
...
![Tren, Albania. SPOT5, 2.5m. (1/2/3 Band Combination). Date: 2011-08-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image316.jpeg)

Mediterranean scrubs in Albania in summertime.

![Badajoz (Spain) SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18 Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image317.png)
...
- [**6.1 Sparsely vegetated areas**]{custom-style="NormalLine"}\

  - 6.1.1 Sparse vegetation on sands

  - 6.1.2 Sparse vegetation on rocks

- [**6.2 Beaches, dunes, river banks**]{custom-style="NormalLine"}\

  - [6.2.1 Beaches and dunes]{custom-style="NormalLine"}\

    - [6.2.1.1 Beaches]{custom-style="NormalLine"}\

      - 6.2.1.1.1 Sandy beach

      - 6.2.1.1.2 Shingle beach

    - [6.2.1.2 Dunes]{custom-style="NormalLine"}\

  - [6.2.2 River banks]{custom-style="NormalLine"}\

- [**6.3 Bare rocks, burnt areas, glaciers and perpetual snow**]{custom-style="NormalLine"}\

  - [6.3.1 Bare rocks, outcrops, cliffs]{custom-style="NormalLine"}\
...
![Desert-like landscape in Lieberoser Heide, Brandenburg (Germany). Credit: J.-H. Janßen - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=28987289](./CZ-media/media/image319.jpeg)
...
![Sparsely vegetated areas in the foreground Nipfjället, Sweden. Credits S. Kirppu.](./CZ-media/media/image320.jpeg)

![Sparsely vegetated areas in the background. South of Spain. Credits: M. Palacios.](./CZ-media/media/image321.png)
...
![Sparsely vegetated areas, Ölands alvar, Sweden. SPOT-5 data.](./CZ-media/media/image322.png)

Example from Ölands alvar (a limestone barren plain).

![6.1.2 Sparse vegetation on rocks in Agalar (Anatolia, Turkey) SPOT-5 (2.5 m) (NIR/R/G Band Combination). Date: 2011-06-29 Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image323.png)
...
![6.1.2 Sparse vegetation on rocks in the Alps. SPOT-5 (2.5 m) (NIR/R/G Band Combination). Date: 2012-09-07 Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image324.png)
...
![Beach at Lanzarote (Canary Islands, Spain). Credit: K. Larsson](./CZ-media/media/image325.jpeg)

![Beach at Doñana Natura 2000 site (Southern Spain). Credits: M. Palacios](./CZ-media/media/image326.jpeg)
...
![Example of Beach (sand), 20 -30 m wide. Sudersand, Sweden. Aerial orthophoto. Credit imagery: Lantmäteriet, Sweden](./CZ-media/media/image327.jpeg)

![Example of Beach (sand). (Sudersand, Sweden). SPOT-5. Credit (1/2/3 Band Combination). Date: 2012-08-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image328.jpeg)
...
![Shingle beach near Brighton (UK). Credit: A. Kreisel](./CZ-media/media/image329.png)

![Stupova Beach (Croatia). Credit: Michal Klajban - Own work, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=74913673](./CZ-media/media/image330.jpeg)
...
![Example of Beach (cobblestones), 10 -20 m wide. (Skäret, Sweden). Aerial orthophoto. Credit: Lantmäteriet, Lantmäteriet](./CZ-media/media/image331.jpeg)
...
![Maspalomas dune, (Canary Islands, Spain). Credits: M. Palacios](./CZ-media/media/image332.jpeg)

![Dune in Doñana Natura 2000 site (Southern Spain) Credits: M. Palacios](./CZ-media/media/image333.jpeg)
...
![Dunes near Portu Mago, Sardinia (Italy). Pléiades 1B (2m) (1/2/3 Band Combination). Date: 2018-08-13. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image334.png)
...
![River bank in Var River (Alps Maritimes, France). Credit: European Union, LUCAS.](./CZ-media/media/image335.jpeg)
...
![River banks. (Torneträsk, Sweden). Aerial orthophoto. Credit imagery: Lantmäteriet, Sweden.](./CZ-media/media/image336.jpeg)

![River banks. (Torneträsk, Sweden). SPOT-5. (1/2/3 Band Combination). Date: 2011-07-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image337.jpeg)

![River banks (6.2.2) in Anatolia (Turkey) SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-06-30. Source: CNES 2011© Distribution Airbus DS/Spot Image.](./CZ-media/media/image338.png)
...
![Bare rocks, Loferer Steinberge (Austria). Credit: A. Kreisel](./CZ-media/media/image339.jpeg)

![Bare rocks and outcrops (Portugal). Credits: C. Gruber](./CZ-media/media/image340.jpeg)

![Etna's volcanic landscape (Italy). Credits: A. Utanda](./CZ-media/media/image341.jpeg)

![Volcanic bare rocks in (Canary Islands, Spain). Credits: M. Palacios](./CZ-media/media/image342.jpeg)
...
![Bare rocks formations (6.3.1.1) in Anatolia (Turkey). SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-06-30 Source: CNES 2011© Distribution Airbus DS/Spot Image](./CZ-media/media/image343.png)

![Example of bare rock with \<10% vegetation. It is a steep hillside dotted with birch. (Norway) Image (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image344.png)

![Example of bare rock with \<10% vegetation in the Alps (Austria). SPOT-5 (2.5m), Date: 2012-09-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image345.png)
...
![Coastal cliffs near Lagos (Portugal). Credits: Luc. T from Buggenhout, België, CC BY 2.0, https://commons.wikimedia.org/w/index.php?curid=43600517](./CZ-media/media/image346.jpg)

![Coastal cliffs near Sagres (Portugal). Credit: C. Gruber](./CZ-media/media/image347.png)
...
![Cliffs at the British coastline near Fairlight (UK). SuperView-1 (2m) (1/2/3). Date: 2018-09-02. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image348.PNG)
...
![Scrubland affected by fire (North Western Spain). Credit: European Union, LUCAS](./CZ-media/media/image349.jpeg)
...
![Glacier Übeltalferner (6.3.3) in Southern Tirol (Italy). Credit: A. Kreisel](./CZ-media/media/image350.jpeg)

![Glacier Gepatschferner and permanent snowfields (6.3.3) in Tyrol (Austria). Credit: F. Innerbichler](./CZ-media/media/image351.jpeg)
...
![Glacier and perpetual snow (Kebnekaise, Sweden). SPOT-5. The delineation of the class (yellow polygons) is from CORINE Land Cover and corresponds well to the satellite image (3/4/2 Band Combination). Date: 2010-09-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image352.jpeg)

![Glacier and perpetual snow according to topographical map. (Kebnekaise, Sweden). Credit: Lantmäteriet, Sweden](./CZ-media/media/image353.png)

![Infrared orthophoto over glacier and perpetual snow. (Kebnekaise, Sweden). Credit: Lantmäteriet, Sweden.](./CZ-media/media/image354.jpeg)
...
![](./CZ-media/media/image3.png)

![](./CZ-media/media/image4.png)

A decision criteria tree is established to clarify guideline distinctions between Level 5 classes as follows:

![](./CZ-media/media/image356.png)

***This category includes:***

- [**7.1 Inland wetlands**]{custom-style="NormalLine"}\
...
- [**7.2 Coastal wetlands**]{custom-style="NormalLine"}\
...
![Inland freshwater marshes in Tablas de Daimiel Natura 2000 Site (Central Spain). Credits: M. Palacios](./CZ-media/media/image357.jpeg)

![Inland saline marsh in Central Spain. Credit: European Union, 2012, LUCAS.](./CZ-media/media/image358.jpeg)

![Interpretation of cyperaceae plants in a wetland. Credits of photography: M. Rodriguez](./CZ-media/media/image359.png)

![Juncaceae plants. Credits: M. Palacios](./CZ-media/media/image360.png)
...
![SPOT-5 (2,5 m). (1/2/3 band combination). Pannonic Salt Steppes example. Felső-kiskunsági szikes tavak és Miklapuszta Natura 2000 site, Hungary. Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image361.png)

[Examples of "Inland marshes" interpretation rules:]{.underline}

![Araslövssjöområdet Natura 2000 site (limits in green), Sweden. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image362.png)

![Srebarna Natura 2000 site (in green), Bulgaria. SPOT-5 2.5 m. (1/2/3 band combination). Date: 2011-04-26. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image363.png)

![Pannonic Salt Steppes example. Felső-kiskunsági szikes tavak és Miklapuszta Natura 2000 site, Hungary. SPOT-5 2.5 m (1/2/3 band combination). Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image364.png)

[Wetlands with reeds examples:]{.underline}

![Example of 7.1.1 in Umeå, Sweden. (1/2/3 band combination). SPOT-5 image. Date: 2011-07-08. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image365.png)

![7.1.1 Inland marshes (with reeds). Murnau, Southern Bavaria. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image366.png)

![7.1.1 Inland marshes (with reeds, mowed and mixed with grassland). Murnau, Southern Bavaria. SPOT-5 (2.5 m. (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image367.png)

[Wetland and semi-natural (mesic) grassland distinction example:]{.underline}

![7.1.1 Inland marsh with CLC class 411 overlay. Neighbouring moorland shows yellow-green-spectral signatures. Location: South of Murnau, Southern Bavaria. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image368.png)
...
![Exploited peat bog in Roscommon (Ireland). Credit: European Union, 2012, LUCAS.](./CZ-media/media/image369.jpeg)
...
![The delineation of the exploited peat bog (yellow polygons) is from CORINE Land Cover and corresponds fairly to the satellite image. Sweden. SPOT-5 data. Credit imagery: ESA](./CZ-media/media/image370.png)

![The same area as above but infrared orthophotos as image background. Credit imagery: Lantmäteriet](./CZ-media/media/image371.png)

![Exploited peat bog in northern Germany SPOT-5 (2.5m), CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image372.jpeg)

![Exploited peat bog in northern Germany -- right side: CLC overlay Source: SPOT-5 (2.5m), CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image373.jpeg)
...
![Unexploited peat bog near Benderloch (Wester Scotland, United Kingdom). Credit: European Union, 2012, LUCAS.](./CZ-media/media/image374.jpeg)
...
![Unexploited peat bog. Typical raised peatbog. Jordbärsmuren-Albo Natura 2000 site, Sweden, SPOT-5 data. The delineation of the peat bog (yellow polygons) is from CORINE Land Cover and corresponds well to the satellite image. Credit imagery: ESA](./CZ-media/media/image375.jpeg)

![Same area as left. The delineation of the peat bog (red polygons) is from Nature 2000 habitat map, also corresponding well to the satellite image. Credit imagery: ESA](./CZ-media/media/image376.jpeg)

![Area in the north of Sweden mapped as peat bog in CORINE LC. SPOT-5. Credit imagery: ESA](./CZ-media/media/image377.png)

![Same area as left. Aerial orthophoto with delineation (based on Nature 2000 habitat map). Credit imagery: Lantmäteriet](./CZ-media/media/image378.png)
...
![Salt marshes with salt tolerant plants in Camargue (Southern France). Credits: European Union 2012, LUCAS.](./CZ-media/media/image379.jpeg)

![Reeds (foreground) and salt tolerant plants (background) in marshes of Foz do Rio Miñor Natura 2000 site (Galicia, Spain). Credit: M. Palacios](./CZ-media/media/image380.jpeg)
...
![Salt marsh in Foz do Rio Miñor Natura 2000 site during low tide (Galicia, Spain). Credit: M. Palacios](./CZ-media/media/image381.jpeg)

![Salt marsh in Foz do Rio Miñor Natura 2000 site during high tide (Galicia, Spain). Credit: M. Palacios](./CZ-media/media/image382.jpeg)
...
![Marshes in Doñana Natura 2000 site, Spain and estuary of the Guadalquivir river SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image383.jpeg)

[Vegetated flat areas in/near the coastline or in estuaries and other coastal landscapes]{.underline}:

![Marais at Gironde estuary (France) SPOT-5 (25 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image384.jpeg)

[In the case of salt marshes transformed to agriculture, classification rules are applied as follows]{.underline}:

![Rice fields in Doñana National Park (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image385.png)

- [Agricultural activity is evident → *2.1.1 Arable irrigated and non-irrigated land.*]{custom-style="NormalLine"}\

![Transformed salt marsh in Doñana National Park (Spain) without agricultural use. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image386.png)
...
![Pineiou Delta, Natura 2000 site (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image387.jpeg)
...
![Pineiou Delta, Natura 2000 site (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image388.jpeg)
...
![Relevant and clear ponds and channels in salt marshes are classified as 8.3.1 Lagoons. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image389.png)
...
![Salines des Pesquieres (Southern France). Credits: European Union 2012, LUCAS.](./CZ-media/media/image390.jpeg)

![Salt marshes in Lanzarote (Canary island, Spain). Credit: C. Alonso](./CZ-media/media/image391.jpeg)
...
![Santa Pola salines (Spain) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image392.jpeg)
...
![Intertidal flat in Étel (Bretagne, France). Credits: European Union, 2012, LUCAS](./CZ-media/media/image393.jpeg)

![Intertidal flat (Nissum Bredning, Denmark). Credits: European Union, 2012, LUCAS](./CZ-media/media/image394.jpeg)
...
![Wadden sea (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-04-25. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image395.png)
...
![Schematic differentiation 7.2.3 Intertidal flats](./CZ-media/media/image396.png)

![Schematic differentiation 8.3.2 Estuaries](./CZ-media/media/image397.png)
...
- [**8.1 Water courses**]{custom-style="NormalLine"}\
...
- [**8.2 Lakes and reservoirs**]{custom-style="NormalLine"}\
...
- [**8.3 Transitional waters**]{custom-style="NormalLine"}\
...
- [**8.4 Sea and ocean**]{custom-style="NormalLine"}\
...
![](./CZ-media/media/image3992.png)

![](./CZ-media/media/image399.png)  {{< pagebreak >}}
...
![Permanent interconnected running water course in Antalya Province (Southern Turkey). Credits: M. Escobar](./CZ-media/media/image400.jpeg)

![River in Northern Wales (United Kingdom). Credits: European Commission 2012. LUCAS](./CZ-media/media/image401.jpeg)

![Intermittently running water course (Ribeira de Odeleite, Algarve, Portugal). Credits: Eurostat LUCAS 2013.](./CZ-media/media/image402.jpeg)
...
![River Weser in Bodenwerder (Lower Saxony, Germany). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image403.png)

![Intermittent river in Aetolia-Acarnania region (Greece). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image404.png)
...
![Example of delineation of dry braided rivers. Euphrates River (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-25. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image405.png)

- [River banks without presence of channels \> 10 m. → classification of all area as *6.2.2* *Rivers banks*.]{custom-style="NormalLine"}\

![River system where it is not possible to delineate water channels \> 10 m. Tributary of the Euphrates River (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-29. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image406.png)

[Approach for differentiation between 8.1.1 Natural & semi-natural water courses and flooded areas:]{.underline}

![](./CZ-media/media/image407.jpeg)
...
![Highly modified natural water course (Río Manzanares crossing Madrid city). Credits: M. Palacios.](./CZ-media/media/image409.jpeg)

![Canal in Lingen (Lower Saxony, Germany). Credits: Eurostat LUCAS 202.](./CZ-media/media/image410.jpeg)
...
![Danube river in Gemenc Ramsar Site, Hungary. SPOT-5 2.5 m. (1/2/3 band combination). Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image411.png)
...
![Intermittent oxbow lake in Scandinavia. Credit: I, Boffe, CC BY 2.5, https://commons.wikimedia.org/w/index.php?curid=2333357](./CZ-media/media/image412.jpeg)
...
![Permanent dead side-arms of Danube river (Tolna, Hungary). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image](./CZ-media/media/image413.jpeg)
...
![Temporary flood ponds in Danube River in Borcea (Romania). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-04-21. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image414.png)
...
![Permanent natural water body in the Bavarian Alps (S-Germany). Credits: M. Probeck](./CZ-media/media/image417.png)

![Lake in a green area in Madrid city (Spain). Credits: M. Palacios](./CZ-media/media/image418.jpeg)
...
![Lake Öreg-tó (Hungary). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-08-15. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image419.png)

![Tail of a hydropower lake in Euphrates river, Kasaba (Turkey), Spot 5 (2.5 m; 1/2/3 band combination). Date: 2011-05-07. CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image420.jpeg)
...
![Delimitation of water bodies using the maximum water lever. This is the **wrong interpretation**. Canary Islands (Spain). Credit: M. Palacios.](./CZ-media/media/image421.png)

![Delimitation of water bodies using the current water level. This is the **correct interpretation**. Canary Islands (Spain). Credit: M. Palacios.](./CZ-media/media/image422.png)
...
![Temporary Mediterranean ponds in Castilla-La Mancha (Spain) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image423.jpeg)

![Croaghill Turlough Natura 2000 site, Ireland (outlined Natura 2000 site limit). IRS 20 m. (3/4/2 band combination). Date: 2011-04-29. Credits: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image424.png)
...
![Irrigation pond with completely man-made structure (Canary Islands, Spain). Credits: M. Palacios](./CZ-media/media/image425.jpeg)

![Irrigation pond in Sicily (Italy. Credits: European Commission, 2012, LUCAS](./CZ-media/media/image426.jpeg)
...
![Irrigation water pond in Thessaly (Greece) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image427.png)
...
![Fish ponds in Lubusz (Poland). Credits: Eurostat, LUCAS, 2009](./CZ-media/media/image428.jpeg){
...
![Typical pattern of fish ponds in the region of Třeboňsko (Czech Republic)](./CZ-media/media/image429.png)
...
![Mining pond near Tornitz (Saxony-Anhalt, Germany). European Union, 2012, LUCAS](./CZ-media/media/image430.jpeg)
...
![Water bodies in extraction area - Villedaigne (France) Credit: SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-20. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image431.jpeg)
...
![Water bodies in a gravel pit area - Bozbulut (Turkey) Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-05. Source: CNES 2011©, Distribution Airbus DS/Spot](./CZ-media/media/image432.png)
...
![Coastal lagoon at Golfo di Signo (Sardinia, Italy). Credits: European Union 2012, LUCAS.](./CZ-media/media/image433.jpeg)

![Orbetello Lake (Grosseto, Italy). Credits: European Union 2012, LUCAS.](./CZ-media/media/image434.jpeg)
...
![SPOT-5 (2.5 m) (1/2/3 band combination). Limnes Voulkaria Kai Saltini Natura 2000 site, Greece. Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image. In green, limits of Natura 2000 site.](./CZ-media/media/image435.jpeg)

![Schematic representation of typical coastal lagoon landscape.](./CZ-media/media/image436.png)
...
![Schematic view of La Albufera coastal lagoon (Valencia, Spain).](./CZ-media/media/image437.png)
...
![Schematic view of open coastal lagoon. Limni Kiknolakka (Greece).](./CZ-media/media/image438.png)

![Schematic view of Falsterbo coastal lagoons complex (Scania Province, Sweden)](./CZ-media/media/image439.png)

![Schematic view of a transformed coastal lagoon. Logarou lake (Koronisia, Greece).](./CZ-media/media/image440.png)
...
![Schematic view of percolation Cemlyn lagoon (north Wales, United Kingdom)](./CZ-media/media/image441.png)
...
![Limnes Voulkaria Kai Saltini Natura 2000 site, Greece. SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image442.png)
...
![Concept of coastal marshes: A, B, C and D situations are considered as 7.2.1 Salt marshes](./CZ-media/media/image443.png)

![Schematic concept for differentiation between 8.3.1 Lagoons / 7.2.1 Salt marshes.](./CZ-media/media/image444.png)
...
![Schematic concept of coastal lagoons with reed beds and tide channels (Leaky coastal lagoon of Ria Formosa in Portugal)](./CZ-media/media/image445.png)
...
![Estuary of Guadalquivir River (Southern Spain). Credits: E. Mazón](./CZ-media/media/image446.jpeg)
...
![Gironde Estuary delineated (France). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01 Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image447.jpeg)

![Schematic representation of typical estuary morphology](./CZ-media/media/image448.png)
...
![Axios Delta (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](./CZ-media/media/image449.png)

![Schematic representation of level 5 classification of Axios Delta (Greece)](./CZ-media/media/image4501.png)
...
![Ria coast near Vigo (Spain). Credit: Harpagornis - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=18115391](./CZ-media/media/image450.jpeg)

![Lysefjord (Norway). Credit: Andreas Tille - Eigenes Werk, CC BY-SA 4.0, https://commons.wikimedia.org/w/index.php?curid=924946](./CZ-media/media/image451.jpeg)
...
![Open sea in the Bay of Biscay. Credit: By STHLM, CC BY 3.0, https://commons.wikimedia.org/w/index.php?curid=54638112](./CZ-media/media/image454.jpg)
...
![Delineation of coastal waters and open sea at the British coastline near Fairlight (UK). SuperView-1 (2m) (1/2/3). Date: 2018-09-02. Source: Airbus DS Geo SA (2018)](./CZ-media/media/image455.png)
...
![Atlantic Ocean near Sagres (Portugal). Credit: C. Gruber.](./CZ-media/media/image456.png)

![Strait of Gibraltar seen from Tarifa (Spain). Credit: CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=58051](./CZ-media/media/image457.jpeg)
...
![Delineation of a coastline in Catalonia (Spain). (1/2/3 Band Combination). Date: 2012-09-07. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image458.png)

![8.4.2 Coastal waters separated from the other marine classes by the presence of fine sediment deposition of Intertidal flats (7.2.3) that are in between high and low water marks. (Wadden Sea, Germany). (1/2/3 Band Combination). Date: 2011-04-25. © Airbus Defence and Space, provided under EC/ESA CSC-DA](./CZ-media/media/image459.png)

![Schematic representation of classes 8.4 Sea and ocean (red dot line)](./CZ-media/media/image460.png)
