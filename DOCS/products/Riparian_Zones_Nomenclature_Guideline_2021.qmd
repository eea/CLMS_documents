...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Capture1.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Capture2.png){fig-align="left"}
![Detailed Nomenclature for the LC/LU dataset (version 1.4.1, dated 2021.04.07)](Riparian_Zones_Nomenclature_Guideline_2021-media/Capture3.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Urban.png){width=30%}
...
![Continuous Urban fabric IM.D. \>80% (Tallinn, Estonia). Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image10.jpeg){fig-align="left"}

![Continuous Urban fabric IM.D. \>80% (Palermo, Italy). Credit: M. Escobar](Riparian_Zones_Nomenclature_Guideline_2021-media/image11.jpeg){fig-align="left"}
...
![Class 1.1.1.1, City Drammen (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-07-20. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image12.png){fig-align="left"}

![Class 1.1.1.1, City Skien (Norway). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image13.png){fig-align="left"}

![Class 1.1.1.1, City Skien (Norway).SPOT-5 and HR I.MD. (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image14.png){fig-align="left"}
...
![Dense urban fabric (IM.D ≥30-80%): City: Stockholm. Credits: European Union LUCAS 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image15.jpeg){fig-align="left"}

![Dense urban fabric (IM.D ≥30-80%): City: Stockholm. Credits: European Union LUCAS 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image16.jpeg){fig-align="left"}
...
![Class 1.1.1.2 City Larvik (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image17.png){fig-align="left"}

![Class 1.1.1.2 City Lunde (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image18.png){fig-align="left"}

![Class 1.1.1.2 City Lunde (Norway). SPOT-5 and HR I.MD. (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image19.png){fig-align="left"}
...
![Low density urban fabric (IM.D \<30%) (Täby, Sweden). Credits: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image20.jpeg){fig-align="left"}

![Low density urban fabric (IM.D \<30%) (Costa del Sol, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image21.jpeg){fig-align="left"}
...
![Class 1.1.1.3 Low Density Urban fabric at Siljan region (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image22.png){fig-align="left"}

![Class 1.1.1.3, City Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination) together with HR IM.D. Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image23.png){fig-align="left"}

![In regions with scattered houses, only large accumulations of houses are mapped (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image24.png){fig-align="left"}

![Village Åre (Sweden): Example of generalized delineation of a low density urban fabric area (class 1113). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image25.png){fig-align="left"}
...
![Example of generalized delineation of a low density urban fabric area, class 1.1.1.3 (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image26.png){fig-align="left"}

![Generalized mapping of scattered urban areas. Gardens have to be included. Gaps of less than 50 meters are generalized and single blocks are connected. Large agricultural areas (width \> 50 m) at the urban border should be excluded.](Riparian_Zones_Nomenclature_Guideline_2021-media/image27.png){fig-align="left"}

![Gardens included, outline generalized to support a cartographic representation of urban areas. Otherwise urban areas will be underestimated and not presented correctly. Do not include too much agricultural area (Example from Poland). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image28.png){fig-align="left"}

![Urban mapping example from Poland: SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image29.png){fig-align="left"}


![Generalize urban outline, include gardens, and use class 2.3.2.0 for complex areas (example from Poland). SPOT-5 (2.5m) (Poland) (1/2/3 Band Combination). Date: 2011-07-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image30.png){fig-align="left"}
...
![Industrial or commercial units. (Riga, Latvia). Credits: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image33.jpeg){fig-align="left"}

![Industrial site (Madrid, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image34.jpeg){fig-align="left"}
...
![Industrial site of Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image35.png){fig-align="left"}

![Example of class 1.1.2.0 in Batman, Anatolia region (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image36.png){fig-align="left"}

![Active archeological site: Hosap castle -- Guzelsu (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-08-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image37.png){fig-align="left"}
...
![Ataturk dam, Sanliurfa region (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-07-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image38.png){fig-align="left"} 
...
![Road network and associated land, (Stockholm, Sweden) Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image39.jpeg){fig-align="left"}
...
![Example of Class 1.2.1.0 from Siljan (Norway) presented on SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image40.png){fig-align="left"}

![Example of class 1.2.1.0 city of Skien (Norway) presented on SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image41.png){fig-align="left"}

![Example of class 1.2.1.0 Bismil (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-07-13. Source: CNES 2013©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image42.png){fig-align="left"}
...
![Class 3.4.2.0 surrounded by 1.2.1.0 and area \< 0.5 ha: map as associated feature and generalize into road](Riparian_Zones_Nomenclature_Guideline_2021-media/image43.png){fig-align="left"}  
...
![Railways and associated land (Täby, Sweden) Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image44.jpeg){fig-align="left"}
...
![Class 1.2.2.0 city of Lunde (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination) Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image45.png){fig-align="left"}

![Class 1.2.2.0 city of Gvarv (Norway.) SPOT-5 (2.5m) (1/2/3 Band Combination) Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image46.png){fig-align="left"}
...
![Industrial site with railways from ancillary data in turquoise. Example from Stockholm (Sweden). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image47.png){fig-align="left"}  
...
![Port area of Stockholm (Sweden) Credit: European Union, LUCAS 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image48.jpeg){fig-align="left"}
...
![Delineation of a port area and associated land located at Surtebogen (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image49.png){fig-align="left"}
...
![Airport, (Arlanda Stockholm, Sweden). Credits: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image50.jpeg){fig-align="left"}
...
![Military airport at Wilhelmswöerth (Germany). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image51.png){fig-align="left"}

![Airport Worms (Germany).* *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image52.png){fig-align="left"}

![Erzinkan airport (Turkey)*. *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-09-16. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image53.png){fig-align="left"}
...
![Construction site (Cadiz, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image54.jpeg){fig-align="left"}

![Construction site (Malaga, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image55.jpeg){fig-align="left"}

![Dump site (Madrid, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image56.jpeg){fig-align="left"}

![Dump site (Madrid, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image57.jpeg){fig-align="left"}
...
![Delineation of mineral extraction site at Bostrac (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image58.png){fig-align="left"}

![Delineation of construction site at Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image59.png){fig-align="left"}

![Gravel pit (Turkey)*. *SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2013-08-07. Source: CNES 2013©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image60.png){fig-align="left"}
...
![Land without current use (Malaga, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image61.jpeg){fig-align="left"}
...
![Land without current use near Porsgun (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image62.png){fig-align="left"}

![Land without current use near Porsgun (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image63.png){fig-align="left"}

![Ruins near Caykoy (Turkey). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2011-06-30. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image64.jpeg){fig-align="left"}
...
![Green urban areas (Täby, Sweden). Credits: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image65.jpeg){fig-align="left"}

![Golf course. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image66.jpeg){fig-align="left"}
...
![Green urban area in Skien (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image67.png){fig-align="left"}

![Golf course at Uleforss (Norway). SPOT-5 (2.5m) (1/2/3 Band Combination). Date: 2010-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image68.png){fig-align="left"}
...
![Non-irrigated arable land: Rapeseed in Germany. Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image71.png){fig-align="left"}

![Non-irrigated arable land: Parcel of cereal harvested in Central Spain. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image73.jpeg){fig-align="left"}

![Schematic representation of managed non-irrigated arable land](Riparian_Zones_Nomenclature_Guideline_2021-media/image74.png){fig-align="left"}
...
![Non-irrigated agricultural fields in Northern Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-07-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image76.jpeg){fig-align="left"}
...
![Non-irrigated arable land in central Europe (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-28. Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image77.jpeg){fig-align="left"}

- [Plough furrows are a typical characteristic of crops.]{custom-style="NormalLine"}\


![Non-irrigated arable land in Altnkusak (Anatolia, Turkey) SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-08-05 Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image78.png){fig-align="left"}

- [Yellow/white colours in summer-time.]{custom-style="NormalLine"}\


![Non-irrigated arable land in northern Sweden. (1/2/3 Band Combination). SPOT-5 image. Date: 2013-08-05. Source: CNES 2013©, Distribution Airbus DS/Spot.](Riparian_Zones_Nomenclature_Guideline_2021-media/image79.png){fig-align="left"}
...
![Irrigation channel in Osmaniye (Turkey). Credits:"Osmaniye irrigation" by Ozgurmulazimoglu - Own work. Licensed under Creative Commons Attribution-Share Alike 3.0 via Wikimedia Commons - http://commons.wikimedia.org/wiki/File:Osmaniye_irrigation.JPG#mediaviewer/File:Osmaniye_irrigation.JPG](Riparian_Zones_Nomenclature_Guideline_2021-media/image80.png){fig-align="left"}

![Schematic representation of a permanent irrigated area with irrigation channels.](Riparian_Zones_Nomenclature_Guideline_2021-media/image81.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image82.png){fig-align="left"}   
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image83.png){fig-align="left"}   

![Examples of centre-pivot irrigation system not used to irrigate parcels in summer-time. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image84.jpeg){fig-align="left"}     
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image85.png){fig-align="left"}
...
![Traditional irrigated area in Saka (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-09-06 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image86.png){fig-align="left"}
...
![Rice fields at Rosayenda, Italy. SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-07-29. Source: CNES 20011©, Distribution Airbus DS / Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image87.png){fig-align="left"}
...
![Viransehir, Turkey. Source: SPOT-5 (2.5 m) Natural colour combination. Date: 2006-09-16. CNES 2006 ©, Distribution Airbus DS / Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image88.jpeg){fig-align="left"}
...
![Zaragoza (Ebro valley), Spain. Source: SPOT-5 (2.5 m) Natural colour combination. Date: 2006-08-27 CNES 2006 ©, Distribution Airbus DS / Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image89.jpeg){fig-align="left"}
...
![Irrigated fruits trees plantation in Morhamam (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-29 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image90.png){fig-align="left"}
...
![Example of final result of classification of traditional irrigated land with traditional infrastructures](Riparian_Zones_Nomenclature_Guideline_2021-media/image94.png){fig-align="left"}
...
![Example of final result of classification of irrigated land using underground water](Riparian_Zones_Nomenclature_Guideline_2021-media/image95.png){fig-align="left"}
...
![Example of final result of classification of centre pivot irrigation systems](Riparian_Zones_Nomenclature_Guideline_2021-media/image96.png){fig-align="left"}
...
![Example of final result of classification of intensively managed fruit trees plantations](Riparian_Zones_Nomenclature_Guideline_2021-media/image98.png){fig-align="left"}
...
![Harran (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-04 and 2011-07-15 .Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image100.png){fig-align="left"}
...
![Akoren (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-06-04. Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image101.png){fig-align="left"}

![Akoren (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-08-15. Source: CNES 2011© Distribution Airbus DS/Spot Image. Irrigated parcels are only visible in the image dated 2011-08-15.](Riparian_Zones_Nomenclature_Guideline_2021-media/image102.png){fig-align="left"}
...
![Schematic representation of complex patters of irrigated and non-irrigated arable land](Riparian_Zones_Nomenclature_Guideline_2021-media/image102.2.png){fig-align="left"}
...
![Example of Type C class 2.1.1.0. Kallithiro (Turkey).SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-02. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image103.png){fig-align="left"}

![Example of Type C class 2.1.1.0. Megala Kalivia (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-02. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image104.png){fig-align="left"}       
...
![Greenhouse in Almeria (Andalusia, Spain). Credit: Eurostat Lucas 2009.](Riparian_Zones_Nomenclature_Guideline_2021-media/image105.jpeg){fig-align="left"}

![Greenhouses structure in Almeria (Andalusia, Spain). Credit: Eurostat Lucas 2009.](Riparian_Zones_Nomenclature_Guideline_2021-media/image106.jpeg){fig-align="left"}
...
![Nursery with greenhouses, Lampertheim, (Germany).SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-14 Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image107.jpeg){fig-align="left"}
...
![Nursery with greenhouses, Lampertheim, (Germany).SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-14 Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image108.jpeg){fig-align="left"}
...
![Greenhouses in Koru (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-29. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image109.jpeg){fig-align="left"}
...
![Vineyards in Dordogne (France). Credits: C. Alonso](Riparian_Zones_Nomenclature_Guideline_2021-media/image110.jpeg){fig-align="left"}

![Vineyards in Duero Valley (Central Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image111.jpeg){fig-align="left"}

![Apple trees in Slovakia. Credit: Eurostat Lucas 2009.](Riparian_Zones_Nomenclature_Guideline_2021-media/image112.jpeg){fig-align="left"}

![Almond trees in Valencia region (Spain). Credit: Eurostat Lucas 2009.](Riparian_Zones_Nomenclature_Guideline_2021-media/image113.jpeg){fig-align="left"}

![Cherry fruit trees, western Germany. Source: © LUCAS 2012.](Riparian_Zones_Nomenclature_Guideline_2021-media/image114.png){fig-align="left"}

![Low stem fruit trees near Rome, Italy. Source: © LUCAS 2012](Riparian_Zones_Nomenclature_Guideline_2021-media/image115.png){fig-align="left"}

![Vineyard in Loutsa (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image116.jpeg){fig-align="left"}
...
![Vineyards at Úbeda (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image117.jpeg){fig-align="left"}
...
![Vineyard at Oestrich-Winkel (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image118.jpeg){fig-align="left"}

- [Characteristic structure: small parcel sizes, terraced cultivation and high reflectance of open soil when cultivated in rows.]{custom-style="NormalLine"}\


![Vineyard at Lösnich (Germany).* *SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image119.jpeg){fig-align="left"}
...
![High stem fruit trees, Helmarshausen (Germany), Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-28. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image120.jpeg){fig-align="left"}
...
![High stem fruit trees, Ingelheim am Rhein (Germany), Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image121.png){fig-align="left"}
...
![Example of pistachio cultivation. Nizip (Turkey) 1/2/3 Band Combination). Date: 2011-05-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image122.jpeg){fig-align="left"}
...
![Schwarmstedt (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Central Europe (Germany). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image123.jpeg){fig-align="left"}

![Apple plantation at Schwarmstedt (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image124.jpeg){fig-align="left"}
...
![Śniadków Dolny (Poland). Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-08-06. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image125.png){fig-align="left"}
...
![Bogoria (Poland). Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-08-06. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image126.png){fig-align="left"}
...
![Olive groves in a mountainous area in South-western Spain. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image127.jpeg){fig-align="left"}

![Young plantation of olive trees in Southern Spain. Credits: J. Pecci](Riparian_Zones_Nomenclature_Guideline_2021-media/image128.jpeg){fig-align="left"}

![Olive groves in Kathenes (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image129.jpeg){fig-align="left"}

![Olive groves in Kallithea (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image130.jpeg){fig-align="left"}
...
![Olive grove with vineyards around. Úbeda (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image131.png){fig-align="left"}

![Olive grove, Badajoz (Spain). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image132.jpeg){fig-align="left"}
...
![Typical landscape of annual crops in association and mosaic with olive groves and vineyards in Spain. Credit: Eurostat Lucas 2009.](Riparian_Zones_Nomenclature_Guideline_2021-media/image133.jpeg){fig-align="left"}
...
![Schematic representation of 2.3.2.0 complex cultivation patterns](Riparian_Zones_Nomenclature_Guideline_2021-media/image134.png){fig-align="left"}
...
![Mix of annual and permanent crops, Bad Salzig (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image135.jpeg){fig-align="left"}
...
![Schematic representation of 2.3.3.0 land principally occupied by agriculture with significant areas of natural vegetationS](Riparian_Zones_Nomenclature_Guideline_2021-media/image136.jpeg){fig-align="left"}

![Agricultural parcel included in an area with vegetation natural (spontaneous grasses, trees, scrub, etc.). Credits: M. Rodriguez](Riparian_Zones_Nomenclature_Guideline_2021-media/image137.png){fig-align="left"}
...
![Agricultural area with natural vegetation in Inandik (Anatolia, Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-07-16 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image139.png){fig-align="left"}

![Land principally occupied by agriculture with significant areas of natural vegetation (2330) in Germersheim (Germany). SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2010-07-14. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image140.png){fig-align="left"}
...
![Dehesa of cork oaks with very high T.C.D. in South-western Spain. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image141.jpeg){fig-align="left"}

![Dehesa invaded by scrubs. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image142.jpeg){fig-align="left"}

![Dehesa in Spain in spring-time. Credit: C. Alonso](Riparian_Zones_Nomenclature_Guideline_2021-media/image143.jpeg){fig-align="left"}

![Schematic representation of 2.3.4.0 Agro-forestry T.C.D \< 30%](Riparian_Zones_Nomenclature_Guideline_2021-media/image144.png){fig-align="left"}
...
![Badajoz (Spain).SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image145.jpeg){fig-align="left"}

![Example of Agroforestry T.C.D. \< 30% with grassland and arable land understory. Extremadura (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image146.jpeg){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image147.png){fig-align="left"}
...
![Broadleaved forest (beech), Bavaria, Germany. Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image149.png){fig-align="left"}

![Broadleaved forest (beech and maple), Stockholm, Sweden. Credits: E. Alkrona](Riparian_Zones_Nomenclature_Guideline_2021-media/image150.jpeg){fig-align="left"}

![Broadleaved forest in La Rioja region (Spain). Credits: C. Alonso](Riparian_Zones_Nomenclature_Guideline_2021-media/image151.jpeg){fig-align="left"}

![Poplar (Populus sp.) plantation. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image152.jpeg){fig-align="left"}

![Broadleaved swamp forest, Island of Rügen, Germany. Credits: U. Weingart](Riparian_Zones_Nomenclature_Guideline_2021-media/image153.png){fig-align="left"}

![Broadleaved evergreen forest (Quercus ilex, Quercus coccifera, Juniperus spec.) in Ano Vathia (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image154.jpeg){fig-align="left"}
...
![Natural & semi natural deciduous broadleaved forest near the Danube river near Károlyháza (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image155.png){fig-align="left"}

![Broadleaved forest at the Danube River near Kisbodak (Hungary). Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image156.png){fig-align="left"}


[Broadleaved Swamp Forest:]{.underline}

!["Borsteler Moor" near Borstel, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image157.png){fig-align="left"}
...
![Mediterranean sclerophyllous forest (Quercus rotundifolia) in South Western Spain.  SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-03-18. Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image158.jpeg){fig-align="left"}
...
![Eucalyptus sp. plantation in Southern Spain. Credit: 2009 Ministerio de Fomento IGN](Riparian_Zones_Nomenclature_Guideline_2021-media/image159.jpeg){fig-align="left"}

![Eucalyptus sp. plantation in Southern Spain. Lepe (Huelva, Spain) SPOT-5 (2.5 m) (NIR Band Combination). Date: 2011-08-06. Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image160.png){fig-align="left"}
...
![Clear cuts between harvesting and restoration in an Eucalyptus plantation. Cortegana (Huelva, Spain) SPOT-5 (2.5 m) (NIR Band Combination). Date: 2011-08-06. Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image161.png){fig-align="left"}   
...
![Other natural coniferous (spruce) forest in Attali (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image162.jpeg){fig-align="left"}

![Coniferous forest (Pinus canariensis). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image163.jpeg){fig-align="left"}

![Dwarf pine on swampland, Bavaria, Germany. Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image164.png){fig-align="left"}

![Coniferous forest (Pinus) in Sweden. Source: © LUCAS 2012.](Riparian_Zones_Nomenclature_Guideline_2021-media/image165.png){fig-align="left"}
...
![Other natural or semi-natural coniferous forest located near Bezenye (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image166.png){fig-align="left"}

![Other natural or semi-natural coniferous forest, Harz, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-03. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image167.png){fig-align="left"}
...
![Coniferous forest located at the Monsini Danube River near Magyarkimle (Hungary). Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image168.png){fig-align="left"}   
...
![Highly artificial coniferous plantations (Pine) in the north west of Spain. Source: © LUCAS 2012.](Riparian_Zones_Nomenclature_Guideline_2021-media/image169.png){fig-align="left"}
...
![Highly artificial coniferous plantation (Christmas trees) near Gifhorn, Germany. Spot 6 (1.5 m) (4/1/3 Band Combination). Date: 2013-09-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image170.png){fig-align="left"}

![Highly artificial coniferous plantation (Christmas trees) near Bischofsheim, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-05-25. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image171.png){fig-align="left"}
...
![Highly artificial coniferous plantation in Central Spain. Credit: 2009 Ministerio de Fomento IGN](Riparian_Zones_Nomenclature_Guideline_2021-media/image172.png){fig-align="left"}

![Coniferous plantation in Central Spain. Credit: SPOT-5 (2.5 m) (NIR Band Combination). Date: 2012-07-04. Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image173.png){fig-align="left"}
...
![Mixed forest (Pinus sylvestris, Quercus petraea), Germany. Source: © LUCAS 2012](Riparian_Zones_Nomenclature_Guideline_2021-media/image174.png){fig-align="left"}
...
![Other mixed forest near Runkel, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-06-03. Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image175.png){fig-align="left"}
...
![Mixed swamp forest, "Großes Moor" near Uchte, Northern Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2013©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image176.png){fig-align="left"}
...
![Transitional woodland. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image177.jpeg){fig-align="left"}

![Transitional woodland, Scotland Credits: M. Rosengren](Riparian_Zones_Nomenclature_Guideline_2021-media/image178.jpeg){fig-align="left"}
...
![Reeds alongside a Mediterranean River: Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image179.jpeg){fig-align="left"}
...
![Forest clear-cuts at the Danube river side (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image180.png){fig-align="left"}

![Transitional forest near Zella-Mehlis, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination).Date: 2012-08-01. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image181.png){fig-align="left"}
...
![Lines of tress and scrub, eastern Germany. Source: © LUCAS 2012.](Riparian_Zones_Nomenclature_Guideline_2021-media/image182.png){fig-align="left"}
...
![Lines of trees and scrub near Novákpuszta (Hungary). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-10. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image183.png){fig-align="left"}

![Lines of trees and scrub near Guntershausen, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2010-07-10. Source: CNES 2010©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image184.png){fig-align="left"}

![Example: Lines of trees along river with Strahler level 3 → Forest close to riparian zones. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-10-04. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image185.png){fig-align="left"}

![Example: Lines of forest along river with Strahler level 4 (or higher) → SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-09-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image186.png){fig-align="left"}
...
![Other damaged forest: Bark-beetle damage, Bavarian Forest, Germany. Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image187.png){fig-align="left"}

![Other damaged forest: Bark-beetle damage, Bavarian Forest, Germany. Credits: M. Probeck.](Riparian_Zones_Nomenclature_Guideline_2021-media/image188.png){fig-align="left"}

![Wildfire in Alcala la Real (Spain). http://commons.wikimedia.org/wiki/File:Desolador_paisaje_tras_un_incendio,_en_Alcal%C3%A1_la_Real_(Ja%C3%A9n,_Espa%C3%B1a_2005).jpg#mediaviewer/ File:Desolador_paisaje_tras_un_incendio,_en_Alcal%C3%A1_la_Real_(Ja%C3%A9n,_Espa%C3%B1a_-_2005).jpg ](Riparian_Zones_Nomenclature_Guideline_2021-media/image189.jpeg){fig-align="left"}
...
![Forest damaged by fire in Benicolet (Spain). Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image190.jpeg){fig-align="left"}

![Almost 1.500 ha of forest affected by fire in San Joan de Labritja (Spain). Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image191.jpeg){fig-align="left"}
...
![Bark-beetle damage, Harz National Park, Central Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-03. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image192.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Grassland.png){width=30%}
...
![Managed (improved) grasslands in Friesland (The Netherlands). Credit: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image195.jpeg){fig-align="left"}

![Schematic representation of managed (improved) grasslands](Riparian_Zones_Nomenclature_Guideline_2021-media/image196.jpeg){fig-align="left"}

![Managed (semi-improved) grasslands. Prairies in Auvergne, France. Credit: C. Alonso](Riparian_Zones_Nomenclature_Guideline_2021-media/image197.jpeg){fig-align="left"}

![Schematic representation of managed (semi-improved) grasslands](Riparian_Zones_Nomenclature_Guideline_2021-media/image198.jpeg){fig-align="left"}
...
![Managed grassland in Scandinavia. Borders to arable land. SPOT-5 image.* (*1/2/3 Band Combination). Date: 2011-08-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image199.png){fig-align="left"}
...
![Managed grasslands plot containing scrubs and trees (right), in this case due a process of land abandonment (Central Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image200.jpeg){fig-align="left"}
...
![Hade Edge (United Kingdom). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-01-31. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image201.jpeg){fig-align="left"}
...
![Example of grassland with trees. Omex (France). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-10-04. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image202.png){fig-align="left"}
...
![Managed Grassland. Spot 5 (2.5 m) (1/2/3 Band Combination).Date: 2011-08-27. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image204.png){fig-align="left"}
...
![Managed grassland in mountain regions. France. Spot 5 (2.5 m) (1/2/3 Band Combination).Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image205.png){fig-align="left"}

![Managed grassland in mountain regions. France. Spot 5 (2.5 m) (1/2/3 Band Combination).Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image206.png){fig-align="left"}
...
!["Managed" grassland of motorway junctions. Spot 5 (2.5 m) (1/2/3 Band Combination). Source: CNES ©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image207.png){fig-align="left"}
...
![Typical arable land colour patterns in Landsat images](Riparian_Zones_Nomenclature_Guideline_2021-media/image209.png){fig-align="left"}

![Typical grasslands colour patterns in Landsat images](Riparian_Zones_Nomenclature_Guideline_2021-media/image224.png){fig-align="left"}
...
![Visible cultivation tracks near Beppen (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image235.png){fig-align="left"}

![Homogenous parcels of grassland without visible mowing tracks, Ahsen-Oetzen (Germany). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2013-09-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image236.png){fig-align="left"}

![Tracks in cropland and grassland with no tracks. SPOT-5 (2.5m), Band combination (1/2/3). Date: 2011-05-06.* *Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image237.png){fig-align="left"}

![Examples of rows in a grassland parcel due mowing management. Credits: Eurostat. LUCAS 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image238.jpeg){fig-align="left"}

![Examples of rows in a grassland parcel due mowing management. Credits: Eurostat. LUCAS 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image239.jpeg){fig-align="left"}
...
![Dry grassland with trees on the Franconian Alb (juniper heathland), Germany. Credit: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image240.png){fig-align="left"}

![Schematic representation of calcareous dry grasslands](Riparian_Zones_Nomenclature_Guideline_2021-media/image241.jpeg){fig-align="left"}

![Dry Mediterranean grasslands in Extremadura region, South Western Spain. Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image242.jpeg){fig-align="left"}

![Schematic representation of Mediterranean pseudo-steppes in summer time](Riparian_Zones_Nomenclature_Guideline_2021-media/image243.jpeg){fig-align="left"}

![Pannonian dry grasslands in Northwestern Hungary. Credits: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image244.jpeg){fig-align="left"}

![Nordic alvar (Oländ, Sweden). Credits: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image245.jpeg){fig-align="left"}

![Grasses covering an abandoned arable land. Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image246.jpeg){fig-align="left"}

![Grasses in a military camp. Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image247.jpeg){fig-align="left"}
...
![Spontaneous grassland in Bieszczday district (Poland). Credits: Eurostat, LUCAS, 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image248.jpeg){fig-align="left"}

![Wet grassland in Donegal (Ireland): Credits: Eurostat, LUCAS, 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image249.jpeg){fig-align="left"}

![Wet grassland alongside river humid soils in Spain. Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image250.jpeg){fig-align="left"}

![Schematic representation of Mediterranean alluvial meadows](Riparian_Zones_Nomenclature_Guideline_2021-media/image251.jpeg){fig-align="left"}

[Differentiation between Natural Mesic Grasslands and Wetlands (7.x):]{.underline}

![Differentiation between grasslands and wetlands near Drozdowo (Poland). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-08-27. Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image252.png){fig-align="left"}
...
![Examples of Mediterranean grasslands ploughed 3-5 years to remove scrubs invading the parcel. Example in Extremadura, Spain. Credits: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image253.jpeg){fig-align="left"}

![Examples of Mediterranean grasslands ploughed 3-5 years to remove scrubs invading the parcel. Example in Extremadura, Spain. Credits: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image254.jpeg){fig-align="left"}
...
![Calcareous dry grasslands example with trees (Himsklamm Natura 2000 site, Germany. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2012-08-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image255.jpeg){fig-align="left"}
...
![Mediterranean dry grasslands example (Contrada Giammaiano Natura 2000 site, Sicily, Italy). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-07-16. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image256.jpeg){fig-align="left"}
...
![Pannonic steppe grasslands example. (Hortobágy Natura 2000 site, Hungary. SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-09-22. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image257.png){fig-align="left"}
...
![Anatolian steppe example. Sultanhanı (South of Tuz Lake, Turkey). SPOT-5 (2.5 m.). Date: 2011-11-27. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image258.jpeg){fig-align="left"}
...
![Machair example. Termoncarragh Lake and Annagh Machair SPA (Ireland). In green, Nature 2000 site limits. IRS (20 m.) (3/4/2 Band Combination)Date: 2011-03-31.](Riparian_Zones_Nomenclature_Guideline_2021-media/image259.jpeg){fig-align="left"}
...
![Nordic Alvar example. Stora Alvaret Natura 2000 site, Sweden. Grasslands appear in red colour. SPOT-5 (2.5 m.) (1/2/3 Band Combination) Date: 2011-06-29. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image260.png){fig-align="left"}
...
![Semi-natural grassland (4.2.1.0) on a former military training site. SPOT-5 (2.5m), Band combination (1/2/3). Date: 2011-05-06.* *Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image261.jpeg){fig-align="left"}
...
![Hydrophilous tall herb example. Rečice Natura 2000 site, Croatia. SPOT-5 (2.5 m). Date: 2011-08-25. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image262.png){fig-align="left"}
...
![Alluvial meadow example in Umurca (Turkey) SPOT-5 (2.5 m.) (NIR/R/G Band Combination). Date: 2011-07-05 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image263.jpeg){fig-align="left"}
...
![Oro-Iberian festuca indigesta grasslands at altitude above 2,000 m. in Madrid region (Spanish Central Mountains range) Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image264.jpeg){fig-align="left"}

![Schematic representation of alpine grasslands](Riparian_Zones_Nomenclature_Guideline_2021-media/image265.png){fig-align="left"}

Alpine and subalpine grassland could be located in alpine valley bottom, slopes or mountain tops.

![Location of alpine and subalpine grasslands. Credit: M. Rodriguez](Riparian_Zones_Nomenclature_Guideline_2021-media/image266.jpeg){fig-align="left"}
...
![Alpine meadows/mountain hay meadows discrimination using a theoretical tree line (dotted line in red). Alps in Austria. Credit of photography: European Union, 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image267.png){fig-align="left"}
...
![Siliceous Pyrenean Festuca eskia grassland example. SPOT-5 (2.5 m) (1/2/3 Band Combination). Tendeñera Natura 2000 site, Spain. Date: 2011-09-08.](Riparian_Zones_Nomenclature_Guideline_2021-media/image268.jpeg){fig-align="left"}

![Alpine calcareous grassland example. Verwall Natura 2000 site, Austria. SPOT-5 (2.5 m) (1/2/3 Band Combination) Date: 2012-09-28. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image269.jpeg){fig-align="left"}

![Alpine grassland example. Border between Bosnia and Herzegovina and Montenegro. SPOT-5 (2.5 m) (1/2/3 Band Combination) Date: 2011-10-18. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image270.jpeg){fig-align="left"}

![Alpine grassland example. IRS (20 m.) example. (Durness Natura 2000 site, Scotland, UK). Date: 2013-06-05. Source: CNES 2012©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image271.jpeg){fig-align="left"}

![Example from mountainous parts of Scandinavia. (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image272.png){fig-align="left"}

![Alpine grassland example. France. Spot 5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-18. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image273.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Heathland.png){width=30%}
...
![Un-grassed lichen area of Rödfjället, Dalarana, Sweden. Credit: Charlotta Cristvall](Riparian_Zones_Nomenclature_Guideline_2021-media/image276.jpeg){fig-align="left"}

![Stornärfjället, Dalarna (Sweden). Credit: Sebastian Kirppu](Riparian_Zones_Nomenclature_Guideline_2021-media/image277.jpeg){fig-align="left"}

![Juniperus communis subsp. nana in Mediterranean Alpine-subalpine mountains. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image278.jpeg){fig-align="left"}

![Heathland invading grasslands in Ireland. Credit: A. Utanda](Riparian_Zones_Nomenclature_Guideline_2021-media/image279.jpeg){fig-align="left"}
...
![LC CLC classes. Alpine area south east of Kebnekaise, Sweden. (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image280.png){fig-align="left"}
...
![Heathlands and Moorlands, class 5.1.1.0.* *SPOT 6 image.* *(1/2/3 Band Combination). (1/2/3 Band Combination). Spot 6 image. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image281.png){fig-align="left"}
...
![Heathland and Moorlands in the southern parts of Scandinavia. SPOT-5 image. 1/2/3 Band Combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image282.png){fig-align="left"}
...
![Heathland on a military training site located near Munster, Germany (Niedersachsen), SPOT-5 (2.5m), Date: 2011-05-06. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image283.png){fig-align="left"}
...
![CLC Class 322 "Moors and heathland" used to localize heathland. Munster in Germany (Niedersachsen), SPOT-5 (2.5m), Date: 2011-05-06. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image284.jpeg){fig-align="left"}   
...
![5.1.2.0 Other scrub land: Mountain dwarf pine in the Bavarian Alps, Germany. Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image285.jpeg){fig-align="left"}

![5.1.2.0. Other scrub land, Salix in boreal climate zone of Kiruna, Sweden. Credits: S. Kirppu.](Riparian_Zones_Nomenclature_Guideline_2021-media/image286.jpeg){fig-align="left"}
...
![5.1.2.0. Other scrub land. Location: Kiruna, Sweden. SPOT-6 image (1.5 m), Band Combination. (3/4/2). Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image287.png){fig-align="left"}
...
![5.1.2.0. in low laying parts of mountainous areas relative to dwarf scrubs (5.1.1.0). Location: Kiruna, Sweden. SPOT-6 image (1.5 m), Band Combination. (3/4/2). Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image*](Riparian_Zones_Nomenclature_Guideline_2021-media/image288.png){fig-align="left"}
...
![SPOT-6 image (1.5m), Band Combination (1/2/3). Location: Kiruna, Sweden. Date: 2013-07-24. Source: CNES 2013©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image289.png){fig-align="left"}
...
![Dwarf pine region in the Alps (Austria).Difference in height and texture to neighbouring coniferous forest is clearly visible. SPOT-5 (2.5m), Band combination (1/2/3). CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image290.png){fig-align="left"}
...
!["Garriga" in Catalonia (Spain). Credits: European Union, 2012 LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image291.jpeg){fig-align="left"}

![Sclerophillous vegetation (Stipa tenaccissima) in Central Spain. Credits: European Union, 2012 LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image292.jpeg){fig-align="left"}

![Sclerophyllous vegetation (Asparagus spec., Euphorbia spec., Cistus spec., Olea europaea var. sylvestris) in Loutsa (Island of Evia), Greece. Credits: N. Kolpatzik](Riparian_Zones_Nomenclature_Guideline_2021-media/image293.jpeg){fig-align="left"}

![Scrubs (Retama sphaerocarpa) invading a grassland area in south-western Spain. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image294.jpeg){fig-align="left"}
...
![Tren, Albania. SPOT5, 2.5m. (1/2/3 Band Combination). Date: 2011-08-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image295.jpeg){fig-align="left"}

Mediterranean scrubs in Albania in summer-time.

![Badajoz (Spain) SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-18 Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image296.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image297.png){width=30%}
...
![Sparsely vegetated areas in the foreground Nipfjället, Sweden. Credits S. Kirppu.](Riparian_Zones_Nomenclature_Guideline_2021-media/image298.jpeg){fig-align="left"}

![Sparsely vegetated areas in the background. South of Spain. Credits: M. Palacios.](Riparian_Zones_Nomenclature_Guideline_2021-media/image299.png){fig-align="left"}
...
![Sparsely vegetated areas, Ölands alvar, Sweden. SPOT-5 data.](Riparian_Zones_Nomenclature_Guideline_2021-media/image300.png){fig-align="left"}
...
![Sparsely vegetated area (6.1.0.0) in Agalar (Anatolia, Turkey) SPOT-5 (2.5 m) (NIR/R/G Band Combination). Date: 2011-06-29 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image301.png){fig-align="left"}
...
![Sparsely vegetated area (6.1.0.0) in the Alps. SPOT-5 (2.5 m) (NIR/R/G Band Combination). Date: 2012-09-07 Source: CNES 2011© Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image302.png){fig-align="left"}
...
![Beach at Lanzarote (Canary Islands, Spain). Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image303.jpeg){fig-align="left"}

![Beach at Doñana Natura 2000 site (Southern Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image304.jpeg){fig-align="left"}

![Maspalomas dune, (Canary Islands, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image305.jpeg){fig-align="left"}

![Dune in Doñana Natura 2000 site (Southern Spain) Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image306.jpeg){fig-align="left"}
...
![Example of Beach (sand), 20 -30 m wide. Sudersand, Sweden. Aerial orthophoto. Credit imagery: Lantmäteriet, Sweden](Riparian_Zones_Nomenclature_Guideline_2021-media/image307.jpeg){fig-align="left"}

![Example of Beach (sand). (Sudersand, Sweden). SPOT-5.Credit (1/2/3 Band Combination). Date: 2012-08-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image308.jpeg){fig-align="left"}

![Example of Beach (cobblestones), 10 -20 m wide. (Skäret, Sweden). Aerial orthophoto. Credit: Lantmäteriet, Lantmäteriet](Riparian_Zones_Nomenclature_Guideline_2021-media/image309.jpeg){fig-align="left"}

![Example of Beach (cobblestones), 10 -20 m wide. Skäret, Sweden. SPOT-5.Credit: (1/2/3 Band Combination). Date: 2011-07-04. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image311.jpeg){fig-align="left"}

![Example White and Grey dunes marked (based on Nature 2000 habitats) (Ulla Hau, Sweden). Infrared orthophoto. Credit: Lantmäteriet, Sweden](Riparian_Zones_Nomenclature_Guideline_2021-media/image310.jpeg){fig-align="left"}

![Coniferous forest (CLC)).The dunes are too small to be mapped. (Ulla Hau, Sweden). SPOT-5. (1/2/3 Band Combination). Date: 2012-08-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image312.jpeg){fig-align="left"}
...
![River bank in Var River (Alps Maritimes, France). Credit: European Union, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image313.jpeg){fig-align="left"}
...
![River banks. (Torneträsk, Sweden). Aerial orthophoto. Credit imagery: Lantmäteriet, Sweden.](Riparian_Zones_Nomenclature_Guideline_2021-media/image314.jpeg){fig-align="left"}

![River banks. (Torneträsk, Sweden). SPOT-5. (1/2/3 Band Combination). Date: 2011-07-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image315.jpeg){fig-align="left"}

![River bank (6.2.1.3) in Anatolia (Turkey) SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-06-30. Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image316.png){fig-align="left"}
...
![Bare rocks and rock debris (Sweden). Credits: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image317.jpeg){fig-align="left"}

![Bare rocks and rock debris in the background. Nipfjället, Sweden. Credit: S. Kirppu.](Riparian_Zones_Nomenclature_Guideline_2021-media/image318.jpeg){fig-align="left"}

![Etna's volcanic landscape. (Italy) Credits: A. Utanda](Riparian_Zones_Nomenclature_Guideline_2021-media/image319.jpeg){fig-align="left"}

![Volcanic bare rocks in (Canary Islands, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image320.jpeg){fig-align="left"}
...
![Bare rocks formations (6.3.1.0) in Anatolia (Turkey). SPOT-5 (2,5 m.) (NIR/R/G Band Combination). Date: 2011-06-30 Source: CNES 2011© Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image321.png){fig-align="left"}

![Example of bare rock with \<10% vegetation. It is a steep hillside dotted with birch. (Norway) Image (1/2/3 Band Combination). Date: 2012-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image322.png){fig-align="left"}

![Example of bare rock with \<10% vegetation in the Alps (Austria). SPOT-5 (2.5m), Date: 2012-09-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image323.png){fig-align="left"}
...
![Scrubland affected by fire (North Western Spain). Credit: European Union, LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image324.jpeg){fig-align="left"}
...
![Glacier (6.3.3.*0*) de Bossons (French Alps). Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image325.jpeg){fig-align="left"}

![Glacier (6.3.3.0) de Bossons (detail). Credit: M. Rodriguez](Riparian_Zones_Nomenclature_Guideline_2021-media/image326.jpeg){fig-align="left"}
...
![Glacier and perpetual snow (Kebnekaise, Sweden). SPOT-5. The delineation of the class (yellow polygons) is from CORINE Land Cover and corresponds well to MAES delineation (3/4/2 Band Combination). Date: 2010-09-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image327.jpeg){fig-align="left"}

![Glacier and perpetual snow according to topographical map. (Kebnekaise, Sweden). Credit: Lantmäteriet, Sweden](Riparian_Zones_Nomenclature_Guideline_2021-media/image328.png){fig-align="left"}

![Infrared orthophoto over glacier and perpetual snow. (Kebnekaise, Sweden). Credit: Lantmäteriet, Sweden.](Riparian_Zones_Nomenclature_Guideline_2021-media/image329.jpeg){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Wetland.png){width=30%}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Capture.png){fig-align="left"}

A decision criteria tree is established to clarify guideline distinctions between CODE Level 4 classes as follows:

![](Riparian_Zones_Nomenclature_Guideline_2021-media/image332.png){fig-align="left"}
...
![Inland freshwater marshes in Tablas de Daimiel Natura 2000 Site (Central Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image333.jpeg){fig-align="left"}

![Inland saline marsh in Central Spain. Credit: European Union, 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image334.jpeg){fig-align="left"}

![Interpretation of cyperaceae plants in a wetland. Credits of photography: M. Rodriguez](Riparian_Zones_Nomenclature_Guideline_2021-media/image335.png){fig-align="left"}

![Juncaceae plants. Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image336.png){fig-align="left"}

**Appearance:**

![SPOT-5 (2,5 m). (1/2/3 band combination). Pannonic Salt Steppes example. Felső-kiskunsági szikes tavak és Miklapuszta Natura 2000 site, Hungary. Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image337.png){fig-align="left"}

[Example of "Inland wetland" Interpretation Rules:]{.underline} 

![Araslövssjöområdet Natura 2000 site (limits in green), Sweden. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image338.png){fig-align="left"}

[Waterlogged areas covered by vegetation:]{.underline}

![Srebarna Natura 2000 site (in green), Bulgaria. SPOT-5 2.5 m. (1/2/3 band combination). Date: 2011-04-26. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image339.png){fig-align="left"} 

[Wetlands with Reeds Examples:]{.underline}

![Example of 7.1.0.0 in Umeå, Sweden. (1/2/3 band combination). SPOT-5 image. Date: 2011-07-08. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image342.png){fig-align="left"}

![7.1.0.0 Inland marshes (with reeds). Murnau, Southern Bavaria. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image343.png){fig-align="left"}

![7.1.0.0 Inland marshes (with reeds, mowed and mixed with grassland). Murnau, Southern Bavaria. SPOT-5 (2.5 m. (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image344.png){fig-align="left"}

[Wetland and semi-natural grassland distinction example:]{.underline}

![7.1.0.0 Inland marsh with CLC class 411 overlay. Neighbouring moorland shows yellow-green-spectral signatures. Location: South of Murnau, Southern Bavaria. SPOT-5 (2.5 m), (1/2/3 band combination). Date: 2011-06-28. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image345.png){fig-align="left"}
...
![Exploited peat bog in Roscommon (Ireland). Credit: European Union, 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image346.jpeg){fig-align="left"}
...
![The delineation of the exploited peat bog (yellow polygons) is from CORINE Land Cover and corresponds fairly to MAES delineation. Sweden. SPOT-5 data. Credit imagery: ESA](Riparian_Zones_Nomenclature_Guideline_2021-media/image347.png){fig-align="left"}

![The same area as left but infrared orthophotos as image background. Credit imagery: Lantmäteriet](Riparian_Zones_Nomenclature_Guideline_2021-media/image348.png){fig-align="left"}

![Exploited peat bog in northern Germany. Source: SPOT-5 (2.5m), CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image349.jpeg){fig-align="left"}

![Exploited peat bog in northern Germany - CLC overlay. Source: SPOT-5 (2.5m), CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image350.jpeg){fig-align="left"}
...
![Unexploited peat bog near Benderloch (Wester Scotland, United Kingdom). Credit: European Union, 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image351.jpeg){fig-align="left"}
...
![Unexploited peat bog. Typical raised peatbog. Jordbärsmuren-Albo Natura 2000 site, Sweden, SPOT-5 data. The delineation of the peat bog (yellow polygons) is from CORINE Land Cover and corresponds well to MAES delineation. Credit imagery: ESA](Riparian_Zones_Nomenclature_Guideline_2021-media/image352.jpeg){fig-align="left"}

![Same area as left. The delineation of the peat bog (red polygons) is from Nature 2000 habitat map, also corresponding well to MAES delineation. Credit imagery: ESA](Riparian_Zones_Nomenclature_Guideline_2021-media/image353.jpeg){fig-align="left"}

![Area in the north of Sweden mapped as peat bog in CORINE LC. SPOT-5. Credit imagery: ESA](Riparian_Zones_Nomenclature_Guideline_2021-media/image354.png){fig-align="left"}

![Same area as left. Aerial orthophoto with delineation MAES (based on Nature 2000 habitat map). Credit imagery: Lantmäteriet](Riparian_Zones_Nomenclature_Guideline_2021-media/image355.png){fig-align="left"}
...
![Salt marshes with salt tolerant plants in Camargue (Southern France). Credits: European Union 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image356.jpeg){fig-align="left"}

![Reeds (foreground) and salt tolerant plants (background) in marshes of Foz do Rio Miñor Natura 2000 site (Galicia, Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image357.jpeg){fig-align="left"}

![Salt marsh in Foz do Rio Miñor Natura 2000 site during low tide (Galicia, Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image358.jpeg){fig-align="left"}

![Salt marsh in Foz do Rio Miñor Natura 2000 site during high tide (Galicia, Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image359.jpeg){fig-align="left"}
...
![Marshes in Doñana Natura 2000 site, Spain and estuary of the Guadalquivir river SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image360.png){fig-align="left"}

[Vegetated flat areas in/near the coastline or in estuaries and other coastal landscapes]{.underline}:

![Marais at Gironde estuary (France) SPOT-5 (25 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image361.jpeg){fig-align="left"}

[In the case of salt marshes transformed to agriculture, classification rules are applied as follows]{.underline}:

![Rice fields in Doñana National Park (Spain). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image362.png){fig-align="left"} 

- [Agricultural activity is evident → *2.1.1.0 Arable irrigated and non-irrigated land.*]{custom-style="NormalLine"}\


![Transformed salt marsh in Doñana National Park (Spain) without agricultural use. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image363.png){fig-align="left"}
...
![Pineiou Delta, Natura 2000 site (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image364.jpeg){fig-align="left"width=70%}
...
![Pineiou Delta, Natura 2000 site (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image365.png){fig-align="left"width=70%}
...
![Relevant and clear ponds and channels in salt marshes are classified as 8.2.1.0 Coastal lagoons. SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image367.png){fig-align="left"}
...
![Salines des Pesquieres (Southern France). Credits: European Union 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image368.jpeg){fig-align="left"}

![Salt marshes in Lanzarote (Canary island, Spain). Credit: C. Alonso](Riparian_Zones_Nomenclature_Guideline_2021-media/image369.jpeg){fig-align="left"}
...
![Santa Pola salines (Spain) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-12. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image370.jpeg){fig-align="left"}
...
![Intertidal flat in Étel (Bretagne, France). Credits: European Union, 2012, LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image371.jpeg){fig-align="left"}

![Intertidal flat (Nissum Bredning, Denmark). Credits: European Union, 2012, LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image372.jpeg){fig-align="left"}
...
![Waddenzee (Netherlands). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-10-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image373.png){fig-align="left"}
...
![Schematic differentiation 8.1.3.0 Intertidal flats](Riparian_Zones_Nomenclature_Guideline_2021-media/image374.png){fig-align="left"}

![Schematic differentiation 8.2.2.0 Estuaries](Riparian_Zones_Nomenclature_Guideline_2021-media/image375.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Water.png){width=30%}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image376.png){fig-align="left"}  
...
![Natural and semi-natural water course in Antalya Province (Southern Turkey). Credits: M. Escobar](Riparian_Zones_Nomenclature_Guideline_2021-media/image378.jpeg){fig-align="left"}

![River in Northern Wales (United Kingdom). Credits: European Commission 2012. LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image379.jpeg){fig-align="left"}

![Intermittently running water course (Ribeira de Odeleite, Algarve, Portugal). Credits: Eurostat LUCAS 2013.](Riparian_Zones_Nomenclature_Guideline_2021-media/image380.jpeg){fig-align="left"}
...
![River Weser in Bodenwerder (Lower Saxony, Germany). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image381.png){fig-align="left"}

![Intermittent river in Aetolia-Acarnania region (Greece). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image382.png){fig-align="left"}
...
![Example of delineation of dry braided rivers. Euphrates River (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-25. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image383.png){fig-align="left"}

- [River banks without presence of channels \> 10 m. → classification of all area as *6.2.2.0* *Rivers banks*.]{custom-style="NormalLine"}\

![River system where it is not possible to delineate water channels \> 10 m. Tributary of the Euphrates River (Turkey). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-06-29. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image384.png){fig-align="left"}

[Approach for differentiation between 9.1.1.0 *Interconnected water courses* and flooded areas:]{.underline}

![](Riparian_Zones_Nomenclature_Guideline_2021-media/image385.jpeg){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image386.jpeg){fig-align="left"}
...
![Highly modified natural water course (Río Manzanares crossing Madrid city). Credits: M. Palacios.](Riparian_Zones_Nomenclature_Guideline_2021-media/image387.jpeg){fig-align="left"}

![Canal in Lingen (Lower Saxony, Germany). Credits: Eurostat LUCAS 202.](Riparian_Zones_Nomenclature_Guideline_2021-media/image388.jpeg){fig-align="left"}
...
![Danube river in Gemenc Ramsar Site, Hungary. SPOT-5 2.5 m. (1/2/3 band combination). Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image389.png){fig-align="left"}
...
![Intermittent oxbow lake in Scandinavia. Source: Bjørn Ove Finseth. <http://es.wikipedia.org/wiki/Brazo_muerto#mediaviewer/File:Finna2.JPG> Creative Commons BY 2.5](Riparian_Zones_Nomenclature_Guideline_2021-media/image391.jpeg){fig-align="left"}
...
![Permanent dead side-arms of Danube river (Tolna, Hungary). SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-24. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image392.jpeg){fig-align="left"}
...
![Temporary flood ponds in Danube River in Borcea (Romania). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-04-21. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image393.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image394.jpeg){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image395.png){fig-align="left"}
...
![Permanent natural water body in the Bavarian Alps (S-Germany). Credits: M. Probeck](Riparian_Zones_Nomenclature_Guideline_2021-media/image396.png){fig-align="left"}

![Lake in a green area in Madrid city (Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image397.jpeg){fig-align="left"}
...
![Tail of a reservoir in Euphrates river near Kasaba (Turkey). SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-05-07. Source: CNES 2011©, Distribution Airbus DS/Spot Image](Riparian_Zones_Nomenclature_Guideline_2021-media/image398.jpeg){fig-align="left"}
...
![Delimitation of water bodies using the maximum water lever. This is the **wrong interpretation**. Reservoir in Canary Island (Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image399.png){fig-align="left"}

![Delimitation of water bodies using the current water level. This is the **correct interpretation**. Reservoir in Canary Island (Spain). Credit: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image400.png){fig-align="left"}
...
![Temporary Mediterranean ponds in Castilla-La Mancha (Spain) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-22. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image403.png){fig-align="left"}

![Croaghill Turlough Natura 2000 site, Ireland (outlined Natura 2000 site limit). IRS 20 m. (3/4/2 band combination). Date: 2011-04-29. Credits: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image404.png){fig-align="left"}
...
![Irrigation pond with completely man-made structure (Canary Islands, Spain). Credits: M. Palacios](Riparian_Zones_Nomenclature_Guideline_2021-media/image405.jpeg){fig-align="left"}

![Irrigation pond in Sicily (Italy. Credits: European Commission, 2012, LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image406.jpeg){fig-align="left"}
...
![Irrigation water pond in Thessaly (Greece) SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-23. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image407.png){fig-align="left"}
...
![Fish ponds in Lubusz (Poland). Credits: Eurostat, LUCAS, 2009](Riparian_Zones_Nomenclature_Guideline_2021-media/image408.jpeg){fig-align="left"}
...
![Typical pattern of fish ponds in the region of Třeboňsko (Czech Republic)](Riparian_Zones_Nomenclature_Guideline_2021-media/image4444.png){fig-align="left"}
...
![Mining pond near Tornitz (Saxony-Anhalt, Germany). European Union, 2012, LUCAS](Riparian_Zones_Nomenclature_Guideline_2021-media/image409.jpeg){fig-align="left"}
...
![Water bodies in extraction area - Villedaigne (France) Credit: SPOT-5 (2.5 m.) (1/2/3 Band Combination). Date: 2011-03-20. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image410.jpeg){fig-align="left"}
...
![Water bodies in a gravel pit area - Bozbulut (Turkey) Credit: SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-07-05. Source: CNES 2011©, Distribution Airbus DS/Spot](Riparian_Zones_Nomenclature_Guideline_2021-media/image411.png){fig-align="left"}
...
![Coastal lagoon at Golfo di Signo (Sardinia, Italy). Credits: European Union 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image413.jpeg){fig-align="left"}

![Orbetello Lake (Grosseto, Italy). Credits: European Union 2012, LUCAS.](Riparian_Zones_Nomenclature_Guideline_2021-media/image414.jpeg){fig-align="left"}
...
![SPOT-5 (2.5 m) (1/2/3 band combination). Limnes Voulkaria Kai Saltini Natura 2000 site, Greece. Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image. In green, limits of Natura 2000 site.](Riparian_Zones_Nomenclature_Guideline_2021-media/image415.jpeg){fig-align="left"}

![Schematic representation of typical coastal lagoon landscape.](Riparian_Zones_Nomenclature_Guideline_2021-media/image416.png){fig-align="left"}
...
![Schematic view of the treatment of bare soils in coastal lagoons](Riparian_Zones_Nomenclature_Guideline_2021-media/image417.png){fig-align="left"}

The following types of coastal lagoons are considered according their main morphological characteristics:  

![Schematic view of La Albufera coastal lagoon (Valencia, Spain)](Riparian_Zones_Nomenclature_Guideline_2021-media/image418.png){fig-align="left"}
...
![Schematic view of Falsterbo coastal lagoons complex (Scania Province, Sweden)](Riparian_Zones_Nomenclature_Guideline_2021-media/image420.png){fig-align="left"}

![Schematic view of a transformed coastal lagoon. Logarou lake (Greece).](Riparian_Zones_Nomenclature_Guideline_2021-media/image4211.png){fig-align="left"}
...
![Schematic view of percolation Cemlyn lagoon (north Wales, United Kingdom)](Riparian_Zones_Nomenclature_Guideline_2021-media/image4212.png){fig-align="left"}
...
![Schematic view of silled lagoon of Strangford Lough (Northern Ireland, United Kingdom)](Riparian_Zones_Nomenclature_Guideline_2021-media/image4213.png){fig-align="left"}
...
![Limnes Voulkaria Kai Saltini Natura 2000 site, Greece. SPOT-5 (2.5 m) (1/2/3 band combination). Date: 2011-02-05. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image4214.png){fig-align="left"}
...
![Concept of coastal marshes: A, B, C and D situations are considered as 8.1.1.0 Coastal salt marshes](Riparian_Zones_Nomenclature_Guideline_2021-media/image421.png){fig-align="left"}

![Schematic concept for differentiation between 8.2.1.0/8.1.1.0 classes](Riparian_Zones_Nomenclature_Guideline_2021-media/image4221.png){fig-align="left"}
...
![Schematic concept of coastal lagoons with reed beds and tide channels (Leaky coastal lagoon of Ria Formosa in Portugal)](Riparian_Zones_Nomenclature_Guideline_2021-media/image4222.png){fig-align="left"}
...
![Estuary of Guadalquivir River (Southern Spain). Credits: E. Mazón](Riparian_Zones_Nomenclature_Guideline_2021-media/image422.jpeg){fig-align="left"}
...
![Gironde Estuary delineated (France). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-08-01 Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image423.jpeg){fig-align="left"}

![Schematic representation of typical estuary morphology](Riparian_Zones_Nomenclature_Guideline_2021-media/image424.png){fig-align="left"}
...
![Axios Delta (Greece). SPOT-5 (2.5 m) (1/2/3 Band Combination). Date: 2011-09-17. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image426.png){fig-align="left"}

![Schematic representation of RZ level 4 classification of Axios Delta (Greece)](Riparian_Zones_Nomenclature_Guideline_2021-media/image4262.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image4263.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image4264.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/image4265.png){fig-align="left"}
...
![Marine Others (Fjärdlång, Sweden). Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image427.png){fig-align="left"}

![Marine Others (Grinda, Sweden). Credit: K. Larsson](Riparian_Zones_Nomenclature_Guideline_2021-media/image428.png){fig-align="left"}
...
!["Sea and ocean" is delineated using CLC 522 as indication and computer assisted visual interpretation. Credit imagery: Lantmäteriet, Sweden.](Riparian_Zones_Nomenclature_Guideline_2021-media/image429.jpeg){fig-align="left"}

![Class 8.4.0.0 Sea and ocean, separates from the other marine classes by the presence of fine sediment deposition (8.3.2.0 Estuaries) and Intertidal flats (7.2.3.0) that are in between high and low water marks. (Sweden) (1/2/3 Band Combination). Date: 2013-07-11. Source: CNES 2011©, Distribution Airbus DS/Spot Image.](Riparian_Zones_Nomenclature_Guideline_2021-media/image430.png){fig-align="left"}

![Schematic representation of 8.4 Sea and Ocean class (red dot line)](Riparian_Zones_Nomenclature_Guideline_2021-media/image431.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.1.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.2.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.3.png){fig-align="left"}
...
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.4.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.5.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.6.png){fig-align="left"}

# Annex 2: Re-coding Table for UA Core Areas

![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.7.png){fig-align="left"}
![](Riparian_Zones_Nomenclature_Guideline_2021-media/Annex1.8.png){fig-align="left"}  
