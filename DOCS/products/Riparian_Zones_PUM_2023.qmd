...
- Chapter IX lists references to the cited literature {{< pagebreak >}}
...
*Table 6: List of allowed \[Sensor\] entries* {{< pagebreak >}}
...
In 2012 there is an industrial area (1.1.2) that is below the MMU. Part of a neighbouring urban area (1.1.1) \>0,5 ha changes into industrial area in 2018. The small industrial area from 2012 together with the new industrial area now has a total area large enough for mapping (\>MMU) and therefore the small industrial area "changes" along with the current change and forms a complex change area.  {{< pagebreak >}}
...
**List of Quality Control Steps**
  ...
  ----- ----------- ------------- -------------- -------------------------------------------------------------------
  1     Multipart   Check         Assurance that ![](RZ2023-media/media/image30.jpeg){width="2.9032261592300963in"
        features m  separates all all delivered  height="1.3333333333333333in"}\
        f s f       ultipart d    ata is         Source: Esri ArcGIS 10.2 Help
                    eatures into  inglepart data 
                    s inglepart                  
                    eatures                      

  2     Missing     Check that    Assurance that ![](RZ2023-media/media/image31.JPG)\
        vertices f  all adjacent  delivery data  Source: Interpretation data
        s v c       eatures i     s opologically 
                    hare all t    ound           
                    ertices at s                 
                    ommon edges                  

  3     Overlaps f  Check that    Assurance that ![](RZ2023-media/media/image32.JPG)\
        p n e       eature d      elivery data   Source: Esri ArcGIS 10.2 Help
                    olygons do i  s free of      
                    ot overlap o  verlaps        
                    ach other                    

  4     Gaps f p n  Check that    Assurance that ![](RZ2023-media/media/image33.JPG)\
        g e         eature d      elivery data   Source: Esri ArcGIS 10.2 Help
                    olygons do i  s free of gaps 
                    ot possess                   
                    aps between                  
                    ach other                    
  ------------------------------------------------------------------------------------------------------------------
...
Product technical support is provided by the product custodian through Copernicus Land Monitoring Service helpdesk at <copernicus@eea.europa.eu>. Product technical support doesn't include software specific user support or general GIS or remote sensing support. {{< pagebreak >}}
...
# References
  ...
  \[42\]   L. Lind, E. M. Hasselquist and H. Laudon, "Towards ecologically functional riparian zones: A meta-analysis to develop guidelines for protecting ecosystem functions and biodiversity in agricultural landscapes," *Journal of Environmental Management,* vol. 249, November 2019. {{< pagebreak >}}
