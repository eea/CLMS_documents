...
<table style="border-collapse: collapse; width: 100%; font-size: 14px;">
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>Multipart features</td>
      <td>Check separates all multipart features into singlepart features</td>
      <td>Assurance that all delivered data is singlepart data.</td>
      <td>
        <img src=
        "RZ2023-media/media/image30.jpeg"
          style="object-fit: scale-down;"><br>
          Source: Esri ArcGIS 10.2 Help
      </td>
    </tr>
    <tr>
      <td>2</td>
      <td>Missing vertices</td>
      <td>Check that all adjacent features share all vertices at common edges</td>
      <td>Assurance that delivery data is topologically sound</td>
      <td>
        <img src=
        "RZ2023-media/media/image31.JPG" 
        style="object-fit: scale-down;"><br>
    ...
    <tr>
      <td>3</td>
      <td>Overlaps</td>
      <td>Check that feature polygons do not overlap each other</td>
      <td>Assurance that delivery data is free of overlaps</td>
      <td>
        <img src=
        "RZ2023-media/media/image32.JPG" 
        style="object-fit: scale-down;"><br>
        Source: Esri ArcGIS 10.2 Help
      </td>
    </tr>
    <tr>
      <td>4</td>
      <td>Gaps</td>
      <td>Check that feature polygons do not possess gaps between each other</td>
      <td>Assurance that delivery data is free of gaps</td>
      <td>
        <img src=
        "RZ2023-media/media/image33.JPG" 
        style="object-fit: scale-down;"><br>
        Source: Esri ArcGIS 10.2 Help
      </td>
    </tr>
