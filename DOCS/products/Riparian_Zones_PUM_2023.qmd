...
![Figure 1: Riparian Zones 2012-2018 product portfolio](./Riparian_Zones_PUM_2023-media/media/Fig1.png)
...
![Figure 2: The 43 Riparian Zones Delivery Units (based on ECRINS v1.1)](./Riparian_Zones_PUM_2023-media/media/image6.png)
...
![](./Riparian_Zones_PUM_2023-media/media/Table1.png)

![](./Riparian_Zones_PUM_2023-media/media/Table2.png)

![](./Riparian_Zones_PUM_2023-media/media/Table3.png)

![](./Riparian_Zones_PUM_2023-media/media/Table4.png)
...
[^2]: [**Index of /RiparianZones (europa.eu)**](https://cws-expert.eea.europa.eu/RiparianZones/)[**,**]{.underline} **Username: cwsexpert, Password: expertcws**
...
![Figure 3: AoI amendment example of Str-2 hanging rivers connected to Str. 3](./Riparian_Zones_PUM_2023-media/media/image7.png)

![Figure 4: AoI amendment to include Lake Outline](./Riparian_Zones_PUM_2023-media/media/image8.png)
...
![Table 8: Recoding of the UA Core areas into the RZ Nomenclature](./Riparian_Zones_PUM_2023-media/media/Picture1.png)
...
![Figure 5: UA2012/2018 Integration into the RZ project](./Riparian_Zones_PUM_2023-media/media/image10.png)
...
![Figure 6: Delineation avoiding smooth lines](./Riparian_Zones_PUM_2023-media/media/image11.png)
...
![Figure 7: Delineation avoiding acute angles](./Riparian_Zones_PUM_2023-media/media/image14.png)
...
![Figure 8: MMU exception at RZ border](./Riparian_Zones_PUM_2023-media/media/image15.png)
...
![Figure 9: MMU exception of linear elements](./Riparian_Zones_PUM_2023-media/media/image16.png)
...
![Figure 10: MMU exception between roads](./Riparian_Zones_PUM_2023-media/media/image17.jpeg)
...
![Figure 11: MMW exception](./Riparian_Zones_PUM_2023-media/media/image18.png)
...
-   [UA2012/2018]{.underline}: UA2012/2018 data are integrated in the RZ data set, where UA urban centres[^3] are located inside the RZ. In that case, the MMU of all UA objects is kept; however the UA class codes are recoded to RZ CODE values (as far as possible). Outside UA Urban centres, UA data are used as an important data source for class delineation and class interpretation. Thus, interpreting the same areas twice is avoided and data compatibility between UA and RZ is guaranteed.

-   [High-Resolution Layer (HRL) Imperviousness Degree (IM.D.)]{.underline}: HRL Imperviousness Degree is used to support the imperviousness degree derivation of urban classes during the first mapping phase for the reference year 2012. IM.D. is determined by either visual interpretation based on EO data and the Imperviousness Degree layer or derived by an automatic routine based on the IM.D. layer and road segments.

-   [HRL Tree Cover Density (TCD)]{.underline}: For the reference year 2012, HR Forest Layer is applied to support TCD classification. The classification is performed by either visual interpretation based on EO data and HR Forest Layer or derived by an automatic routine based on HR Forest Layer and forest segments.

-   [CLC2012/2018]{.underline}: CLC2012/2018 is used as important data source for class assignment. CLC data use ensures data compatibility between CLC and RZ.

-   [Landsat-8/Sentinel-2 data sets]{.underline}: For critical classes, Landsat-8/ Sentinel 2 data are used as additional data source. They are primarily used to support cropland/grassland differentiations and to detect irrigated areas, as in those cases, mono-temporal data analysis will not provide reliable results. Time series of summer images are collected for irrigated areas and images acquired in late summer/autumn/spring are used for grassland identification.

-   [In-situ data]{.underline}: Diverse national in-situ data like WMS services, specific maps or classifications as well as descriptions and maps of Natura 2000 (N2000) or RAMSAR site are used to support the object interpretation.
...
![Figure 12: A Green urban area (1.4.0.0) ≥0,5 ha in 2012 changes into Continuous urban fabric (1.1.1.1) in 2018](./Riparian_Zones_PUM_2023-media/media/image19.png)
...
![Figure 13: Changes (Continuous urban fabric 0,4 ha, water area 0,15 ha) with an area \<0,5 ha and different classes make up a complex change area of 0,55 ha](./Riparian_Zones_PUM_2023-media/media/image20.png)
...
![Figure 14: An Olive grove (2.2.2.0) changed into Vineyards, fruit trees and berry plantations (2.2.1.0) and Industrial, commercial and military units (1.1.2.0), but because the areas are \<0,5 ha, they are merged with the neighbouring objects.](./Riparian_Zones_PUM_2023-media/media/image21.png)
...
![Figure 15: Urban expansion: Several changes with an area \<0,5 ha make up a complex change area of 0,5 ha (0,1 ha of 4.1.0.0 and 0,4 ha of 2.1.1.0 changed to 0,5 ha of 1.1.1.1)](./Riparian_Zones_PUM_2023-media/media/image22.png)
...
![Figure 16: Polygons \<0,5 ha with no change (4.1.0.0) but connected to polygons (1.3.1) where there is a change](./Riparian_Zones_PUM_2023-media/media/image23.png)
...
![Figure 17: Simple change](./Riparian_Zones_PUM_2023-media/media/image24.png)
...
![Figure 18: Simple change](./Riparian_Zones_PUM_2023-media/media/image25.png)
...
![Figure 19: Small change integrated into adjacent change](./Riparian_Zones_PUM_2023-media/media/image26.png)
...
![Figure 20: Generalisation (disappearing polygon)](./Riparian_Zones_PUM_2023-media/media/image27.png)
...
![Figure 21: A new Aquaculture pond (8.2.3) is established on semi-natural grassland (4.2.x).](./Riparian_Zones_PUM_2023-media/media/image28.png)
...
![Figure 22: New established feature with splitted change](./Riparian_Zones_PUM_2023-media/media/image29.png)
...
+:==========+:===========================+:======================================================================+:===================================================+:==================================================================================================+
| 1         | Multipart features m f s f | Check separates all ultipart d eatures into s inglepart eatures       | Assurance that all delivered ata is inglepart data | ![](Riparian_Zones_PUM_2023-media/media/image30.jpeg){width="2.9032261592300963in" height="1.3333333333333333in"}\ |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 2         | Missing vertices f s v c   | Check that all adjacent eatures i hare all t ertices at s ommon edges | Assurance that delivery data s opologically ound   | ![](Riparian_Zones_PUM_2023-media/media/image31.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Interpretation data                                                                       |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 3         | Overlaps f p n e           | Check that eature d olygons do i ot overlap o ach other               | Assurance that elivery data s free of verlaps      | ![](Riparian_Zones_PUM_2023-media/media/image32.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
| 4         | Gaps f p n g e             | Check that eature d olygons do i ot possess aps between ach other     | Assurance that elivery data s free of gaps         | ![](Riparian_Zones_PUM_2023-media/media/image33.JPG)\                                                              |
|           |                            |                                                                       |                                                    | Source: Esri ArcGIS 10.2 Help                                                                     |
+-----------+----------------------------+-----------------------------------------------------------------------+----------------------------------------------------+---------------------------------------------------------------------------------------------------+
...
| No. | Check                                                            | Description                                                                                   | Purpose                                                                                                | Example                                                                                                                                                                                                                                                                                                                        |
+:===:+:=================================================================+:==============================================================================================+:======================================================================================================:+:==============================================================================================================================================================================================================================================================================================================================:+
| 1   | Multipart                                                        | Check separates features into singlepart features s                                           | Assurance that all delivered data is inglepart data.                                                   | ![](Riparian_Zones_PUM_2023-media/media/image30.jpeg){width="2.9in" height="1.33in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 2   | Missing vertices                                                 | Check that all adjacent features share all vertices at common edges ( c                       | Assurance that delivery data is topologically sound share exactly ommon edges)                         | ![](Riparian_Zones_PUM_2023-media/media/image31.JPG){width="2.27in" height="1.53in"}                                                                                                                                                                                                                                                            |
|     |                                                                  |                                                                                               |                                                                                                        |                                                                                                                                                                                                                                                                                                                                |
|     |                                                                  |                                                                                               |                                                                                                        | Source: Interpretation data                                                                                                                                                                                                                                                                                                    |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 3   | Overlaps                                                         | Check that feature polygons do not overlap each other                                         | Assurance that delivery data is free of overlaps                                                       | ![](Riparian_Zones_PUM_2023-media/media/image32.JPG){width="0.99in" height="1.03in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 4   | Gaps                                                             | Check that feature polygons do not possess gaps between each other                            | Assurance that delivery data is free of gaps                                                           | ![](Riparian_Zones_PUM_2023-media/media/image33.JPG){width="1.30in" height="0.97in"} Source: Esri ArcGIS 10.2 Help                                                                                                                                                                                                                              |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 9   | Unnecessary polygon boundaries                                   | Check finds adjacent polygons with same attribution p                                         | Assurance that delivery data is free of unnecessary olygon boundaries                                  | ![](Riparian_Zones_PUM_2023-media/media/image34.jpeg){width="2.90in" height="0.87in"} Source: interpretation data                                                                                                                                                                                                                               |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 15  | Attribution completeness of attribute tables                     | Check completeness of attribute tables                                                        | Assure that all attributes are complete and correct                                                    | ![](Riparian_Zones_PUM_2023-media/media/image35.png){width="2.90in" height="0.39in"}                                                                                                                                                                                                                                                            |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 17  | Projection                                                       | Check projection h                                                                            | LAEA-projection as to be defined                                                                       | ![](Riparian_Zones_PUM_2023-media/media/image36.png){width="2.85in" height="0.78in"}                                                                                                                                                                                                                                                            |
+-----+------------------------------------------------------------------+-----------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
