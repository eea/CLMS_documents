...
![Figure 1 - ‘Which category describes best your current professional activity?’ (single choice)](Survey_Evaluation_v1-media/img-7fc03cfba11c7af99271d646985f693eea22b9bd.png){width="6.27in"}
...
![Figure 2 - ‘How would you rate your technical skills in the field of geospatial applications?’](Survey_Evaluation_v1-media/img-d82b983272123af1c3826fb1c922c0428186da86.png){width="6.27in"}
...
![Figure 3 - ‘How do you normally work with geodata?’](Survey_Evaluation_v1-media/img-b517b561ae2527eb4f9db918fdb10897bb804325.png){width="6.27in"}
...
![Figure 4 - What is the data amount you are usually dealing with? (single choice)](Survey_Evaluation_v1-media/img-fd0320b7c3ea7d2d43dc68e239016ec2f0d948f4.png){width="6.27in"}
...
![Figure 5 - 'Where is your data mostly stored?' (multiple question)](Survey_Evaluation_v1-media/img-9fcdf4dd99e33e58363bedaf14ede7ffd8020dff.png){width="6.27in"}
...
## In recent times, let’s say in the past year, have you been working in a cloud processing environment? {#sec-3-3}
...
![Figure 6 - In recent times, let's say in the past year, have you been working in a cloud processing environment?](Survey_Evaluation_v1-media/img-847a58a2c98af9f2bb83d5970d0a80c5b862ded8.png){width="6.27in"}
...
![Figure 7 – What is the scale you are usually working on? (multiple choice)](Survey_Evaluation_v1-media/img-512418cabf87a8782d0d8a929294999ef8874591.png){width="6.27in"}
...
![Figure 8 - Generally, do you find yourself in the situation where you would like to have more data/products at your disposal?](Survey_Evaluation_v1-media/img-b9a0538f6ac96aa1dc153d1e6526ec2149bc2f7a.png){width="6.27in"}
...
![Figure 9 – ‘Think about new products that you wish to include in your processes. How difficult/problematic is…’](Survey_Evaluation_v1-media/img-a9bf8b3bb3ef3583aacd84449d7142cc137d5de1.png){width="6.27in"}
...
![Figure 10 – ‘How easy it is...’](Survey_Evaluation_v1-media/img-7059a8039acb8745a6057d792689b8d46f062375.png){width="6.27in"}
...
![Figure 11 - 'Please rank the following ways of consuming geospatial data according to your preference and regular use'](Survey_Evaluation_v1-media/img-1dfb0d2b588aed2d55dd53387a4c4271397c434b.png){width="6.27in"}
