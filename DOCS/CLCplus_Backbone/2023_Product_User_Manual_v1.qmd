...
![Figure 1: Overview of CLCplus Backbone layers produced for the reference year 2023.](CLCplus_Backbone_2023_PUM_v1_2-media/img-3ae7a950b89b88ab5164a45a96c174e993f664d9.png)
...
![Table 2: Thematic raster classes of CLCplus Backbone 2023, their class codes and colours.](CLCplus_Backbone_2023_PUM_v1_2-media/table2.png)

![Figure 2: CLCplus Backbone 2023 for the EEA38+UK (note: French DOMs are not shown).](CLCplus_Backbone_2023_PUM_v1_2-media/img-9df408152771d42bb0f22ad96081a803854b9e76.png)
...
![Figure 3: CLCplus Backbone 2023 for tile E44N36 (Copenhagen).](CLCplus_Backbone_2023_PUM_v1_2-media/img-66b2331d63fc430e212e30aa8999c547d0b8dc82.png)
...
![Figure 4: Exemplary 10x10m plot illustration of a situation where no single land cover class covers 50% of the area.](CLCplus_Backbone_2023_PUM_v1_2-media/img-0f13569c926a8fcffb56ce87a86f6969e7efe854.png)
...
![Figure 5: Levels 1-5 of the EAGLE Land Cover Components (LCC) v3.2[^1]. The hierarchical levels allow for resolving the LCC assignment in the most suitable way. In case level 1 is too general, the most suitable lower level is chosen.](CLCplus_Backbone_2023_PUM_v1_2-media/img-eeda59c50bb28bb4c441bd411b0a293d236bdfac.png)
...
![Figure 6: Decision tree for the usage of area thresholds for pixels with (pure or) spatially mixed land cover in the CLCplus Backbone.](CLCplus_Backbone_2023_PUM_v1_2-media/img-dc7fffd1594ddeea432815b9578cf21c994675b4.png)
...
![](CLCplus_Backbone_2023_PUM_v1_2-media/img-ce527b7884c864e1d4f22d1adf6949c45d24f5e1.png)
...
![](CLCplus_Backbone_2023_PUM_v1_2-media/example2.png)
...
![Figure 15: Example of the uncertainty in the mapping of Low-growing woody plants. This example from Northern Sweden illustrates that a sharp distinction of shrubs and trees is often difficult and sometimes remains fuzzy even at the level of the same species (here different specimens of Betula with sometimes more tree-like, sometimes more shrub-like habitus). In addition, the canopy is rather sparse and the understorey comprises a mix of herbaceous species, dwarf shrubs as well as mosses and lichens.](CLCplus_Backbone_2023_PUM_v1_2-media/img-98f8fc0c2616e39680f4446b5be599320c5a71ab.png)
...
![Figure 17: CLCplus Backbone Data Score Layer (RASDL) of the reference year 2023 (±3 months).](CLCplus_Backbone_2023_PUM_v1_2-media/img-957b567d0ef07f50f054c5cee41babd5cf0d641d.png)
...
![Figure 18: CLCplus Backbone Raster Confidence Layer 2023.](CLCplus_Backbone_2023_PUM_v1_2-media/img-dce450dddbdcde7b15953ed341a6d06ccee0784e.png)

![Figure 19: Closeup of the RASCL showing edges as a result of separate training models per production unit.](CLCplus_Backbone_2023_PUM_v1_2-media/img-30f84d5430161602116c020f37687fa15d9cb6f1.png)

![Figure 20: Distribution and fractions of values in the Raster Confidence Layer (RASCL) of CLCplus Backbone 2023 across the EEA38+UK.](CLCplus_Backbone_2023_PUM_v1_2-media/img-59c1dd0915814ee2101e85c9ab825da1feea60d1.png)
...
![Figure 21: CLCplus Backbone Raster Post-Processing Layer (RASPL) 2023.](CLCplus_Backbone_2023_PUM_v1_2-media/img-873fc1d0b90c1e8fea175db5a26fb19ff0db0f39.png)
...
![Colour palette for the Raster (RAS) Product](CLCplus_Backbone_2023_PUM_v1_2-media/image1.png)

Data Score Layer (RASDL)

![Colour palette for the Data Score Layer](CLCplus_Backbone_2023_PUM_v1_2-media/image2.png)

Raster Confidence Layer (RASCL)

![Colour palette for the Raster Confidence Layer](CLCplus_Backbone_2023_PUM_v1_2-media/image3.png)

Post-Processing Layer (RASPL)

![Colour palette for the Raster Post-Processing layer](CLCplus_Backbone_2023_PUM_v1_2-media/image4.png)
