...
![Figure 1: Overview of products, produced for the reference year 2021](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-b4fbbbdc4b33564621ee337d9861f70a86f3661e.png)
...
![Figure 2: CLC+ BB Raster Product 2021 for the EEA-38 area.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-12e5610281353b753a3417050e02fd6b68e04ddd.png)
...
![Figure 3: Exemplary 10x10m plot illustration of a situation where no single land cover class reaches 50%.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-faa419a259fdd5e59310f4ac6d9b6a79f7e5c071.png)
...
![Figure 4: Levels 1-4 of the EAGLE Land Cover Components (LCC) v3.1. The component hierarchy shall be used to resolve the class assignment in cases where no single land cover class dominates.](Product_Specification_and_User_Manual_Raster_Product_2021-media/image4.png)
...
![Figure 5: Decision tree for the usage of area thresholds for pixels with (pure or) spatially mixed land cover in the Raster Product.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-6b363aeea02c234f42a1dce3fae11f9d8e5dda9c.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-f4616282bc6f3850c711288c37e17f15242e3baa.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-3215f868ce96270cf1adfebba005b649b22f5397.png)
...
![Figure 7: CLC+ BB Raster Product (left) and ESRI World Imagery (right) for a rural area in France illustrating the interruption of narrow linear elements which do not reach the majority per 10 m pixels (black grid lines) and typically show mixed spectral signals in the Sentinel-2 time series.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-9a1448c6e7124fd7a8c0e1560834fff3a0eb3396.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-349277b02736665865c69655a9a0243f9074b8d4.png)
...
![Figure 10: Example of the mapping of ephemeral classes in the CLC+ BB Raster Product. Permanent Snow and Ice is mapped according to its spatio-temporal coverage during the reference year 2021. In the given example from the 2018 production, areas which are more than 90% of the observations covered by snow or ice (i.e. NDSI typically above 0.41), are correctly mapped as Snow and Ice. Adjacent areas with shorter snow or ice coverage are correctly mapped as Sparsely- and Non-vegetated.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-e86685f85d5413260b54cd186872dedeb9fac63a.png)
...
![Figure 13: Example of the mapping of intensively used grassland (e.g. fodder crops). The distinction between the classes Permanent Herbaceous and Periodically Herbaceous depends on whether the bare soil is exposed (e.g. ploughed parcel on the right, mapped as Periodically Herbaceous) within the reference year or not. Especially under temporarily very dry conditions, the distinction of mowing events (i.e. no ploughing on the left parcel, mapped as Permanent Herbaceous) from actual exposure of bare soil can be very difficult.](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-bd9a18fb9fef08fefe83dbf6d12a26a471853f49.png)
...
![Figure 16: Production units (French DOMs excluded) for the CLC+ BB Raster Product 2021](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-42bf5c09c27a718fe5a3a197d2368c1af3cc16e2.png)
...
![Figure 17: 2018 Raster Product (left) and 2021 Raster Product (right) with recoded coastal seawater buffer (light blue)](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-db0b46869144e0cd243dc15d7c93f9c926aa2460.png)
...
![Figure 18: CLC+ BB Data Score Layer of the reference year 2021 (± 3 months)](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-19221ab04124c8c686e30662fbb4b097f7dfa540.png)
...
![Figure 19: CLC+ BB Raster Confidence Layer 2021](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-3dd6e98050d5f9a4ebaa5a73fcd25fc8a82510fd.png)
...
![Figure 20: Distribution of CLC+ BB Raster Confidence values across the EEA-38](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-eac0f2423dc5a495a417b23890e03f8e568597e3.png)
...
![Figure 21: CLC+ BB Raster Post-processing Layer 2021](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-4f751e7bd8cdb48ed8c628345c3ca1e514fc00f5.png)
...
![Figure 22: National projection of the CLC+ Raster Product 2021 for French Guiana](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-90beb29f480bb39421fe68a70bfa544fd9bd7ee9.png)
...
![Figure 23: Distribution of the sampling and reporting units for the EEA38 Raster Product](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-dc70829b3e91ed45c09c7f5efda5bed7239b648f.png)
...
![Figure 24: Sampling design distribution over the EEA-38](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-984e908801a86d07df904c3407f42f39083cb4da.png)
...
![Figure 25: Qgis validation tool to support the interpretation of large numbers of sampling units](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-14a326f4b4a3c5c6980335c3113e75e88d0445e2.png)

![Figure 26: Example of NDVI profile](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-a6a275caf9dba06610be1c3f79e592c09811c18b.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/table6.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/table8.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/table9.png)
...
![Figure 27: Example for class 6 commission in a vineyard](Product_Specification_and_User_Manual_Raster_Product_2021-media/image27.png)

![Figure 28: Example for class 4 commission in shrubby area](Product_Specification_and_User_Manual_Raster_Product_2021-media/image28.png)

![Figure 29: Example for class 3 commission in an area with deciduous shrubs](Product_Specification_and_User_Manual_Raster_Product_2021-media/img-a7b4212d6bded43329bb252cba3379eb4daac7ad.png)
...
![Figure 30: Example for a sample validated as omission due to the NDVI value](Product_Specification_and_User_Manual_Raster_Product_2021-media/image28.png)
...
![](Product_Specification_and_User_Manual_Raster_Product_2021-media/image1.png)

*Data Score Layer*

Colour palette for the Data Score Layer

![](Product_Specification_and_User_Manual_Raster_Product_2021-media/image2.png)

*Raster Confidence Layer*

Colour palette for the Raster Confidence Layer

![](Product_Specification_and_User_Manual_Raster_Product_2021-media/image3.png)

*Post-Processing Layer*

Colour palette for the Raster Post-processing layer

![](Product_Specification_and_User_Manual_Raster_Product_2021-media/image3.1.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 1](Product_Specification_and_User_Manual_Raster_Product_2021-media/turkey.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 2](Product_Specification_and_User_Manual_Raster_Product_2021-media/france.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 3](Product_Specification_and_User_Manual_Raster_Product_2021-media/spain.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 4](Product_Specification_and_User_Manual_Raster_Product_2021-media/sweden.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 5](Product_Specification_and_User_Manual_Raster_Product_2021-media/germany.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 6](Product_Specification_and_User_Manual_Raster_Product_2021-media/finland.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 7](Product_Specification_and_User_Manual_Raster_Product_2021-media/norway.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 8](Product_Specification_and_User_Manual_Raster_Product_2021-media/poland.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 9](Product_Specification_and_User_Manual_Raster_Product_2021-media/italy.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 10](Product_Specification_and_User_Manual_Raster_Product_2021-media/ireland.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 11](Product_Specification_and_User_Manual_Raster_Product_2021-media/romania.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 12](Product_Specification_and_User_Manual_Raster_Product_2021-media/cyprus.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 13](Product_Specification_and_User_Manual_Raster_Product_2021-media/bulgaria.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 14](Product_Specification_and_User_Manual_Raster_Product_2021-media/island.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 15](Product_Specification_and_User_Manual_Raster_Product_2021-media/hungaria.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 16](Product_Specification_and_User_Manual_Raster_Product_2021-media/portugal.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 17](Product_Specification_and_User_Manual_Raster_Product_2021-media/austria.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 18](Product_Specification_and_User_Manual_Raster_Product_2021-media/belgium.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 19](Product_Specification_and_User_Manual_Raster_Product_2021-media/albania.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 20](Product_Specification_and_User_Manual_Raster_Product_2021-media/slovenia.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 21](Product_Specification_and_User_Manual_Raster_Product_2021-media/czech.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 22](Product_Specification_and_User_Manual_Raster_Product_2021-media/latvia.png)
...
![CLC+ Backbone Raster Product - Producer’s and User’s accuracy in percent for zone 23](Product_Specification_and_User_Manual_Raster_Product_2021-media/french.png)
