...
format:
  ...
  pdf: default
keywords: ["10. output location", "11. quarto", "12. local", "13. build", "14. special",
  "15. site.", "2. manage", "3. media", "4. rendering", "5. documentation", "6. html",
  "7. pdf", "8. docx", "9. preview", "Answer: 1. environment", "Example Output:",
  "Example:", "```"]
---
...
You must adjust `reference-doc:` under the `docx:` to specify the default style used for the DOCX/PDF output.
...
-   Output files (HTML, DOCX) are written directly next to the `.qmd` file (e.g. in `src/products/`)
