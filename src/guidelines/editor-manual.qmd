...
<!--# I have looked into the  ../../metadata/default.yml. there are several things which are also set here e.g. toc but also others. In this document we may go a bit more into detail what is controlled in default.yaml and what can/should be controlled by the document creator. deleteme once done -->
