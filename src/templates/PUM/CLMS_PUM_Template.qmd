---
title: "PUM Copernicus Land Monitoring Service -- Product full name"
subtitle: "Product SHORT NAME Product User Manual (PUM)"
date: "2022-10-06"
...
# User requirements [(optional chapter)]{.yellow-box custom-style="yellow-box-line"}
...
:::{.yellow-box custom-style="yellow-box"}
Provides a comprehensive overview of the product's portfolio, including multiple product types (where applicable). It details the layers specifications, reference years or time series, and update cycles. Additionally, it outlines the thematic characteristics, geospatial format and distribution (e.g., 100 km LAEA tiles), as well as the metadata, standards, and alignment with the EEA reference grid.
:::
...
:::{.yellow-box custom-style="yellow-box"}
Describes the characteristics of the product, the thematic definition and the relation with different datasets, the elements included and excluded, classified features and layers coding. Use third-level subchapters to structure if needed.
:::
...
```{=html}
<table>
  <caption>Table 7.1 Vector dataset/layer sheet (replace with field ‘Layer name’)</caption>
  <thead>
    <tr>
      <th>Field</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td colspan="5">Categorization of a dataset according to its content, purpose, timeliness, level of processing or similar (e.g. status/change/aggregated /expert/intermediate/reference layer; near-real time)</td>
    </tr>
    <tr>
      <td>Summary</td>
      <td colspan="5">Brief description of the dataset, including the data type (vector), spatial resolution, input data sources, reference dates, and auxiliary features</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="5">File format in which the datasets and ancillary files are delivered (e.g. geopackage, dataset in HDF5, external colour tables in *.lyr and *.lyrx formats)</td>
    </tr>
    <tr>
      <td>Quality -- Production verification</td>
      <td colspan="5">Quality statement of the dataset detailing the results of production verification: user's/producer's or/and overall quality of the dataset (e.g. layer thematic accuracy reached/exceed the 90% producer's and user's target.)</td>
    </tr>
  </tbody>
</table>
```
...
```{=html}
<table>
  <caption>Table 7.2 Raster dataset/layer sheet (replace with field 'Layer name')</caption>
  <thead>
    <tr>
      <th>Field</th>
  ...
  <tbody>
    ...
    <tr>
      <td>Dataset category</td>
      <td colspan="2">Categorization of a dataset according to its content, purpose, timeliness, level of processing or similar (e.g. status/change/aggregated /expert/intermediate/reference layer; near-real time)</td>
    </tr>
    <tr>
      <td>Summary</td>
      <td colspan="2">Brief description of the dataset, including the data type (vector), spatial resolution, input data sources, reference dates, and auxiliary features</td>
    </tr>
    <tr>
      <td>Reference year/cycle/period</td>
    ...
    <tr>
      <td>Coverage</td>
      <td colspan="2">Geographic area covered by the product area (and reference of EEA coverage) (e.g. EEA-38 + UK)</td>
    </tr>
    <tr>
      <td>Geometric accuracy</td>
      <td colspan="2">Positional accuracy of the product, expressed in meters at a specific % confidence level (e.g. ~11m at 95.5% confidence)</td>
    </tr>
    <tr>
      <td>Thematic accuracy</td>
    ...
    <tr>
      ...
      <td colspan="2">Smallest area that is represented in the dataset (e.g. 0.5 ha (50 pixels))</td>
    </tr>
    <tr>
      <td>Raster coding</td>
      <td colspan="2">
    ...
    <tr>
      <td>Delivery format</td>
      <td colspan="2">File format in which dataset is delivered (e.g. GeoTiff)</td>
    </tr>
    <tr>
      <td>Quality - Production verification</td>
      <td colspan="2">Quality statement of the dataset detailing the results of production verification: user's/producer's or/and overall quality of the dataset (e.g. layer thematic accuracy reached/exceed the 90% producer's and user's target.)</td>
    </tr>
  </tbody>
</table>
```
...
[^1]: [Copernicus Land Monitoring Service - Data policy](https://land.copernicus.eu/en/data-policy){target=_blank}

[^2]: [Copernicus Land Monitoring Service -- Service desk](https://land.copernicus.eu/en/data-policy){target=_blank}
