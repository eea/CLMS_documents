...
This Product User Manual details the CLCplus Backbone 2023, a foundational product within the Copernicus Land Monitoring Service’s CLCplus Product Suite. It comprehensively describes this large-scale, seamless land cover inventory for the EEA38 and UK, derived from Sentinel-2 satellite imagery at 10m spatial resolution. The document outlines the 11 basic land cover classes, their nomenclature based on the EAGLE model, and technical specifications, including auxiliary Raster Data Score, Confidence, and Post-processing layers. It further elucidates product lineage, application areas supporting environmental policy like LULUCF, and methodological insights, empowering users to effectively utilise this vital geospatial dataset.
...
CLCplus Backbone 2023, land cover classification, 10m spatial resolution, Sentinel-2 time series, EAGLE Land Cover Components, Temporal Convolutional Neural Network, LULUCF reporting, thematic accuracy assessment, Raster Data Score Layer, Raster Confidence Layer, Raster Post-processing Layer, European land monitoring
