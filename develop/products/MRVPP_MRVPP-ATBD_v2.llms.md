...
© European Union, Copernicus Land Monitoring Service 2026, European Environment Agency (EEA)

Reuse is authorised under the Creative Commons Attribution 4.0 International (CC BY 4.0) licence. The reuse policy of the European Commission is implemented by Commission Decision 2011/833/EU.

Where third-party content is identified, separate permission may be required.
...
# 3 Input data and plant phenology index for MR-VPP
...
![](MRVPP_MRVPP-ATBD_v2-media/img-ed65a43813c9f8636ab49e9a99041236.png)
...
![](MRVPP_MRVPP-ATBD_v2-media/img-9b74f7681b6cb6837197dad9dc3be062.png)

Figure 2. Processing flowchart for Plant Phenology Index (PPI) calculation

## 3.3 Calculation of PPI Quality flag (QA) values for TIMESAT processing
...
## 3.4 Specification of output PPI data
...
![](MRVPP_MRVPP-ATBD_v2-media/img-d83e527495e21e29642a0fa3fb6686a7.png)
...
## 4.3 Related and previous applications
...
### 4.3.3 Evaluation of Short Time-Series Processing for Operational Phenology Retrieval
...
## 4.4 Detailed algorithm description

### 4.4.1 Extraction of phenology and productivity parameters using TIMESAT

An overview of TIMESAT version 4.2 processing is shown in Figure 4.

![](MRVPP_MRVPP-ATBD_v2-media/img-584e4dfd6ae1178e149b1991921e7e93.png)
...
### 4.4.3 PPI fitting to daily data
...
### 4.4.4 Extraction of phenology and productivity parameters
...
![](MRVPP_MRVPP-ATBD_v2-media/img-95c01c5f9bd858e2d5cfeb660289d497.png)

Figure 5. TIMESAT module for extracting phenological parameters.

### 4.4.5 Defining growing season thresholds
...
### 4.4.6 Assigning seasons to years
...
![](MRVPP_MRVPP-ATBD_v2-media/img-6bec814ea766febc6cde5d7bfd808050.png)
...
### 4.4.7 Defining thresholds for omitting seasons and regions
...
![](MRVPP_MRVPP-ATBD_v2-media/img-b1a39741ad3489a9ede924eceb8b60ab.png)
...
![](MRVPP_MRVPP-ATBD_v2-media/img-07c8b38d2e9c4aa2768a258a1f8e3986.png)
...
## 4.6 Risk of failure and mitigation measures
...
# 5 Post processing and file naming
...
- Bolton, D. K., Gray, J. M., Melaas, E. K., Moon, M., Eklundh, L., & Friedl, M. A. (2020). Continental-scale land surface phenology from harmonized Landsat 8 and Sentinel-2 imagery. *Remote Sensing of Environment, 240*, 111685. https://doi.org/https://doi.org/10.1016/j.rse.2020.111685
...
- Chmura, H. E., Kharouba, H. M., Ashander, J., Ehlman, S. M., Rivest, E. B., & Yang, L. H. (2019). The mechanisms of phenology: the patterns and processes of phenological shifts. *Ecological Monographs, 89*(1), e01337. https://doi.org/https://doi.org/10.1002/ecm.1337
...
- Jin, H., & Eklundh, L. (2014). A physically based vegetation index for improved monitoring of plant phenology. *Remote Sensing of Environment, 152*(0), 512-525. https://doi.org/doi.org/10.1016/j.rse.2014.07.010
...
- Jönsson, P., & Eklundh, L. (2004). TIMESAT – a program for analyzing time-series of satellite sensor data. *Computers & Geosciences, 30*(8), 833-845. ://WOS:000225367100004
...
- Olsson, L., & Eklundh, L. (1994). Fourier-Series for Analysis of Temporal Sequences of Satellite Sensor Imagery. *International Journal of Remote Sensing, 15*(18), 3735-3741. ://WOS:A1994PZ44700008
...
## 7.1 Comparison of TPROD using Version 5.0 and 4.0
...
![](MRVPP_MRVPP-ATBD_v2-media/img-9b6bf208da4a290a31d1d20e7cd36dd9.png)

Figure 9. Pan-European TPROD (Season 1, 2018) from MR-VPP Versions 4.0 and 5.0, showing correction of artifacts in desert/barren areas, in particular in N. Africa.

1.  MR-VPP version 4.0
2.  MR-VPP version 5.0

## 7.2 Comparison of MR-VPP naming scheme in Version 5.0 and 4.0
...
## 7.3 Detailed Comparison of 2025 MR-VPP V5.0 Issue 2.0 Results from Short and Long Input Time Series
...
![](MRVPP_MRVPP-ATBD_v2-media/img-4e7996f2eab8c321fb188c0c010123ef.png)

![](MRVPP_MRVPP-ATBD_v2-media/img-2c5e4c7e031a5a7b445d1d6e2fae3030.png)

![](MRVPP_MRVPP-ATBD_v2-media/img-7cf817c6c6a0fb7dfba709884fbdfc62.png)
...
![](MRVPP_MRVPP-ATBD_v2-media/img-00fc8e231c1e7e3ed79e717cc61b37f8.png)
...
![](MRVPP_MRVPP-ATBD_v2-media/img-b08a8132b99b9a13639476be6698a2ca.png)
