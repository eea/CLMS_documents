...
This Product User Manual describes the Copernicus Land Monitoring Service’s (CLMS) High Resolution Layer (HRL) Croplands product, focusing on crop types and agricultural practices across the EEA38. It details yearly 10-metre spatial resolution raster products, including Crop Types (CTY) and various Cropping Patterns (CP) layers such as harvest, fallow land, and secondary crops. The document explains the production methodology using Sentinel-2 data, outlines diverse application areas like biomass monitoring, and presents the rigorous quality assessment and validation procedures, including F-score metrics, ensuring high thematic accuracy.
...
HRL Croplands, crop types mapping, agricultural practices, Sentinel-2 data, cropping patterns, land cover monitoring, biomass monitoring, thematic accuracy, fallow land, secondary crops, spatial resolution, EEA38
