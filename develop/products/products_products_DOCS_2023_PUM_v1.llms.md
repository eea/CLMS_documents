...
This Product User Manual details the Copernicus Land Monitoring Service’s CLCplus Backbone 2023, a high-resolution land cover raster product. It provides comprehensive technical specifications for 11 thematic classes across the EEA38, the UK, and French Overseas Departments, derived from Sentinel-2 time series imagery at 10m spatial resolution. The document elucidates the class nomenclature, rooted in EAGLE Land Cover Components, and outlines the decision tree for class assignment. Furthermore, it describes auxiliary layers for data quality and classification confidence, equipping scientists, regulators, and data engineers with essential information for diverse environmental analyses and applications.
...
CLCplus Backbone 2023, land cover classification, Sentinel-2 time series, 10m spatial resolution, EAGLE Land Cover Components, Temporal Convolutional Neural Network, thematic accuracy, raster data quality, land use, land use change and forestry (LULUCF), Copernicus Land Monitoring Service
