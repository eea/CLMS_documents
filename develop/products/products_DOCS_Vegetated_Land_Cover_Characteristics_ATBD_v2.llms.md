...
This Algorithm Theoretical Basis Document (ATBD) comprehensively details the methodologies, algorithms, and workflows for the Copernicus Land Monitoring Service’s High-Resolution Vegetated Land Cover Characteristics (HRL VLCC) product suite. It focuses on the generation of annual maps and change layers for Tree Cover & Forests, Grasslands, and Croplands across Europe, utilising Sentinel-2 imagery, Temporal Convolutional Neural Networks, and CatBoost regression models. The document describes the innovative Base Vegetation Layer and advanced techniques for agricultural monitoring, ensuring high thematic accuracy and supporting various environmental policies.
...
High-Resolution Vegetated Land Cover Characteristics, Sentinel-2 time-series, Temporal Convolutional Neural Networks, Base Vegetation Layer, Tree Cover Density, Crop Type classification, Grassland Mowing Events, Ploughing indicator, Cropping Patterns, Thematic accuracy, LULUCF regulation, Algorithm Theoretical Basis Document
