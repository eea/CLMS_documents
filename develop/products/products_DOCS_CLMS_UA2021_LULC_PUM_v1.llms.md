...
This Product User Manual serves as a comprehensive guide for the Copernicus Urban Atlas 2021, a crucial dataset for monitoring European urban areas. It elucidates the product’s vector layers, covering detailed land use and land cover mapping, and critical changes observed between 2018 and 2021 at high spatial resolution. The document outlines the semi-automatic production methodologies, integrating VHR and Sentinel-2 satellite imagery, along with ancillary data, to produce status and change layers. Special attention is given to the innovative classification of Green Urban Areas by public or private accessibility, supporting urban planning and environmental policy.
...
Copernicus Urban Atlas, land use/land cover mapping, Functional Urban Areas, change detection, Green Urban Areas accessibility, Sentinel-2 imagery, Very High Resolution imagery, Principal Component Analysis, Root Mean Square Deviation, thematic accuracy, OpenStreetMap, vector data
