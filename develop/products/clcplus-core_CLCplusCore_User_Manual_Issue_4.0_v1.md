...
- [<span class="toc-section-number">1</span>
  ...
  - [<span class="toc-section-number">1.9</span> About
    EAGLE](#about-eagle)
- [<span class="toc-section-number">2</span> <span id="_Toc154044849"
  class="anchor"></span>EAGLE](#eagle2)
  ...
  - [<span class="toc-section-number">2.3</span>
    <span id="_Toc154044853" class="anchor"></span>EAGLE Ontology
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image3.jpg"
...
System and how to perform an Ingestion or Extraction. Chapter
[0](#_Ref105139868) gives an introduction about how to get started and
the main functionalities of the CLC+ Core. Further, you get to
information about the Organizations and User that are part of the
System. The EAGLE concept, as a main part of the System, is described in
chapter [0](#_Toc65609501). In this section you get tips and hints how
to perform the EAGLE barcoding. There are already several datasets in
the CLC+ Core System. The process how to ingest your own data in the
System is described in chapter [3](#ingestions) whereas chapter
[4](#extraction) explains the creation of an Extraction. The Frequently
Asked Questions (FAQ) section ([5](#faq-frequently-asked-questions))
provides the user a summary of questions and their answers regarding the
CLC+ Core environment.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image4.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image7.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image8.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image9.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image11.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image12.jpg"
...
In the table below ([Table 1‑1](#_Ref151985895)) the roles possible in
the CLC+ Core system are listed:
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image16.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image17.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image18.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image19.jpg"
...
[Figure 1‑11](#_Ref151467477)). On pages with a higher number, you can
find previously ingested datasets.

**Help function** by clicking on the “?” icon on the bottom right corner
(see [Figure 1‑11](#_Ref151627187)) a separate Help window opens in
which the use can report any issues or questions. The support contact
form can be found here:
<https://land.copernicus.eu/en/contact-service-helpdesk>.

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image21.png"
style="width:6.925in;height:3.82847in"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image20.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image23.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image24.jpg"
style="width:6.92939in;height:3.85834in"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image25.jpeg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image26.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image27.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image28.png"
...
clock icon (see [Figure 1‑18](#_Ref151468543)).

By clicking on the **notification’s icon**, a more detailed view of the
notifications opens which includes all notifications (see [Figure
1‑18](#_Ref151468543)). By clicking on the notification or by clicking
“Mark all as read” (all) notifications get read and the blue dot
disappears.

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image30.jpg"
style="width:6.9252in;height:2.75173in"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image29.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image34.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image35.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image36.png"
...
CLMS products and by GDAL (see Annex [Table 0‑4](#_Ref151967307)).
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image37.png"
...
# [<span id="_Toc154044849" class="anchor"></span>EAGLE](https://land.copernicus.eu/eagle)[^2]
...
will need for the EAGLE barcoding (section [2.3](#_Ref153949431)).
Additionally, expert users have the possibility to add new EAGLE
ontologies (section 6.3 in separate Annex). The most current version of
the EAGLE matrix is v3.2[^3] which is also implemented already in the
current version of the CLC+ Core system. In the current EAGLE matrix
version some elements have been deleted and the barcoding values were
reduced to X-5 instead of before X,0-6.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image38.png"
...
ingested (see in Annex [Table 0‑2](#_Ref151628372)). They are detectable
as they were created exclusively by the „User Admin /Support CLC+ Core”
User.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image39.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image40.jpg"
style="width:6.26806in;height:5.13194in"
data-fig-alt="This table presents an excerpt from the EAGLE (EIONET Action Group on Land monitoring in Europe) matrix, detailing hierarchical classifications for Land Cover Components (LCC) and Land Use Attributes (LUA) used within the Copernicus Land Monitoring Service (CLMS) CLC+ Core consortium. The table includes the following metadata fields: `Class Code*` with value `84100`, `Name*` with value `Open sea`, `100% EAGLE Compliant*` with value `Yes`, and `Colour Code` with value `#e6f5f3`. / Code / Label / Level / Factor / /---/---/---/---/ / LCC-2_2_1_2 / Reeds, Bamboos, Canes / 4 / / / LCC-2_2_2 / Non-Graminoids (Forbs, Ferns) / 3 / / / LCC-2_3 / Succulents, Cacti / 2 / / / LCC-2_4 / Lichens, Mosses, Algae / 2 / / / LCC-2_4_1 / Lichens / 3 / / / LCC-2_4_2 / Mosses / 3 / / / LCC-2_4_3 / Algae / 3 / / / LCC-2_4_3_1 / Macro Algae / 4 / / / LCC-2_4_3_2 / Micro Algae (Plankton) / 4 / / / LCC-3 / Water / 1 / / / LCC-3_1 / Liquid Water Bodies / 2 / / / LCC-3_1_1 / Inland Water Bodies / 3 / / / LCC-3_1_1_1 / Water Course / 4 / / / LCC-3_1_1_2 / Standing Water / 4 / / / LCC-3_1_2 / Marine Waters / 3 / 5 / / LCC-3_2 / Solid Waters / 2 / / / LCC-3_2_1 / Snow / 3 / / / LCC-3_2_2 / Ice, Glaciers / 3 / / / LUA / Land Use Attributes / 0 / / / LUA-1 / Primary Production Sector / 1 / / / LUA-1_1 / Agriculture / 2 / / / LUA-1_1_1 / Commercial Crop Production / 3 / / / LUA-1_1_2 / Farming Infrastructure / 3 / / / LUA-1_1_2_1 / Animal Husbandry / 4 / / / LUA-1_1_2_2 / Farming Storage / 4 / / / LUA-1_1_2_3 / Other Farming Infrastructure / 4 / / / LUA-1_1_3 / Production for Own Consumption / 3 / / / LUA-1_2 / Forestry / 2 / / / LUA-1_3 / Mining and Quarrying / 2 / / / LUA-1_4 / Aquaculture and Fishing / 2 / / / LUA-1_4_1 / Aquaculture / 3 / / / LUA-1_4_2 / Professional Wild Fishery / 3 / / / LUA-1_5 / Other Primary Production / 2 / / / LUA-1_5_1 / Hunting / 3 / / / LUA-1_5_2 / Migratory Animals / 3 / / / LUA-1_5_3 / Picking Natural Products / 3 / / / LUA-1_5_4 / Apiculture (Bee Hives) / 3 / / The table details Land Cover Components (LCC) such as vegetation (e.g., Reeds, Bamboos, Canes, Lichens, Mosses, Algae) and various water bodies (e.g., Inland Water Bodies, Standing Water, Marine Waters, Snow, Ice, Glaciers), alongside Land Use Attributes (LUA) related to primary production (e.g., Agriculture, Forestry, Mining and Quarrying, Aquaculture and Fishing). Each entry includes a hierarchical `Code`, `Label`, and `Level` (ranging from 0 for broad categories like LUA to 4 for highly specific types like Micro Algae or Animal Husbandry), with only `Marine Waters` having a `Factor` of `5`." />

This table presents an excerpt from the EAGLE (EIONET Action Group on
Land monitoring in Europe) matrix, detailing hierarchical
classifications for Land Cover Components (LCC) and Land Use Attributes
(LUA) used within the Copernicus Land Monitoring Service (CLMS) CLC+
Core consortium.

The table includes the following metadata fields: `Class Code*` with
value `84100`, `Name*` with value `Open sea`, `100% EAGLE Compliant*`
with value `Yes`, and `Colour Code` with value `#e6f5f3`.
...
The table details Land Cover Components (LCC) such as vegetation (e.g.,
Reeds, Bamboos, Canes, Lichens, Mosses, Algae) and various water bodies
(e.g., Inland Water Bodies, Standing Water, Marine Waters, Snow, Ice,
Glaciers), alongside Land Use Attributes (LUA) related to primary
production (e.g., Agriculture, Forestry, Mining and Quarrying,
Aquaculture and Fishing). Each entry includes a hierarchical `Code`,
`Label`, and `Level` (ranging from 0 for broad categories like LUA to 4
for highly specific types like Micro Algae or Animal Husbandry), with
only `Marine Waters` having a `Factor` of `5`.

<span id="_Ref100052219" class="anchor"></span>**Figure 2‑3: Coastal
Zones - "Open Sea" land cover components, land use attributes**

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image41.jpg"
style="width:6.26806in;height:4.07292in"
data-fig-alt="This table displays a simplified EAGLE (Eionet Action Group on Land monitoring in Europe) barcoding scheme used by the Copernicus Land Monitoring Service (CLMS) CLC+ CORE consortium for land cover and land use classification. The table includes columns for `URI` (Uniform Resource Identifier), `Code`, `Label`, `Level`, `Barcode`, and `Factor`. Above the main data, general instructions state: `Class Code* (If continuous dataset, enter &#39;0&#39; as Class Code)`. Additional metadata indicates the dataset is `100% EAGLE Compliant` (Yes) and provides a `Colour Code` (`#FFFFFF`). The text `Inland water for mineral extraction` is also present at the top right, possibly as a specific example for barcoding application. The table content is: / URI / Code / Label / Level / Barcode / Factor / /---/---/---/---/---/---/ / https://dd.LCC-2_4_3 / LCC-2_4_3 / Algae / 3 / / / / https://dd.LCC-2_4_3_1 / LCC-2_4_3_1 / Macro Algae / 4 / / / / https://dd.LCC-2_4_3_2 / LCC-2_4_3_2 / Micro Algae (Plankton) / 4 / / / / https://dd.LCC-3 / LCC-3 / Water / 1 / / / / https://dd.LCC-3_1 / LCC-3_1 / Liquid Water Bodies / 2 / / / / https://dd.LCC-3_1_1 / LCC-3_1_1 / Inland Water Bodies / 3 / 3 / / / https://dd.LCC-3_1_1_1 / LCC-3_1_1_1 / Water Course / 4 / / / / https://dd.LCC-3_1_1_2 / LCC-3_1_1_2 / Standing Water / 4 / / / / https://dd.LCC-3_1_2 / LCC-3_1_2 / Marine Waters / 3 / / / / https://dd.LCC-3_2 / LCC-3_2 / Solid Waters / 2 / / / / https://dd.LCC-3_2_1 / LCC-3_2_1 / Snow / 3 / / / / https://dd.LCC-3_2_2 / LCC-3_2_2 / Ice, Glaciers / 3 / / / / LUA / LUA / Land Use Attributes / 0 / / / / https://dd.LUA-1 / LUA-1 / Primary Production Sector / 1 / / / / https://dd.LUA-1_1 / LUA-1_1 / Agriculture / 2 / / / / https://dd.LUA-1_1_1 / LUA-1_1_1 / Commercial Crop Production / 3 / / / / https://dd.LUA-1_1_2 / LUA-1_1_2 / Farming Infrastructure / 3 / / / / https://dd.LUA-1_1_2_1 / LUA-1_1_2_1 / Animal Husbandry / 4 / / / / https://dd.LUA-1_1_2_2 / LUA-1_1_2_2 / Farming Storage / 4 / / / / https://dd.LUA-1_1_2_3 / LUA-1_1_2_3 / Other Farming Infrastructure / 4 / / / / https://dd.LUA-1_1_3 / LUA-1_1_3 / Production for Own Consumption / 3 / / / / https://dd.LUA-1_2 / LUA-1_2 / Forestry / 2 / / / / https://dd.LUA-1_3 / LUA-1_3 / Mining and Quarrying / 2 / 5 / / / https://dd.LUA-1_4 / LUA-1_4 / Aquaculture and Fishing / 2 / / / / https://dd.LUA-1_4_1 / LUA-1_4_1 / Aquaculture / 3 / / / / https://dd.LUA-1_4_2 / LUA-1_4_2 / Professional Wild Fishery / 3 / / / / https://dd.LUA-1_5 / LUA-1_5 / Other Primary Production / 2 / / / / https://dd.LUA-1_5_1 / LUA-1_5_1 / Hunting / 3 / / / The table provides a hierarchical classification of Land Cover Classes (LCC), such as &#39;Water&#39; and its subtypes (e.g., &#39;Inland Water Bodies&#39;), and Land Use Attributes (LUA), like &#39;Primary Production Sector&#39; with its sub-sectors (e.g., &#39;Agriculture&#39;, &#39;Forestry&#39;, &#39;Mining and Quarrying&#39;). Specific &#39;Barcode&#39; values are assigned to &#39;Inland Water Bodies&#39; (3) and &#39;Mining and Quarrying&#39; (5), illustrating a simplified barcoding approach for these categories." />

This table displays a simplified EAGLE (Eionet Action Group on Land
monitoring in Europe) barcoding scheme used by the Copernicus Land
Monitoring Service (CLMS) CLC+ CORE consortium for land cover and land
use classification. The table includes columns for `URI` (Uniform
Resource Identifier), `Code`, `Label`, `Level`, `Barcode`, and `Factor`.
Above the main data, general instructions state:
`Class Code* (If continuous dataset, enter "0" as Class Code)`.
Additional metadata indicates the dataset is `100% EAGLE Compliant`
(Yes) and provides a `Colour Code` (`#FFFFFF`). The text
`Inland water for mineral extraction` is also present at the top right,
possibly as a specific example for barcoding application.
...
The table provides a hierarchical classification of Land Cover Classes
(LCC), such as “Water” and its subtypes (e.g., “Inland Water Bodies”),
and Land Use Attributes (LUA), like “Primary Production Sector” with its
sub-sectors (e.g., “Agriculture”, “Forestry”, “Mining and Quarrying”).
Specific “Barcode” values are assigned to “Inland Water Bodies” (3) and
“Mining and Quarrying” (5), illustrating a simplified barcoding approach
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image42.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image43.jpg"
style="width:6.26806in;height:6.98819in"
data-fig-alt="This table provides a hierarchical classification of Copernicus Land Monitoring Service (CLMS) Land Cover Components, detailing codes, Uniform Resource Identifiers (URIs), descriptive names, and their hierarchical level, alongside &#39;Barcode&#39; values for specific land cover types. The table is structured into columns: &#39;URI&#39;, &#39;Code&#39;, &#39;Land Cover Components&#39;, &#39;Label (Level)&#39;, &#39;Barcode&#39;, and &#39;Factor&#39;. The classification includes: - **Abiotic / Non-Vegetated Surfaces and Objects (LCC-1)** (Level 0, with red background shading): Subdivided into &#39;Artificial Surfaces and Constructions&#39; (LCC-1_1, Level 1, Barcode 1) and &#39;Natural Material Surfaces&#39; (LCC-1_2, Level 2). Artificial surfaces further branch into &#39;Sealed Artificial Surfaces and Constructions&#39; (LCC-1_1_1, Level 2) like &#39;Buildings&#39; (LCC-1_1_1_1, Level 3) and &#39;Open Sealed Surfaces&#39; (LCC-1_1_1_3, Level 3), and &#39;Non-Sealed Artificial Surfaces&#39; (LCC-1_1_2, Level 2, Barcode 1) like &#39;Waste Materials&#39; (LCC-1_1_2_2, Level 4). Natural Material Surfaces include &#39;Consolidated Surfaces&#39; (LCC-1_2_1, Level 3) like &#39;Bare Rock&#39; (LCC-1_2_1_1, Level 4) and &#39;Unconsolidated Surfaces&#39; (LCC-1_2_2, Level 3) which include &#39;Mineral Fragments&#39; (LCC-1_2_2_1, Level 4) such as &#39;Sand, Grit&#39; (LCC-1_2_2_1_3, Level 5, Barcode 1) and &#39;Bare Soils&#39; (LCC-1_2_2_2, Level 4, Barcode 1), and &#39;Natural Deposits&#39; (LCC-1_2_2_3, Level 4) including &#39;Organic Deposits (Peat)&#39; (LCC-1_2_2_3_2, Level 5). - **Biotic / Vegetation (LCC-2)** (Level 1, with green background shading): Subdivided into &#39;Woody Vegetation&#39; (LCC-2_1, Level 2) (e.g., &#39;Trees&#39;, &#39;Bushes, Shrubs&#39;), &#39;Herbaceous Vegetation (Grass-Like, Forbs, Ferns)&#39; (LCC-2_2, Level 2) (e.g., &#39;Grasses, Sedges, Rushes, Cereals&#39;, &#39;Non-Graminoids (Forbs, Ferns)&#39;), &#39;Succulents, Cacti&#39; (LCC-2_3, Level 2), and &#39;Lichens, Mosses, Algae&#39; (LCC-2_4, Level 2). The top-level LCC-2 has a Barcode of 3. - **Water (LCC-3)** (Level 1, with blue background shading): Subdivided into &#39;Liquid Water Bodies&#39; (LCC-3_1, Level 2) and &#39;Solid Waters&#39; (LCC-3_2, Level 2). Liquid Water Bodies include &#39;Inland Water Bodies&#39; (LCC-3_1_1, Level 3, Barcode 1) (e.g., &#39;Water Course&#39;, &#39;Standing Water&#39;) and &#39;Marine Waters&#39; (LCC-3_1_2, Level 3). Solid Waters include &#39;Snow&#39; (LCC-3_2_1, Level 3) and &#39;Ice, Glaciers&#39; (LCC-3_2_2, Level 3, Barcode 1, Factor 1). Additional metadata is present: &#39;Class Code* (If continuous dataset, enter &#39;0&#39; as Class Code)&#39; is indicated, alongside &#39;100% EAGLE Compliant&#39; status &#39;Yes&#39;, a &#39;Colour Code&#39; of &#39;#000000&#39;, and a &#39;Name*&#39; field showing &#39;Sports area&#39;. The &#39;Factor&#39; column is largely empty, with a single value of &#39;1&#39; for &#39;Ice, Glaciers&#39;." />

This table provides a hierarchical classification of Copernicus Land
Monitoring Service (CLMS) Land Cover Components, detailing codes,
Uniform Resource Identifiers (URIs), descriptive names, and their
hierarchical level, alongside “Barcode” values for specific land cover
types. The table is structured into columns: “URI”, “Code”, “Land Cover
Components”, “Label (Level)”, “Barcode”, and “Factor”.

The classification includes: - **Abiotic / Non-Vegetated Surfaces and
Objects (LCC-1)** (Level 0, with red background shading): Subdivided
into “Artificial Surfaces and Constructions” (LCC-1_1, Level 1,
Barcode 1) and “Natural Material Surfaces” (LCC-1_2, Level 2).
Artificial surfaces further branch into “Sealed Artificial Surfaces and
Constructions” (LCC-1_1_1, Level 2) like “Buildings” (LCC-1_1_1_1, Level
3) and “Open Sealed Surfaces” (LCC-1_1_1_3, Level 3), and “Non-Sealed
Artificial Surfaces” (LCC-1_1_2, Level 2, Barcode 1) like “Waste
Materials” (LCC-1_1_2_2, Level 4). Natural Material Surfaces include
“Consolidated Surfaces” (LCC-1_2_1, Level 3) like “Bare Rock”
(LCC-1_2_1_1, Level 4) and “Unconsolidated Surfaces” (LCC-1_2_2, Level
3) which include “Mineral Fragments” (LCC-1_2_2_1, Level 4) such as
“Sand, Grit” (LCC-1_2_2_1_3, Level 5, Barcode 1) and “Bare Soils”
(LCC-1_2_2_2, Level 4, Barcode 1), and “Natural Deposits” (LCC-1_2_2_3,
Level 4) including “Organic Deposits (Peat)” (LCC-1_2_2_3_2, Level 5). -
**Biotic / Vegetation (LCC-2)** (Level 1, with green background
shading): Subdivided into “Woody Vegetation” (LCC-2_1, Level 2) (e.g.,
“Trees”, “Bushes, Shrubs”), “Herbaceous Vegetation (Grass-Like, Forbs,
Ferns)” (LCC-2_2, Level 2) (e.g., “Grasses, Sedges, Rushes, Cereals”,
“Non-Graminoids (Forbs, Ferns)”), “Succulents, Cacti” (LCC-2_3, Level
2), and “Lichens, Mosses, Algae” (LCC-2_4, Level 2). The top-level LCC-2
has a Barcode of 3. - **Water (LCC-3)** (Level 1, with blue background
shading): Subdivided into “Liquid Water Bodies” (LCC-3_1, Level 2) and
“Solid Waters” (LCC-3_2, Level 2). Liquid Water Bodies include “Inland
Water Bodies” (LCC-3_1_1, Level 3, Barcode 1) (e.g., “Water Course”,
“Standing Water”) and “Marine Waters” (LCC-3_1_2, Level 3). Solid Waters
include “Snow” (LCC-3_2_1, Level 3) and “Ice, Glaciers” (LCC-3_2_2,
Level 3, Barcode 1, Factor 1).

Additional metadata is present: “Class Code\* (If continuous dataset,
enter”0” as Class Code)” is indicated, alongside “100% EAGLE Compliant”
status “Yes”, a “Colour Code” of “\#000000”, and a ’Name\*’ field
showing “Sports area”. The “Factor” column is largely empty, with a
single value of ‘1’ for “Ice, Glaciers”.

<span id="_Toc137576633" class="anchor"></span>**Figure 2‑6: NL BBG -
"Sports Area" which includes land cover component ice rinks**

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image44.jpg"
style="width:6.26806in;height:3.71389in"
data-fig-alt="This table presents a segment of the Land Use Attribute (LUA) classification scheme, specifically detailing &#39;Cultural, Entertainment and Recreational Services&#39; and &#39;Transport Networks, Logistics, Utilities&#39;. The table includes metadata for the entire dataset: &#39;Class Code&#39; is 41, &#39;Name&#39; is &#39;Sports area&#39;, &#39;100% EAGLE Compliant&#39; is &#39;Yes&#39;, and &#39;Colour Code&#39; is &#39;#000000&#39;. The main table columns are: / URI / Code / Label / Level / Barcode / Factor / /:----------------------------/:-------------/:--------------------------------------------------/:------/:--------/:-------/ / https://dd.LUA-3_3_4_2 / LUA-3_3_4_2 / Monastery / 4 / / / / https://dd.LUA-3_3_4_3 / LUA-3_3_4_3 / Cemetery / 4 / / / / https://dd.LUA-3_3_5 / LUA-3_3_5 / Other Community Services / 3 / / / / https://dd.LUA-3_4 / LUA-3_4 / Cultural, Entertainment and Recreational Services / 2 / / / / https://dd.LUA-3_4_1 / LUA-3_4_1 / Cultural Services / 3 / / / / https://dd.LUA-3_4_1_1 / LUA-3_4_1_1 / Indoor Cultural Service / 4 / / / / https://dd.LUA-3_4_1_2 / LUA-3_4_1_2 / Outdoor Cultural Service / 4 / / / / https://dd.LUA-3_4_2 / LUA-3_4_2 / Entertainment / 3 / / / / https://dd.LUA-3_4_3 / LUA-3_4_3 / Sports Infrastructure / 3 / 5 / / / https://dd.LUA-3_4_3_1 / LUA-3_4_3_1 / Golf Course / 4 / / / / https://dd.LUA-3_4_3_2 / LUA-3_4_3_2 / Ski Piste / 4 / / / / https://dd.LUA-3_4_3_3 / LUA-3_4_3_3 / Outdoor Racecourse / 4 / / / / https://dd.LUA-3_4_3_4 / LUA-3_4_3_4 / Sport Hall / 4 / / / / https://dd.LUA-3_4_3_5 / LUA-3_4_3_5 / Stadium / 4 / / / / https://dd.LUA-3_4_3_6 / LUA-3_4_3_6 / Swimming Pool / 4 / / / / https://dd.LUA-3_4_3_7 / LUA-3_4_3_7 / Sports Ground / 4 / / / / https://dd.LUA-3_4_3_8 / LUA-3_4_3_8 / Indoor Sport-/Fitness Facility / 4 / / / / https://dd.LUA-3_4_3_9 / LUA-3_4_3_9 / Yachtharbour, Sport Boat Marina / 4 / / / / https://dd.LUA-3_4_4 / LUA-3_4_4 / Open Air Recreational Areas / 3 / / / / https://dd.LUA-3_4_4_1 / LUA-3_4_4_1 / Urban Greenery and City Parks / 4 / / / / https://dd.LUA-3_4_4_2 / LUA-3_4_4_2 / (Semi-)Natural Areas Used for Recreation / 4 / / / / https://dd.LUA-3_4_5 / LUA-3_4_5 / Other Recreational Services / 3 / / / / https://dd.LUA-3_4_5_1 / LUA-3_4_5_1 / Allotment Garden / 4 / / / / https://dd.LUA-3_4_5_2 / LUA-3_4_5_2 / Amateur Fishing / 4 / / / / https://dd.LUA-3_5 / LUA-3_5 / Other Services / 2 / / / / https://dd.LUA-4 / LUA-4 / Transport Networks, Logistics, Utilities / 1 / / / The &#39;Level&#39; column indicates the hierarchical depth of each Land Use Attribute (LUA) category. The &#39;Barcode&#39; column contains a value of &#39;5&#39; for the &#39;Sports Infrastructure&#39; (LUA-3_4_3) entry, suggesting a specific classification code for this category within a wider &#39;Sports area&#39; context. The table details various sub-categories under &#39;Sports Infrastructure,&#39; all at Level 4, such as &#39;Golf Course,&#39; &#39;Ski Piste,&#39; &#39;Stadium,&#39; and &#39;Swimming Pool.&#39;" />

This table presents a segment of the Land Use Attribute (LUA)
classification scheme, specifically detailing “Cultural, Entertainment
and Recreational Services” and “Transport Networks, Logistics,
Utilities”. The table includes metadata for the entire dataset: “Class
Code” is 41, “Name” is “Sports area”, “100% EAGLE Compliant” is “Yes”,
and “Colour Code” is “\#000000”.

The main table columns are: \| URI \| Code \| Label \| Level \| Barcode
\| Factor \|
\|:—————————-\|:————-\|:————————————————–\|:——\|:——–\|:——-\| \|
...
\| \| https://dd.LUA-3_4 \| LUA-3_4 \| Cultural, Entertainment and
Recreational Services \| 2 \| \| \| \| https://dd.LUA-3_4_1 \| LUA-3_4_1
\| Cultural Services \| 3 \| \| \| \| https://dd.LUA-3_4_1_1 \|
LUA-3_4_1_1 \| Indoor Cultural Service \| 4 \| \| \| \|
https://dd.LUA-3_4_1_2 \| LUA-3_4_1_2 \| Outdoor Cultural Service \| 4
\| \| \| \| https://dd.LUA-3_4_2 \| LUA-3_4_2 \| Entertainment \| 3 \|
\| \| \| https://dd.LUA-3_4_3 \| LUA-3_4_3 \| Sports Infrastructure \| 3
\| 5 \| \| \| https://dd.LUA-3_4_3_1 \| LUA-3_4_3_1 \| Golf Course \| 4
\| \| \| \| https://dd.LUA-3_4_3_2 \| LUA-3_4_3_2 \| Ski Piste \| 4 \|
\| \| \| https://dd.LUA-3_4_3_3 \| LUA-3_4_3_3 \| Outdoor Racecourse \|
4 \| \| \| \| https://dd.LUA-3_4_3_4 \| LUA-3_4_3_4 \| Sport Hall \| 4
...
\| \| https://dd.LUA-3_4_3_8 \| LUA-3_4_3_8 \| Indoor Sport-/Fitness
Facility \| 4 \| \| \| \| https://dd.LUA-3_4_3_9 \| LUA-3_4_3_9 \|
Yachtharbour, Sport Boat Marina \| 4 \| \| \| \| https://dd.LUA-3_4_4 \|
LUA-3_4_4 \| Open Air Recreational Areas \| 3 \| \| \| \|
https://dd.LUA-3_4_4_1 \| LUA-3_4_4_1 \| Urban Greenery and City Parks
\| 4 \| \| \| \| https://dd.LUA-3_4_4_2 \| LUA-3_4_4_2 \| (Semi-)Natural
Areas Used for Recreation \| 4 \| \| \| \| https://dd.LUA-3_4_5 \|
LUA-3_4_5 \| Other Recreational Services \| 3 \| \| \| \|
...
https://dd.LUA-4 \| LUA-4 \| Transport Networks, Logistics, Utilities \|
1 \| \| \|

The “Level” column indicates the hierarchical depth of each Land Use
Attribute (LUA) category. The “Barcode” column contains a value of ‘5’
for the “Sports Infrastructure” (LUA-3_4_3) entry, suggesting a specific
classification code for this category within a wider “Sports area”
context. The table details various sub-categories under “Sports
Infrastructure,” all at Level 4, such as “Golf Course,” “Ski Piste,”
...
([Table 0‑3](#_Ref149045139) see Annex). It is recommended to involve
specific experts to support the subclass definitions to best meet the
...
elements that should describe the subclass as best as possible. In
[Table 0‑3](#_Ref149045139) (see Annex), an example is shown of the
category “Grassland” with its subclasses and the identified EGLE
elements relevant for Extraction. The procedure has to be done for all
the remaining categories as well. In a second round check the
availability of the EAGLE element in the input classes together with the
barcoding value. This second round is very important to ensure that the
rule will have an output. If the rule is not true, the outcome will be
empty. I.e. forest class “clear cuts” can be described best with the
following EAGLE elements: LCC “bushes/shrubs and herbaceous vegetation”,
LUA “forestry” and LCH “clear cut” besides other elements. In this case
the LCH attribute is not barcoded in any of the CLC input classes
although it would be very well describing this subclass. Due to this
fact it cannot be used in the rule or if used, the output would be
empty.

## [<span id="_Toc154044853" class="anchor"></span>EAGLE Ontology](https://land.copernicus.eu/eagle/work-results-documentation-and-tools) overview
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image45.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image46.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image51.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image53.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image54.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image55.jpg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image56.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image57.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image58.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image59.png"
...
[2.3](#_Ref105145961)). By adding them at Ingestion creation, the
information is extracted automatically, otherwise the user need to add
this information manually at a later stage. An Ingestion has been
successfully processed, once it is in the status draft.
...
2)  Map the Input Classes to the respective EAGLE[^6] barcoding using
    the EAGLE barcoding template (section [2.3](#_Ref99728447)).
    Alternatively, the mapping can be performed in the system itself
    (section [3.7](#edit-ingestion))
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image60.jpg"
style="width:6.60777in;height:3.05208in"
data-fig-alt="This workflow diagram illustrates the generic process for data ingestion and subsequent extraction within the Copernicus Land Monitoring Service (CLMS) CLC+ Core System. The workflow is divided into two main phases: an Ingestion phase (orange area) and an Extraction phase (purple area). **Ingestion Phase:** 1. The process begins with establishing &#39;Reporting or extraction requirements.&#39; 2. An &#39;Extraction concept&#39; is developed based on these requirements. 3. This is followed by &#39;Data acquisition and selection.&#39; 4. &#39;EAGLE barcoding&#39; is then performed. 5. The barcoded data proceeds to &#39;Ingestion&#39; into the CLC+ Core System. 6. If &#39;Adaptions of EAGLE barcoding&#39; are required (e.g., for optional re-ingestion), the process moves to this step, which leads to &#39;Re-Ingestion&#39;. There is a feedback loop from &#39;Re-Ingestion&#39; back to &#39;Adaptions of EAGLE barcoding&#39; for iterative adjustments. 7. Once the ingestion is complete and satisfactory, the data is marked by &#39;Publish Ingestion.&#39; **Extraction Phase:** 1. Following &#39;Publish Ingestion,&#39; the process moves to &#39;Input Classes selection.&#39; 2. This is followed by the &#39;Definition of Output Classes.&#39; 3. &#39;Extraction rulesets&#39; are then defined. There is a feedback loop from &#39;Extraction rulesets&#39; back to &#39;Input Classes selection,&#39; allowing refinement of input classes based on ruleset definitions. 4. An &#39;Extraction&#39; is performed using the defined rulesets. There is a feedback loop from &#39;Extraction&#39; back to &#39;Extraction rulesets&#39; and &#39;Input Classes selection,&#39; indicating that extraction results may necessitate adjustments to rulesets or input classes. 5. The final step is to &#39;Publish Extraction.&#39;" />

This workflow diagram illustrates the generic process for data ingestion
and subsequent extraction within the Copernicus Land Monitoring Service
(CLMS) CLC+ Core System. The workflow is divided into two main phases:
an Ingestion phase (orange area) and an Extraction phase (purple area).

**Ingestion Phase:** 1. The process begins with establishing “Reporting
or extraction requirements.” 2. An “Extraction concept” is developed
based on these requirements. 3. This is followed by “Data acquisition
and selection.” 4. “EAGLE barcoding” is then performed. 5. The barcoded
data proceeds to “Ingestion” into the CLC+ Core System. 6. If “Adaptions
of EAGLE barcoding” are required (e.g., for optional re-ingestion), the
process moves to this step, which leads to “Re-Ingestion”. There is a
feedback loop from “Re-Ingestion” back to “Adaptions of EAGLE barcoding”
for iterative adjustments. 7. Once the ingestion is complete and
satisfactory, the data is marked by “Publish Ingestion.”

**Extraction Phase:** 1. Following “Publish Ingestion,” the process
moves to “Input Classes selection.” 2. This is followed by the
“Definition of Output Classes.” 3. “Extraction rulesets” are then
defined. There is a feedback loop from “Extraction rulesets” back to
“Input Classes selection,” allowing refinement of input classes based on
ruleset definitions. 4. An “Extraction” is performed using the defined
rulesets. There is a feedback loop from “Extraction” back to “Extraction
rulesets” and “Input Classes selection,” indicating that extraction
results may necessitate adjustments to rulesets or input classes. 5. The
final step is to “Publish Extraction.”
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image61.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image62.png"
...
refer to section [3.3 Remarks on the Ingestion process](#_Ref99729782).
The supported file formats for raster files are:
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image64.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image63.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image65.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image66.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image67.JPG"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image68.JPG"
...
occur.** Please also refer to section [3.3](#_Ref99729782) to learn
about the **limitations of data uploads**.

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image69.jpg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image70.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image73.JPG"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image72.png"
...
data-fig-alt="This image is a screenshot of the &#39;Add Ingestion&#39; user interface, depicting &#39;Step 2: &#39;Dataset Selection Upload Dataset - Raster&#39;&#39; of a data ingestion process. &#39;Continuous values&#39; is selected as the input type. The interface allows users to specify &#39;Excluded Value&#39; Class Codes, with &#39;254&#39; and &#39;255&#39; currently entered. A description explains that these values, representing non-thematic data, will be counted as NoData in the ingestion. A text field is available for entering a &#39;Layer Name&#39;. Users can upload supporting documents by &#39;Drag and Drop&#39; or using an &#39;UPLOAD DOCUMENT/S&#39; button. Two files are listed as uploaded: &#39;Barcoding3.1.2_Impervious_Degree_v0.3.xlsx&#39; and &#39;IMD_2018_010m_eu_03035_v020.xml&#39;. A checkbox for &#39;Delete raw data&#39; is displayed and is unchecked." /><img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image74.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image76.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image77.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image78.jpg"
style="width:6.925in;height:3.81806in"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image79.jpg"
...
refer to section [3.3](#_Ref99729782) [Remarks on the Ingestion
process](#_Ref99729782). The supported file formats for vector files:
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image80.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image81.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image82.jpeg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image83.jpeg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image84.jpg"
style="width:5.61979in;height:3.06462in"
data-fig-alt="This table displays sample entries from a dataset, likely from the Copernicus Land Monitoring Service (CLMS) Urban Atlas 2018 (UA2018) for Innsbruck, Austria. The table shows 11 rows of data out of a total of 12068 features, with no features currently filtered or selected. / fid / country / fua_name / fua_code / code_2018 / class_2018 / prod_date / /---/---/---/---/---/---/---/ / 1 / AT / Innsbruck / AT005L3 / 11210 / Discontinuous dense urban fabric / 2020-08 / / 2 / AT / Innsbruck / AT005L3 / 14200 / Sports and leisure facilities / 2020-08 / / 3 / AT / Innsbruck / AT005L3 / 11210 / Discontinuous dense urban fabric / 2020-08 / / 4 / AT / Innsbruck / AT005L3 / 11210 / Discontinuous dense urban fabric / 2020-08 / / 5 / AT / Innsbruck / AT005L3 / 13400 / Land without current use / 2020-08 / / 6 / AT / Innsbruck / AT005L3 / 11220 / Discontinuous medium-density urban fabric / 2020-08 / / 7 / AT / Innsbruck / AT005L3 / 12100 / Industrial, commercial, public and military units / 2020-08 / / 8 / AT / Innsbruck / AT005L3 / 12100 / Industrial, commercial, public and military units / 2020-08 / / 9 / AT / Innsbruck / AT005L3 / 12100 / Industrial, commercial, public and military units / 2020-08 / / 10 / AT / Innsbruck / AT005L3 / 12100 / Industrial, commercial, public and military units / 2020-08 / / 11 / AT / Innsbruck / AT005L3 / 11240 / Discontinuous very low-density urban fabric / 2020-08 / The table details various land cover / land use (LCLU) classes within the Functional Urban Area (FUA) of Innsbruck (fua_code: AT005L3), Austria (country: AT). Each entry includes a feature identifier (fid), a land cover code (code_2018), and its corresponding descriptive class name (class_2018) from the Urban Atlas 2018 nomenclature. All entries shown have a production date of 2020-08." />

This table displays sample entries from a dataset, likely from the
Copernicus Land Monitoring Service (CLMS) Urban Atlas 2018 (UA2018) for
Innsbruck, Austria. The table shows 11 rows of data out of a total of
12068 features, with no features currently filtered or selected.
...
The table details various land cover / land use (LCLU) classes within
the Functional Urban Area (FUA) of Innsbruck (fua_code: AT005L3),
Austria (country: AT). Each entry includes a feature identifier (fid), a
land cover code (code_2018), and its corresponding descriptive class
name (class_2018) from the Urban Atlas 2018 nomenclature. All entries
shown have a production date of 2020-08.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image86.JPG"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image85.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image88.JPG"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image87.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image89.png"
...
data-fig-alt="This screenshot illustrates the &#39;Add Ingestion&#39; process, specifically &#39;Step 2: &#39;Dataset Selection Upload Dataset - Vector&#39;&#39;. &#39;Step 1: Input Type Selection&#39; is greyed out, indicating it&#39;s a previous step. The interface presents a section for &#39;Excluded value&#39; with text explaining that &#39;values which do not represent thematic values in the input dataset&#39; will be counted as NoData, and if a TIF dataset specifies a NoData value in its metadata, it is automatically excluded. A &#39;Layer Name&#39; input field is present, pre-filled with &#39;AT005L3_INNSBRUCK_UA2018&#39;, instructing the user to &#39;Enter Layer Name from Dataset which shall be used to generate Input Classes.&#39; Below this is a &#39;Drag and Drop&#39; area or an &#39;UPLOAD DOCUMENT/S&#39; button for file uploads. Supplemental text states: &#39;All documents that help to understand the content, including legend files which will be used to automatically create Input Classes and metadata files which will be used to automatically prefill the data description. (No file type restrictions)&#39;. Three linked documents are visible: &#39;Urban_Atlas_2018_EAGLE_Barcoding_Template_3.1.2_23.12.2021_v3.xlsx&#39;, &#39;AT005L3_INNSBRUCK_UA2018_v013.xml&#39;, and &#39;Urban_Atlas_2018_Legend.sld&#39;. A checkbox option to &#39;Delete raw data&#39; is provided. At the bottom, there are &#39;CANCEL&#39;, &#39;BACK&#39;, and &#39;ADD&#39; action buttons." /><img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image90.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image91.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image92.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image93.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image95.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image96.png"
...
3‑27](#_Ref151989171)). [Table 3‑1](#_Ref98940657) provides a detailed
description of possible status messages. Sections [3.7 Edit
Ingestion](#edit-ingestion) and [4.3 Edit Extraction](#edit-extraction)
go into more detail on how Ingestion- and Extraction-states are changed.
For any change of the status of the users own Ingestion the user gets a
notification (see section [1.7.3](#notifications-messages)) as well as
an email notification. Further all users get notified in whenever a new
Ingestion is published (assuming the Ingestion was published publicly).
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image97.png"
...
<td style="text-align: left;"><p>Process, where all relevant information
and their datasets are uploaded to the system.</p>
...
<tr>
<td style="text-align: left;">Uploading_Error</td>
<td style="text-align: left;"><p>An error occurred while uploading the
dataset. By clicking on the data catalogue entry, a pop-up window will
help indicating the error.</p>
<p><img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image98.jpg"
...
<td style="text-align: left;">Either the dataset was processed
successfully and is newly ingested in the system or changes were made to
an existing Ingestion. The Ingestion can now be edited by performing an
EAGLE barcoding, changing some of its ingesting information and many
more.</td>
</tr>
<tr>
<td style="text-align: left;">Ingesting_Preview</td>
<td style="text-align: left;">The preview is executed for a smaller area
in the map.</td>
</tr>
<tr>
<td style="text-align: left;">Ingesting</td>
<td style="text-align: left;">Ingestion is executed for the whole
area</td>
</tr>
<tr>
<td style="text-align: left;">Ingesting_Error</td>
<td style="text-align: left;">An Error occurred during the INGESTING or
INGESTING_PREVIEW step. When opening the detail page of the Ingestion an
error message with more details is displayed. Do the required changes to
resolve the error and start the Ingestion again?</td>
</tr>
<tr>
<td style="text-align: left;">Ingested</td>
<td style="text-align: left;">Ingestion execution is finished for the
whole area.</td>
</tr>
<tr>
<td style="text-align: left;">Published</td>
<td style="text-align: left;"><p>If the Ingestion is published,
<strong>it can be made available to other users and can thus be used for
Extractions.</strong></p>
<p>The user has several possibilities to publish the Ingestion.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image101.jpg"
style="width:6.925in;height:3.82014in"
...
example below (see [Figure 3‑29](#_Ref151640298)) the Ingestion ‘HRL
Forest Type’ has three input classes. Besides the class code the class
name and the EAGLE barcodes per class are shown, as well as the colour
code per class.

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image102.jpg"
...
This is a screenshot of the Copernicus Land Monitoring Service (CLMS)
data catalogue and ingestion interface for the High Resolution Layer
(HRL) Forest Type (FTY) 2018 product. The interface shows general
product information, a spatial distribution map of forest types across
Europe, and a table detailing the input classification scheme based on
EAGLE (EIONET Action Group Land Monitoring in Europe) elements.

The “General Information” section provides metadata: - Name: HRL -
Forest Type (FTY) 2018 - Country: European Environment Agency (EEA)
(38+UK) - Region: European Environment Agency (EEA) (38+UK) - Reference
Year: 2018 - Time Range of Ingested Data: 01.03.2018 - 31.10.2018 -
INSPIRE Themes: LU Land use, LC Land cover - Created By: CLC+ Core User
Admin/Support - Organisation/s: CLC, European Environment Agency -
Visibility: Public - All Organisations - Contact Person:
copernicus@eea.europa.eu - Link to Document/s:
https://www.eea.europa.eu/about-us/tenders/eea-idm-r0-18-011

The right panel displays an interactive map of Europe showing the
spatial distribution of forest types. Forested areas are depicted in
shades of green, while non-forested areas are light grey/white. A scale
bar indicates 300 km and 300 mi. Map controls include zoom in (+), zoom
out (-), full extent, and layer toggle. Search boxes are present for
“Country *” and ”Region* ”. The map attribution is “© Leaflet \| ©
Core003 Mosaic, © OpenStreetMap contributors”.

Below the map, an “Input Classes” table defines the classification
scheme: \| Class Code \| Name \| EAGLE Elements \| 100% EAGLE compliant
\| Colour \| Show in Map \|
\|:———–\|:——————–\|:——————————–\|:———————\|:————-\|:————\| \| 0 \| All
non-forest areas \| Trees (crossed out icon) \| Yes \| White \| No \| \|
1 \| Broadleaved forest \| Trees (tree icon, plus 2) \| Yes \| Dark
green \| Yes \| \| 2 \| Coniferous forest \| Trees (tree icon, plus 1)
\| Yes \| Darker green \| Yes \|

The table indicates that ‘All non-forest areas’ are represented by a
crossed-out tree icon and are not shown on the map, while ‘Broadleaved
forest’ and ‘Coniferous forest’ are represented by tree icons and shown
in different shades of green on the map. All classes are marked as “100%
EAGLE compliant”. The top of the page also features “REPUBLISH ON
GEOSERVER” and “ARCHIVE” buttons, indicating data management
functionalities.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image103.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image104.png"
...
barcoding file (a detailed description is provided in section
[2.3](#_Ref100162317)) together with the data. You can do this already
when defining the settings for the Ingestion (see section
[3.2](#add-ingestion)) or by clicking on the EAGLE element picker. In
case you use the picker, continue with step 3 below, otherwise you can
skip this and continue with step 4.

<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image106.jpg"
style="width:6.925in;height:3.8125in"
data-fig-alt="This image is a screenshot of the Copernicus Land Monitoring Service (CLMS) Core user interface, displaying the details for a data ingestion named &#39;UA_IBK_2018&#39;. The interface is structured with a top navigation bar, a &#39;General Information&#39; section on the left, a map preview in the center, and an &#39;Input Classes&#39; table below the map. The top navigation bar includes links for &#39;Data Catalogue&#39;, &#39;EAGLE Ontology&#39;, &#39;About EAGLE&#39;, &#39;Organisations&#39;, &#39;Users&#39;, and &#39;CLC+ Core User Admin/Support&#39;. The main page title is &#39;Data Catalogue / Ingestion &#39;UA_IBK_2018&#39;&#39;, with a status tag &#39;INGESTED_PRE&#39; (7). The &#39;General Information&#39; section on the left provides metadata for the &#39;UA_IBK_2018&#39; ingestion: * Name: UA_IBK_2018 * Country: Austria/Österreich * Region: Innsbruck * Reference Year: 2018 * Time Range of Ingested Data: 01.01.2018 - 31.12.2018 * INSPIRE Themes: LU Land use, LC Land cover * Created By: CLC+ Core User Admin/Support * Organisation/s: CLC, European Environment Agency (EEA) An &#39;EDIT&#39; button is available next to the &#39;General Information&#39; heading. A map preview is displayed on the right, showing an aerial/satellite imagery base layer of the Innsbruck region, filtered for &#39;AT Austria/Österreich&#39; and &#39;AT332 Innsbruck&#39;. A green overlay highlights a specific area within the region. The map includes zoom controls, layer toggles, and a scale bar showing &#39;10 km&#39; and &#39;5 mi&#39;. A &#39;PREVIEW&#39; button (5) is located above the map. Above the map, there are buttons for &#39;REPUBLISH ON GEOSERVER&#39;, &#39;START INGESTION&#39;, and &#39;PUBLISH&#39; (6). Below the map, a &#39;DOWNLOAD EAGLE BARCODING&#39; button (4) is visible. The &#39;Input Classes&#39; table lists specific land cover classes relevant to the ingestion, with columns for: * &#39;Class Code ↑&#39;: Numeric identifiers (e.g., 11100, 11210, 11220, 11230). * &#39;Name *&#39;: Editable names corresponding to the class codes (e.g., &#39;11100&#39;). * &#39;EAGLE Elements *&#39; (3): Describes the class mapping according to the EIONET Action Group on Land monitoring in Europe (EAGLE) concept, such as &#39;Sealed Artificial Surfaces and Constructions +10&#39; or &#39;Sealed Artificial Surfaces and Constructions +11&#39;. * &#39;100% EAGLE compliant&#39; (2): Indicates compliance with EAGLE specifications (all classes shown have a green checkmark). * &#39;Colour&#39;: Small coloured squares (red, dark red, medium red, light red) representing the visualization colour for each class. * &#39;Show in Map&#39;: Toggle switches, all currently off, indicating these specific classes are not actively displayed on the map preview. An &#39;APPROVE EAGLE COMPLIANCE&#39; button (1) is located below the &#39;UA_IBK_2018&#39; title." />

This image is a screenshot of the Copernicus Land Monitoring Service
(CLMS) Core user interface, displaying the details for a data ingestion
named ‘UA_IBK_2018’. The interface is structured with a top navigation
bar, a “General Information” section on the left, a map preview in the
center, and an “Input Classes” table below the map.

The top navigation bar includes links for “Data Catalogue”, “EAGLE
Ontology”, “About EAGLE”, “Organisations”, “Users”, and “CLC+ Core User
Admin/Support”. The main page title is “Data Catalogue / Ingestion
‘UA_IBK_2018’”, with a status tag “INGESTED_PRE” (7).

The “General Information” section on the left provides metadata for the
‘UA_IBK_2018’ ingestion: \* Name: UA_IBK_2018 \* Country:
Austria/Österreich \* Region: Innsbruck \* Reference Year: 2018 \* Time
Range of Ingested Data: 01.01.2018 - 31.12.2018 \* INSPIRE Themes: LU
Land use, LC Land cover \* Created By: CLC+ Core User Admin/Support \*
Organisation/s: CLC, European Environment Agency (EEA) An “EDIT” button
is available next to the “General Information” heading.

A map preview is displayed on the right, showing an aerial/satellite
imagery base layer of the Innsbruck region, filtered for “AT
Austria/Österreich” and “AT332 Innsbruck”. A green overlay highlights a
specific area within the region. The map includes zoom controls, layer
toggles, and a scale bar showing “10 km” and “5 mi”. A “PREVIEW” button
(5) is located above the map.

Above the map, there are buttons for “REPUBLISH ON GEOSERVER”, “START
INGESTION”, and “PUBLISH” (6). Below the map, a “DOWNLOAD EAGLE
BARCODING” button (4) is visible.

The “Input Classes” table lists specific land cover classes relevant to
the ingestion, with columns for: \* “Class Code ↑”: Numeric identifiers
(e.g., 11100, 11210, 11220, 11230). \* “Name *”: Editable names
corresponding to the class codes (e.g., ”11100”).* ”EAGLE Elements *”
(3): Describes the class mapping according to the EIONET Action Group on
Land monitoring in Europe (EAGLE) concept, such as “Sealed Artificial
Surfaces and Constructions +10” or “Sealed Artificial Surfaces and
Constructions +11”.* “100% EAGLE compliant” (2): Indicates compliance
with EAGLE specifications (all classes shown have a green checkmark). \*
“Colour”: Small coloured squares (red, dark red, medium red, light red)
representing the visualization colour for each class. \* “Show in Map”:
Toggle switches, all currently off, indicating these specific classes
are not actively displayed on the map preview.

An “APPROVE EAGLE COMPLIANCE” button (1) is located below the
‘UA_IBK_2018’ title.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image107.jpg"
...
3‑34](#_Ref98941416)) or Annex [Table 0‑1](#_Ref152071020)) and set a
factor that defines the coverage of the EAGLE element on the specific
input class once an EAGLE element has been added to an Input Class.
Finally, you need to check the checkbox whether it is 100% EAGLE
compliant or not. The ‘100% EAGLE compliant’ tick box is a flag
indicating if the mapping to the EAGLE language for one Input class is
fully compliant or only partially compliant. If it is only partially
compliant it needs to be evaluated within an Extraction then if the
given gap causes issues in the specific use case. Note that this tick
box is not connected to the “Approved by EAGLE” stamp for complete
Ingestions.
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image108.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image109.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image110.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image111.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image112.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image115.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image116.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image117.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image118.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image119.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image120.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image121.png"
...
Extraction in the system. The status is displayed in the Data Catalogue
for each Ingestion and Extraction in the column ‘Status’ (see [Figure
3‑27](#_Ref151989171)). [Table 4‑1](#_Ref153954038) provides a detailed
description of possible status messages.

<table>
<caption><span id="_Ref153954038" class="anchor"></span>Table 4‑1:
Status of Extraction datasets</caption>
<colgroup>
<col style="width: 4%" />
<col style="width: 95%" />
</colgroup>
...
<td style="text-align: left;"><p>If you want to stop or cancel an
extracted that you started, right click on the associated extraction in
the Data Catalogue and click cancel.</p>
<p><img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image122.jpg"
style="width:4.57692in;height:1.02299in"
data-fig-alt="A screenshot of the CLC+ Core Data Catalogue user interface, featuring a top navigation bar, filter options, and a data table listing &#39;Extractions&#39;. The top navigation bar includes &#39;Data Catalogue&#39;, &#39;EAGLE Ontology&#39;, &#39;About EAGLE&#39;, &#39;Organisations&#39;, and &#39;Users&#39;. The main section is titled &#39;Data Catalogue&#39;. Filter buttons include &#39;Filter&#39;, &#39;My organisation/s&#39; (checked), &#39;My data&#39;, &#39;Ingestions&#39;, and &#39;Extractions&#39; (checked). A &#39;Search&#39; text field is present. Action buttons on the right are &#39;ADD INGESTION&#39; and another green button, partially obscured. The main content area displays a table with headers: &#39;Name&#39;, &#39;Type&#39;, &#39;Created By&#39;, &#39;Country&#39;, &#39;Time Range&#39;, and &#39;Status&#39;. Two rows of data are visible: 1. **Name:** &#39;Test Instances Issue with Eurolarge [partially obscured]&#39; **Type:** &#39;&gt;&#39; **Created By:** &#39;User Admin/Support CLC+ Core&#39; **Country:** &#39;Germany Deutschland&#39; **Time Range:** &#39;01.05.2023 - 31.05.2023&#39; **Status:** &#39;EXTRACTING&#39; 2. **Name:** &#39;LULUCF_Beta_1.1&#39; **Type:** &#39;&gt;&#39; **Created By:** &#39;User Admin/Support CLC+ Core&#39; **Country:** &#39;Netherlands Nederland&#39; **Time Range:** &#39;01.01.2017 - 01.01.2020&#39; **Status:** &#39;EXTRACTED_PREVIEW&#39; A &#39;Cancel&#39; button with an eye icon is shown as a hover action over the &#39;LULUCF_Beta_1.1&#39; row. The background of the interface shows a blurred aerial image of green agricultural fields." /></p></td>
</tr>
<tr>
<td style="text-align: left;">Draft</td>
<td style="text-align: left;">Either the Extraction was newly created in
the system or changes were made to an existing Extraction. The
Extraction can now be edited by adding input- or output classes or
changing some metadata fields.</td>
</tr>
<tr>
<td style="text-align: left;">Extracting</td>
<td style="text-align: left;">If an extraction has been started and the
dataset is processing, the status is set to extracting. While extracting
the data the dataset cannot be viewed.</td>
</tr>
<tr>
<td style="text-align: left;">Extracted_Preview</td>
<td style="text-align: left;">The preview is executed for smaller area
in the map.</td>
</tr>
<tr>
<td style="text-align: left;">Extracted</td>
<td style="text-align: left;">The performed Extraction was successful
and can now be published.</td>
</tr>
<tr>
<td style="text-align: left;">Extracting_Error</td>
<td style="text-align: left;"><p>An error occurred while performing an
Extraction. By clicking on the data catalogue entry, a pop-up window
will help indicating the error.</p>
<p><img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image123.jpg"
...
alt="Graphical user interface, website Description automatically generated" /></p></td>
</tr>
<tr>
<td style="text-align: left;">Published</td>
<td style="text-align: left;"><p>If the Extraction is published,
<strong>it can be made available to other users.</strong> The user has
several possibilities to publish the Extraction. Depending on what kind
of visibility (private, public or national) you have chosen, the
Extraction will then be available to either all users (public), to all
countries of the selected organisation (national), or only to users
within your organisation (private).</p>
<p><strong>Note: Once the Extraction is published, it cannot be changed
anymore!</strong></p></td>
</tr>
<tr>
<td style="text-align: left;">Archived</td>
<td style="text-align: left;">The Extraction is archived and thus it is
unpublished from the geoserver, which means it cannot be viewed in the
preview anymore.</td>
</tr>
</tbody>
</table>
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image124.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image125.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image126.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image127.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image128.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image129.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image130.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image131.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image132.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image133.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image134.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image135.jpg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image136.png"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image137icon.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image138.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image139.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image137.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image140.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image141.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image142.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image143.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image147.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image148.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image149.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image150.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image151.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image152.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image153.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image155.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image156.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image157.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image158.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image159.png"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image160.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image161.jpg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image162.jpg"
...
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image163.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image164.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image166.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image167.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image168.jpg"
...
<img
src="./clcplus-core_CLCplusCore_User_Manual_Issue_4.0_v1-media/image169.png"
...
[^4]: [https://land.copernicus.eu/en/technical-library/explanatory-documentation-of-the-eagle-concept-3_2/%40%40download/file](https://land.copernicus.eu/en/eagle?tab=introduction_and_context)
    (Version 3.2, 2023)
