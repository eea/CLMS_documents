...
This Product User Manual details the Copernicus Land Monitoring Service’s Riparian Zones Land Cover/Land Use (LC/LU) product, providing comprehensive guidance for its optimal utilisation. It outlines the product’s purpose, scope, and technical specifications, covering detailed LC/LU classifications and changes within selected river buffer zones across Europe for reference years 2012 and 2018. The document elaborates on the underlying methodology, including the use of Very High-Resolution satellite imagery and a harmonised 56-class nomenclature. Furthermore, it presents quality assurance procedures, accuracy assessments, and diverse application areas, such as supporting biodiversity strategies, water quality improvements, and flood risk management, thereby enabling informed decisions for scientists, regulators, and data engineers.
...
Riparian Zones, Land Cover/Land Use classification, Change detection mapping, Very High-Resolution satellite imagery, Strahler river classification, EEA-39 geographic coverage, Thematic accuracy assessment, Minimum Mapping Unit, MAES ecosystem typology, Parent Scene Identification Layer, Urban Atlas integration
...
![This conceptual diagram illustrates a land cover change scenario showing the decrease in area of an Olive grove (2.2.2) and its mapping within Riparian Zones (RZ) products between 2012 and 2018. The diagram comprises four panels: 'IMAGE 2012', 'IMAGE 2018', 'RZ 2012', and 'RZ 2018'. In all panels, the green areas represent the 'Natural & semi-natural grassland (4.2.x)' class, and the yellow L](products_DOCS_2012-2018_PUM_v1-media/image25.png)
