...
Figure 2: LSWT, uncertainty and number of observations for lakes Malawi, Malombe, Chiuta and Chilwa in Malawi for the 10-day period starting on the 11-Jun-2018 using SLSTR-A data.
...
Figure 3: Standard deviation of the observations, quality levels and observation time for lakes Malawi, Malombe, Chiuta and Chilwa in Malawi for the 10-day period starting on the 11-Jun-2018 using SLSTR-A data.
...
Figure 4: LSWT, uncertainty and number of observations for a glacial lake in Greenland (centre lat=65.087, lon=-50.040, maximum distance from land = 1.8 km) for the 10-day period starting on the 21-Jul-2020 using SLSTR-AB data.
...
Figure 5: Standard deviation of the observations, quality levels and observation time for a glacial lake in Greenland (centre lat=65.087, lon=-50.040, maximum distance from land = 1.8 km) for the 10-day period starting on the 21-Jul-2020 using SLSTR-AB data.
