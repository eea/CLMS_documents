...
This document serves as an essential annex to the CLC+ Core User Manual, specifically tailored for administrative users. It outlines the advanced functionalities and responsibilities pertinent to managing the CLC+ Core system’s user base and data integrity. The scope encompasses detailed guidance on administering organisations and user accounts, including their creation, modification, and role assignment. Furthermore, it details the crucial processes for integrating and approving new EAGLE ontology versions and ensuring data ingestion compliance within the CLC+ Core environment, leveraging the EIONET Data Dictionary for robust data management.
...
CLC+ Core system administration, user management, organisation management, EAGLE ontology, EIONET Data Dictionary, data ingestion compliance, EAGLE barcoding approval, user roles and authorisations
