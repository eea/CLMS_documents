...
This Product User Manual provides a comprehensive guide to the Copernicus Land Monitoring Service (CLMS) High Resolution Layer (HRL) Croplands product, covering the period from 2017 to present. It details the product’s characteristics, including 10-metre spatial resolution annual layers of crop types and various agricultural practices. The document outlines production methodologies, data formats like Cloud-Optimized GeoTIFFs, and the quality assessment procedures, including thematic accuracy and validation metrics. It serves to equip scientists and data engineers with the essential information for effective utilisation in agricultural monitoring and policy support across Europe.
...
HRL Croplands, crop type classification, agricultural practices monitoring, 10-metre spatial resolution, thematic accuracy assessment, Copernicus Land Monitoring Service, High Resolution Layers, cropping patterns, LUCAS survey data, GeoSpatial Aid Application data, Sentinel data time series, F-score accuracy metric
