...
This Product User Manual details the Copernicus Land Monitoring Service’s Riparian Zones (RZ) Land Cover/Land Use (LC/LU) product, offering comprehensive geographical information for river buffer areas across EEA-38 + UK. It outlines product characteristics, methodology, user requirements, and application areas. Focused on VHR satellite imagery interpretation for 2012 and 2018, it provides status maps and change mapping, adhering to a harmonised 56-class nomenclature and precise mapping units. The document supports critical environmental policies, including biodiversity conservation, water quality management, and flood protection initiatives.
...
Riparian Zones, Land Cover/Land Use classification, Very High-Resolution satellite imagery, Land Cover Change mapping, European Catchments and Rivers Network System, MAES ecosystem typology, Thematic accuracy assessment, Minimum Mapping Unit, Nomenclature guidelines, Product User Manual
...
1.  Identify the main EO dataset used to produce any polygons in the map. This is important for:  
...
3.  recreating the production environment (for validation or in case of discontinued production)
...
![This table presents a cross-reference between Urban Atlas (UA) Land Cover (LCLU) classification codes and nomenclature for 2006, 2012, and 2018, and their corresponding Riparian Zone (RZ) nomenclature and codes. It also specifies the updated RZ CODE when integrating UA2012/2018 data within UA Urban Centres. \| UA Land Cover Code (2006/2012/2018) \| UA Land Cover Nomenclature (2](products_products_Riparian_Zones_2012-2018_PUM_v1-media/Picture1.png)

Table 8: Recoding of the UA Core areas into the RZ Nomenclature
...
![This conceptual map illustrates a 'Simple Change' in Land Cover / Land Use (LCLU) classification between two interpretations, 'Interpretation 2012' and 'Interpretation 2018'. The 2012 interpretation shows three distinct LCLU polygons: 1. An outer, larger beige area classified as '2.1.1.0'. 2. A large red area, classified as '1.1.1.1', partially surrounded by the beige area. 3. An inner, light pink polygon, classified as '1.4.0.0', entirely contained within the red '1.1.1.1' area. The 2018 interpretation shows a change where the inner light pink polygon (previously '1.4.0.0') has transformed into the '1.1.1.1' class (red), effectively merging with the surrounding red area. The outer beige area (2.1.1.0) and its internal boundaries remain unchanged. This demonstrates a single polygon changing its LCLU class over time.](products_products_Riparian_Zones_2012-2018_PUM_v1-media/image19.png)

Figure 12: A Green urban area (1.4.0.0) ≥0,5 ha in 2012 changes into Continuous urban fabric (1.1.1.1) in 2018
...
![This conceptual diagram illustrates a land cover change scenario showing the decrease in area of an Olive grove (2.2.2) and its mapping within Riparian Zones (RZ) products between 2012 and 2018. The diagram comprises four panels: 'IMAGE 2012', 'IMAGE 2018', 'RZ 2012', and 'RZ 2018'. In all panels, the green areas represent the 'Natural & semi-natural grassland (4.2.x)' class, and the yellow L](products_products_Riparian_Zones_2012-2018_PUM_v1-media/image25.png)

Figure 18: Simple change
...
[^2]: [**Index of /RiparianZones (europa.eu)**](https://cws-expert.eea.europa.eu/RiparianZones/)***,*** **Username: cwsexpert, Password: expertcws**

[^3]: [Glossary:Urban centre - Statistics Explained (europa.eu)](https://ec.europa.eu/eurostat/statistics-explained/index.php?title=Glossary:Urban_centre)

[^4]: [Natura 2000 (N2K) — Copernicus Land Monitoring Service](https://land.copernicus.eu/local/natura)
