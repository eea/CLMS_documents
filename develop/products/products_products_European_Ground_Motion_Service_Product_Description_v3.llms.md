...
This document provides a comprehensive technical description of the European Ground Motion Service (EGMS) products, detailing their specifications, formats, and attributes. It covers three primary InSAR-based products – Basic, Calibrated, and Ortho – which offer precise ground displacement measurements and associated time series. The document elucidates the methodologies for data referencing, including GNSS integration, and explains key technical aspects such as spatial and temporal resolution, accuracy metrics, and file naming conventions. This guide ensures users can effectively understand and utilise EGMS data for diverse applications in ground motion monitoring.
...
European Ground Motion Service, InSAR products, ground displacement, Sentinel-1 satellite, Basic product, Calibrated product, Ortho product, GNSS reference model, time series, spatial resolution, temporal resolution, Mean velocity resolution, ETRS89-LAEA
