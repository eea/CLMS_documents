...
This Algorithm Theoretical Basis Document details the algorithms and methodologies underpinning the Copernicus High-Resolution Layer Small Landscape Features (HRL SLF) product suite. It meticulously describes the processing chain, from leveraging Very High Resolution and Sentinel-2 time series data, through advanced deep learning classification models including U-Net and Swin Transformers, to sophisticated post-processing techniques. The document covers the derivation of layers like Woody Vegetation, Small Woody Features, and Street Tree Layer, alongside comprehensive quality control and an overview of known technical limitations for pan-European land cover mapping.
...
HRL Small Landscape Features (SLF), Woody vegetation mapping, Deep learning classification, Very High Resolution satellite imagery, Sentinel-2 time series, Land cover classification algorithms, U-Net segmentation, Swin Transformer model, Geospatial image preprocessing, Thematic accuracy assessment, Pan-European land monitoring
