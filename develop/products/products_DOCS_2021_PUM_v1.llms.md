...
This Product User Manual details the Copernicus Land Monitoring Service’s CLC+ Backbone Raster Product for 2021, a high-resolution, wall-to-wall land cover inventory covering EEA-38 nations. It thoroughly outlines the product’s purpose, technical specifications, and 11-class nomenclature derived from Sentinel-2 time-series data at 10m spatial resolution. The document provides a comprehensive overview of the advanced production methodology, including deep learning classification and post-processing steps. Furthermore, it presents extensive internal validation results, discussing product strengths, limitations, and accompanying quality layers, ensuring users can effectively apply this crucial geospatial dataset for diverse environmental and planning applications.
...
CLC+ Backbone, land cover classification, Sentinel-2 time series, 10m spatial resolution, thematic accuracy assessment, Temporal Convolutional Neural Network, EAGLE Land Cover Components, raster product, Raster Data Score Layer, Raster Confidence Layer, interannual calibration, EEA38
