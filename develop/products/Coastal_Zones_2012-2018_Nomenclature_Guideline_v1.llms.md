...
![A ground-level photograph depicting a golf course, illustrating the land cover class 'Green urban, sports and leisure facilities.' The scene features extensive manicured green lawns, scattered trees, and paved paths winding through the landscape. In the middle ground, two water features (ponds) are visible, each with an active fountain. Several golfers are present on the course. In the background, additional trees and multi-story buildings are visible, indicating an urban or peri-urban setting.](Coastal_Zones_2012-2018_Nomenclature_Guideline_v1-media/image96.jpeg)
...
![A ground-level photograph showing the exterior of a greenhouse structure in Almeria (Andalusia, Spain). The structure is covered with a semi-transparent, light-coloured (beige/tan) material, likely plastic sheeting or netting, through which the internal framework is faintly visible. The upper edge of the greenhouse is visible against a clear blue sky with sparse white clouds. The image is attributed with the copyright '© Eurostat LUCAS 2009'.](Coastal_Zones_2012-2018_Nomenclature_Guideline_v1-media/image131.jpeg)
...
![This is a photograph of a sandy dune landscape under a partly cloudy sky. The image prominently features a sandy hill or dune in the foreground and mid-ground, with a texture suggesting fine sand. Sparse, low-lying green vegetation, identified as small trees or shrubs, grows on top of and around the dune. The background shows more sandy terrain and a light blue sky with scattered clouds. The image captures Maspalomas dune in the Canary Islands, Spain. Credit: M. Palacios.](Coastal_Zones_2012-2018_Nomenclature_Guideline_v1-media/image333.jpeg)
...
![A photograph depicting a natural water course featuring a waterfall cascading on the left into a river or stream on the right. The water in the river is clear, revealing green aquatic vegetation beneath the surface in shallow areas, and shows ripples from the current. The banks are covered with dense, green vegetation, including numerous trees and grasses, indicating a well-watered area. Sunlight illuminates the falling water and the river surface.](Coastal_Zones_2012-2018_Nomenclature_Guideline_v1-media/image400.jpeg)
...
![Fish ponds in Lubusz (Poland). Credits: Eurostat, LUCAS, 2009](Coastal_Zones_2012-2018_Nomenclature_Guideline_v1-media/image428.jpeg){width=“2.17in” ***This category includes:*** - Highly transformed fresh-water ponds used as fish farming.  
