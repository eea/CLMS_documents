...
# File and path length

The maximum file FQFN length is determined by the file system. File systems and their upper limits are:
...
![Example decision tree](images/mermaid-diagram-20240901074702.png) Example decision tree {#fig-cap:classification tree}<!--# pdf and doc connot render mermaid grpaphs, this provisorial solution -->
